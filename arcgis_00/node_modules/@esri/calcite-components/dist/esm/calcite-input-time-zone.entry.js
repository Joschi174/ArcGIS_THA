...
import { u as updateHostInteraction } from './interactive-ede14c07.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-bad69fe5.js';
  ...
  if (mode === "offset") {
    if (!timeZoneGroups) {
      timeZoneGroups = Promise.all([
        import('./index-6d52eadc.js'),
        import('./index-80b05013.js'),
      ]);
    }
