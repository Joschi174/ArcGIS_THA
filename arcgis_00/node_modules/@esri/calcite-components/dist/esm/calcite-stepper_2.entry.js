...
import { s as slotChangeGetAssignedElements, l as focusElementInGroup } from './dom-158133b6.js';
...
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-bad69fe5.js';
...
const Stepper = class {
  ...
  render() {
    return (h(Host, { "aria-label": "Progress steps", role: "region" }, h("slot", { onSlotchange: this.handleDefaultSlotChange })));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
const StepperItem = class {
  ...
  render() {
    return (h(Host, { "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, h("div", { class: CSS.container }, this.complete && (h("span", { "aria-live": "polite", class: CSS.visuallyHidden }, "Completed step")), h("div", { class: CSS.stepperItemHeader, tabIndex: 
