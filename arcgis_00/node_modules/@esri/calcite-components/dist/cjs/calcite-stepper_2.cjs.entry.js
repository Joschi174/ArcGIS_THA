...
const Stepper = class {
  constructor(hostRef) {
    ...
    this.handleDefaultSlotChange = (event) => {
      const slottedItems = dom.slotChangeGetAssignedElements(event);
  ...
  render() {
    return (index.h(index.Host, { "aria-label": "Progress steps", role: "region" }, index.h("slot", { onSlotchange: this.handleDefaultSlotChange })));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
const StepperItem = class {
  ...
  render() {
    return (index.h(index.Host, { "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, index.h("div", { class: CSS.container }, this.complete && (index.h("span", { "aria-live": "polite", class: CSS.visuallyHidden }, "Completed step")), index.h("div", { class: CSS.stepperItemHeader, tabIndex: 
