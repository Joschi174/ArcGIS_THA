  ...
  _afterNew() {
    super._afterNew(), this._data.incrementRef(), this._updateFields(), this._disposers.push(this.data.events.onAll((e) => {
      ...
      if (this.markDirtyValues(), this._markDirtyGroup(), this._dataChanged = true, "clear" === e.type)
        ...
        s.bullets && 0 == s.bullets.length && (s.bullets = void 0), Y(i).forEach((e2) => {
...
Object.defineProperty(_2, "className", { enumerable: true, configurable: true, writable: true, value: "Component" }), Object.defineProperty(_2, "classNames", { enumerable: true, configurable: true, writable: true, value: Je.classNames.concat([_2.className]) });
var y = { millisecond: 1, second: 1e3, minute: 6e4, hour: 36e5, day: 864e5, week: 6048e5, month: 2629742400, year: 31536e6 };
function w(e, t2) {
  return null == t2 && (t2 = 1), y[e] * t2;
}
function I(e, t2, s, i, a, l2, n) {
  if (!n || a) {
    let n2 = 0;
    switch (a || "millisecond" == t2 || (n2 = e.getTimezoneOffset(), e.setUTCMinutes(e.getUTCMinutes() - n2)), t2) {
      case "day":
        ...
        if (s > 1) {
          if (l2) {
            l2 = I(l2, "day", 1);
            let t4 = e.getTime() - l2.getTime(), i2 = Math.floor(t4 / w("day") / s), a3 = w("day", i2 * s);
            e.setTime(l2.getTime() + a3 - n2 * w("minute"));
          }
        } else
          e.setUTCDate(t3);
  ...
  }
  {
    if (isNaN(e.getTime()))
      return e;
    let o = n.offsetUTC(e), h = e.getTimezoneOffset(), u = n.parseDate(e), d = u.year, c = u.month, m2 = u.day, p = u.hour, b = u.minute, f2 = u.second, g2 = u.millisecond, _3 = u.weekday;
    switch (t2) {
      case "day":
        if (s > 1 && l2) {
          l2 = I(l2, "day", 1, i, a, void 0, n);
          let t3 = e.getTime() - l2.getTime(), r = Math.floor(t3 / w("day") / s), o2 = w("day", r * s);
          e.setTime(l2.getTime() + o2), u = n.parseDate(e), d = u.year, c = u.month, m2 = u.day;
        }
        p = 0, b = o - h, f2 = 0, g2 = 0;
        break;
      case "second":
      ...
      case "year":
        ...
        break;
      case "week":
        l(i) || (i = 1), m2 = _3 >= i ? m2 - _3 + i : m2 - (7 + _3) + i, p = 0, b = o - h, f2 = 0, g2 = 0;
    }
...
var D = class extends _2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_aggregatesCalculated", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_selectionAggregatesCalculated", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_dataProcessed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_psi", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_pei", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "bullets", { enumerable: true, configurable: true, writable: true, value: new R() }), Object.defineProperty(this, "bulletsContainer", { enumerable: true, configurable: true, writable: true, value: Je.new(this._root, { width: z, height: z, position: "absolute" }) });
  }
  _afterNew() {
  ...
  getDataItemById(e) {
    return T(this.dataItems, (t2) => t2.get("id") == e);
  }
  _makeBullets(e) {
  ...
  _calculateAggregates(e, t2) {
    ...
    m(s, (e2) => {
      ...
      let a = s2 + "Change", m2 = s2 + "ChangePercent", p = s2 + "ChangePrevious", b = s2 + "ChangePreviousPercent", f2 = s2 + "ChangeSelection", g2 = s2 + "ChangeSelectionPercent", _3 = "valueY";
      "valueX" != s2 && "openValueX" != s2 && "lowValueX" != s2 && "highValueX" != s2 || (_3 = "valueX");
      const v2 = this.getPrivate("baseValueSeries");
      for (let y2 = e; y2 < t2; y2++) {
        const t3 = this.dataItems[y2];
        let w2 = t3.get(s2);
        null != w2 && (r[s2]++, i[s2] += w2, l2[s2] += Math.abs(w2), d[s2] = i[s2] / r[s2], (n[s2] > w2 || null == n[s2]) && (n[s2] = w2), (o[s2] < w2 || null == o[s2]) && (o[s2] = w2), u[s2] = w2, null == h[s2] && (h[s2] = w2, c[s2] = w2, v2 && (h[_3] = v2._getBase(_3))), 0 === e && (t3.setRaw(a, w2 - h[_3]), t3.setRaw(m2, (w2 - h[_3]) / h[_3] * 100)), t3.setRaw(p, w2 - c[_3]), t3.setRaw(b, (w2 - c[_3]) / c[_3] * 100), t3.setRaw(f2, w2 - h[_3]), t3.setRaw(g2, (w2 - h[_3]) / h[_3] * 100), c[s2] = w2);
      }
    }), m(s, (e2) => {
      ...
      m(e2.target._entities, (i) => {
        ...
        if (l(a))
          if (e2.customFunction)
            ...
            let l2, n;
            l2 = e2.logarithmic ? (Math.log(a) * Math.LOG10E - Math.log(t2) * Math.LOG10E) / (Math.log(s) * Math.LOG10E - Math.log(t2) * Math.LOG10E) : (a - t2) / (s - t2), !l(a) || l(l2) && Math.abs(l2) != 1 / 0 || (l2 = 0.5), l(e2.min) ? n = e2.min + (e2.max - e2.min) * l2 : e2.min instanceof Xt ? n = Xt.interpolate(l2, e2.min, e2.max) : e2.min instanceof K && (n = qt(l2, e2.min, e2.max)), i.set(e2.key, n);
          }
        else
  ...
  _positionBullets(e) {
    e.bullets && m(e.bullets, (e2) => {
      ...
      e2.get("dynamic") && (t2 && (t2._markDirtyKey("fill"), t2.markDirtySize()), t2 instanceof Je && t2.walkChildren((e3) => {
        e3._markDirtyKey("fill"), e3.markDirtySize(), e3 instanceof Qe && e3.text.markDirtyText();
      })), t2 instanceof Qe && t2.get("populateText") && t2.text.markDirtyText();
    });
  }
  _hideBullets(e) {
    e.bullets && m(e.bullets, (e2) => {
  ...
  showDataItem(t2, s) {
    ...
    return t(this, void 0, void 0, function* () {
      const e = [i.showDataItem.call(this, t2, s)], l2 = t2.bullets;
      l2 && m(l2, (t3) => {
        e.push(t3.get("sprite").show(s));
      }), yield Promise.all(e);
    });
  }
  hideDataItem(t2, s) {
    ...
    return t(this, void 0, void 0, function* () {
      const e = [i.hideDataItem.call(this, t2, s)], l2 = t2.bullets;
      l2 && m(l2, (t3) => {
        e.push(t3.get("sprite").hide(s));
      }), yield Promise.all(e);
    });
  }
  _sequencedShowHide(t2, s) {
    return t(this, void 0, void 0, function* () {
      if (this.get("sequencedInterpolation"))
        if (l(s) || (s = this.get("interpolationDuration", 0)), s > 0) {
          const i = this.startIndex(), a = this.endIndex();
          yield Promise.all(_(this.dataItems, (l2, r) => t(this, void 0, void 0, function* () {
            let e = s || 0;
            (r < i - 10 || r > a + 10) && (e = 0);
            let n = this.get("sequencedDelay", 0) + e / (a - i);
            yield v(n * (r - i)), t2 ? yield this.showDataItem(l2, e) : yield this.hideDataItem(l2, e);
          })));
        } else
          yield Promise.all(_(this.dataItems, (e) => t2 ? this.showDataItem(e, 0) : this.hideDataItem(e, 0)));
    });
  }
  updateLegendValue(e) {
    if (e) {
...
Object.defineProperty(D, "className", { enumerable: true, configurable: true, writable: true, value: "Series" }), Object.defineProperty(D, "classNames", { enumerable: true, configurable: true, writable: true, value: _2.classNames.concat([D.className]) });
...
Object.defineProperty(P, "className", { enumerable: true, configurable: true, writable: true, value: "Line" }), Object.defineProperty(P, "classNames", { enumerable: true, configurable: true, writable: true, value: Re.classNames.concat([P.className]) });
var T2 = Math.PI;
var M = 2 * T2;
var O = 1e-6;
var $ = M - O;
...
var F2 = class {
  ...
  arcTo(e, t2, s, i, a) {
    ...
    if (null === this._x1)
      ...
      if (Math.abs(u * n - o * h) > O && a) {
        let c = s - l2, m2 = i - r, p = n * n + o * o, b = c * c + m2 * m2, f2 = Math.sqrt(p), g2 = Math.sqrt(d), _3 = a * Math.tan((T2 - Math.acos((p + d - b) / (2 * f2 * g2))) / 2), v2 = _3 / g2, y2 = _3 / f2;
  ...
  arc(e, t2, s, i, a, l2) {
    ...
    null === this._x1 ? this._append`M${o},${h}` : (Math.abs(this._x1 - o) > O || Math.abs(this._y1 - h) > O) && this._append`L${o},${h}`, s && (d < 0 && (d = d % M + M), d > $ ? this._append`A${s},${s},0,1,${u},${e - r},${t2 - n}A${s},${s},0,1,${u},${this._x1 = o},${this._y1 = h}` : d > O && this._append`A${s},${s},0,${+(d >= T2)},${u},${this._x1 = e + s * Math.cos(a)},${this._y1 = t2 + s * Math.sin(a)}`);
  }
  rect(e, t2, s, i) {
...
var N = class extends Je {
  constructor() {
    super(...arguments), Object.defineProperty(this, "chartContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(Je.new(this._root, { width: z, height: z, interactiveChildren: false })) }), Object.defineProperty(this, "bulletsContainer", { enumerable: true, configurable: true, writable: true, value: Je.new(this._root, { interactiveChildren: false, isMeasured: false, position: "absolute", width: z, height: z }) });
  }
};
Object.defineProperty(N, "className", { enumerable: true, configurable: true, writable: true, value: "Chart" }), Object.defineProperty(N, "classNames", { enumerable: true, configurable: true, writable: true, value: Je.classNames.concat([N.className]) });
var U = class extends N {
  constructor() {
    super(...arguments), Object.defineProperty(this, "seriesContainer", { enumerable: true, configurable: true, writable: true, value: Je.new(this._root, { width: z, height: z, isMeasured: false }) }), Object.defineProperty(this, "series", { enumerable: true, configurable: true, writable: true, value: new F() });
  }
  _afterNew() {
...
//# sourceMappingURL=chunk-QD6H3HLJ.js.map
