import {
  ...
  m as m4,
  o as o3
} from "./chunk-JGVOJ4I6.js";
import {
  g as g4,
  p as p4
} from "./chunk-OTTQOHN6.js";
import "./chunk-D27GCMCT.js";
import {
  i
} from "./chunk-PR2OEILG.js";
import {
  e as e3
} from "./chunk-IGXVIWXU.js";
import {
  t
...
import {
  ...
  p as p3,
  t as t2
} from "./chunk-HZ5YIPSY.js";
import {
  m as m2
} from "./chunk-LRYJOXUI.js";
...
function l4(t3) {
  ...
  for (const o4 of r4.polygons) {
    const t4 = o4.count, i4 = o4.index, c6 = a5(r4.position, 3 * i4, 3 * t4), f7 = o4.holeIndices.map((n2) => n2 - i4), a9 = t(i(c6, f7, 3));
...
async function c4(e9, r4, n2) {
  const { source: o4 } = r4, { loadGLTFMesh: i4 } = await p(import("./loadGLTFMesh-XWFNKIK4.js"), n2), a9 = await f5(o4, n2);
  s3(n2);
...
var p7 = class extends l {
  ...
  set displaySource(r4) {
    ...
    this._explicitDisplaySource = r4, r4 && this.externalSources.every((e9) => !h4(e9, r4)) && this.externalSources.add(r4);
  }
  clearSources() {
...
function A(e9, r4) {
  ...
  zn(n2, [A4.x, A4.y, A4.z], R2, c2(n2)), a4(d4, R2), S(b5, r4, d4), h3(i4, n2, v4), null != u5 && null != x6 && _2(u5, i4, v4, n2, x6), null != a9 && null != j6 && R(a9, i4, v4, n2, j6), k(v4, b5), E(v4, i4, n2), null != u5 && null != x6 && j2(x6, i4, v4, n2, u5), null != a9 && null != j6 && v(j6, i4, v4, n2, a9), e9.vertexAttributesChanged();
}
function b3(t3, e9) {
...
var N2 = B = class extends a3(_.LoadableMixin(m(p2))) {
  ...
  async toBinaryGLTF(e9) {
    const t3 = import("./gltfexport-UKWYSDBC.js"), r4 = this.load(), o4 = await Promise.all([t3, r4]), { toBinaryGLTF: s4 } = o4[0];
    return s4(this, e9);
  }
  get memoryUsage() {
    let e9 = 0;
  ...
  static async createFromGLTF(e9, r4, o4) {
    ...
    const { loadGLTFMesh: n2 } = await p(import("./loadGLTFMesh-XWFNKIK4.js"), o4);
...
function y6(t3, r4, o4) {
  ...
  for (const a9 of n2) {
    ...
    null != t4 && s4.features.push(new h5({ geometry: t4, attributes: m9(a9) }));
  }
  return s4;
}
function E3(e9) {
...
//# sourceMappingURL=meshFeatureSet-AWGVGVNM.js.map
