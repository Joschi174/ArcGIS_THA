...
async function $() {
  has("host-webworker") ? P2 || (P2 = await import("./request-TW2QFRCU.js")) : j._abortableFetch || (j._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function z() {
  n || await import("./IdentityManager-BQDAKPXS.js");
}
...
//# sourceMappingURL=chunk-K7YQIZQM.js.map
