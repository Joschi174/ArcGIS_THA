...
async function $() {
  has("host-webworker") ? P2 || (P2 = await import("./request-43F2KYOA.js")) : j._abortableFetch || (j._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function z() {
  n || await import("./IdentityManager-IODP2DRZ.js");
}
...
//# sourceMappingURL=chunk-QPWNDO2C.js.map
