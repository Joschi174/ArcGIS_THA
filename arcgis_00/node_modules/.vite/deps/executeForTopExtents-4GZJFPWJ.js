...
async function m(m2, s, n) {
  const p2 = f(m2), a = await p(p2, S.from(s), { ...n });
  return { count: a.data.count, extent: M.fromJSON(a.data.extent) };
}
export {
  m as executeForTopExtents
};
//# sourceMappingURL=executeForTopExtents-4GZJFPWJ.js.map
