...
function H(s10, i15, a11) {
  return s10.hasSliceTranslatedView ? null != i15 ? i3(S, a11.camera.viewMatrix, i15) : a11.camera.viewMatrix : null;
}
...
function p2(a11, i15) {
  if (!i15.instancedDoublePrecision)
    return void a11.uniforms.add(new e11("proj", (r17, a12) => a12.camera.projectionMatrix), new o13("view", (a12, e27) => i3(v5, e27.camera.viewMatrix, a12.origin)), new o7("localOrigin", (r17) => r17.origin));
  ...
  a11.uniforms.add(new e11("proj", (r17, a12) => a12.camera.projectionMatrix), new e11("view", (a12, e27) => i3(v5, e27.camera.viewMatrix, o22(e27))), new e8("localOrigin", (r17, a12) => o22(a12)));
}
var v5 = e5();
var w = n();
function u3(r17) {
...
l9.shader = new t10(u2, () => import("./SSAOBlur.glsl-U73TIWMW.js"));
...
l10.shader = new t10(v, () => import("./SSAO.glsl-PHQXEVLX.js"));
...
//# sourceMappingURL=chunk-QSXZDF2T.js.map
