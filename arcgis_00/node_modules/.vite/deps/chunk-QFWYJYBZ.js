...
function a(t2) {
  ...
  let i2 = t2 < 0;
  t2 = Math.abs(t2);
  let s2, r2 = /^([0-9]+)(?:\.([0-9]+))?(?:e[\+\-]([0-9]+))?$/.exec("" + t2), a2 = r2[1], o2 = r2[2] || "";
  if (void 0 === r2[3])
    s2 = "" === o2 ? a2 : a2 + "." + o2;
  else {
    let e2 = +r2[3];
    if (t2 < 1) {
      ...
      let t3 = e2 - o2.length;
      s2 = 0 === t3 ? a2 + o2 : t3 < 0 ? a2 + o2.slice(0, t3) + "." + o2.slice(t3) : a2 + o2 + n("0", t3);
    }
  }
  return i2 ? "-" + s2 : s2;
}
...
var L = class {
  ...
  has(t2, e2, i2) {
    return -1 !== k(this._listeners, (s2) => true !== s2.once && s2.type === t2 && (void 0 === e2 || s2.callback === e2) && s2.context === i2);
  }
  _shouldDispatch(t2) {
    if (this._disposed)
      throw new Error("EventDispatcher is disposed");
  ...
  _on(t2, e2, i2, s2, r2, a2) {
    if (this._disposed)
      throw new Error("EventDispatcher is disposed");
    this._removeExistingListener(t2, e2, i2, s2);
    const n2 = { type: e2, callback: i2, context: s2, shouldClone: r2, dispatch: a2, killed: false, once: t2, disposer: new B(() => {
...
var R = class {
  constructor(t2 = []) {
    Object.defineProperty(this, "_values", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "events", { enumerable: true, configurable: true, writable: true, value: new L() }), this._values = t2;
  }
  get values() {
    return this._values;
  }
  ...
  setIndex(t2, e2) {
    N(t2, this._values.length);
    const i2 = this._values[t2];
    return i2 !== e2 && (this._values[t2] = e2, this._onSetIndex(t2, i2, e2)), i2;
  }
  insertIndex(t2, e2) {
    return N(t2, this._values.length + 1), D(this._values, t2, e2), this._onInsertIndex(t2, e2), e2;
  }
  swap(t2, e2) {
    const i2 = this._values.length;
    if (N(t2, i2), N(e2, i2), t2 !== e2) {
  ...
  removeIndex(t2) {
    ...
    return x(this._values, t2), this._onRemoveIndex(t2, e2), e2;
  }
  moveValue(t2, e2) {
    let i2 = this.indexOf(t2);
    if (-1 !== i2)
      if (x(this._values, i2), null == e2) {
        const e3 = this._values.length;
        this._values.push(t2), this._onMoveIndex(i2, e3, t2);
      } else
        D(this._values, e2, t2), this._onMoveIndex(i2, e2, t2);
    else
      null == e2 ? (this._values.push(t2), this._onPush(t2)) : (D(this._values, e2, t2), this._onInsertIndex(e2, t2));
    return t2;
  }
  push(t2) {
...
var K = class _K {
  ...
  static normalize(t2, e2, i2) {
    return t2 instanceof _K ? t2 : new _K(e2 === i2 ? 0 : 100 * Math.min(Math.max(1 / (i2 - e2) * (t2 - e2), 0), 1));
  }
};
function U(t2) {
  return new K(t2);
...
function pt(t2, e2) {
  return t2.target && ut(e2.root.dom, t2.target);
}
function ct(t2, e2) {
...
function St(t2, e2 = false) {
  const i2 = Tt(new Date(t2.getFullYear(), t2.getMonth(), 1), e2);
  let s2 = Tt(t2, e2);
  return 1 == s2 && (s2 = 53), s2 - i2 + 1;
}
function Et(t2, e2, i2 = 1, s2 = false) {
...
function Mt(t2, e2 = false, i2 = false, s2 = false) {
  if (s2)
    return e2 ? "Coordinated Universal Time" : "UTC";
  let r2 = t2.toLocaleString("UTC"), a2 = t2.toLocaleString("UTC", { timeZoneName: e2 ? "long" : "short" }).substr(r2.length);
...
function At(t2) {
  let e2, i2, s2, r2 = t2.h, a2 = t2.s, n2 = t2.l;
  if (0 == a2)
    e2 = i2 = s2 = n2;
  else {
...
function Ht(t2) {
  let e2 = t2.r / 255, i2 = t2.g / 255, s2 = t2.b / 255, r2 = Math.max(e2, i2, s2), a2 = Math.min(e2, i2, s2), n2 = 0, o2 = 0, h2 = (r2 + a2) / 2;
  if (r2 === a2)
    n2 = o2 = 0;
  else {
    let t3 = r2 - a2;
    switch (o2 = h2 > 0.5 ? t3 / (2 - r2 - a2) : t3 / (r2 + a2), r2) {
      case e2:
        n2 = (i2 - s2) / t3 + (i2 < s2 ? 6 : 0);
        break;
      case i2:
        n2 = (s2 - e2) / t3 + 2;
        break;
...
function Lt(t2, e2) {
  return t2 ? { r: Math.max(0, Math.min(255, t2.r + Nt(t2.r, e2))), g: Math.max(0, Math.min(255, t2.g + Nt(t2.g, e2))), b: Math.max(0, Math.min(255, t2.b + Nt(t2.b, e2))), a: t2.a } : t2;
}
function Nt(t2, e2) {
...
function Rt(t2, e2) {
  if (t2) {
    let i2 = Nt(Math.min(Math.max(t2.r, t2.g, t2.b), 230), e2);
...
function Vt(t2, e2 = { r: 255, g: 255, b: 255 }, i2 = { r: 255, g: 255, b: 255 }) {
  let s2 = e2, r2 = i2;
  return Ft(i2) && (s2 = i2, r2 = e2), Ft(t2) ? r2 : s2;
}
function Kt(t2, e2) {
...
var Xt = class _Xt {
  ...
  toCSSHex() {
    return "#" + bt(this.r.toString(16), 2) + bt(this.g.toString(16), 2) + bt(this.b.toString(16), 2);
  }
  toHSL(t2 = 1) {
    return Ht({ r: this.r, g: this.g, b: this.b, a: t2 });
  }
  static fromHSL(t2, e2, i2) {
    const s2 = At({ h: t2, s: e2, l: i2 });
  ...
  static fromRGB(t2, e2, i2) {
    return new _Xt((0 | i2) + (e2 << 8) + (t2 << 16));
  }
  static fromString(t2) {
    return new _Xt(zt(t2));
  }
  static fromCSS(t2) {
    return new _Xt(Gt(t2));
  }
  static fromAny(t2) {
    if (h(t2)) {
      if ("#" == t2[0])
        return _Xt.fromString(t2);
      if ("rgb" == t2.substr(0, 3))
        return _Xt.fromCSS(t2);
    } else {
      if (l(t2))
        return _Xt.fromHex(t2);
      if (t2 instanceof _Xt)
        return _Xt.fromHex(t2.hex);
    }
    throw new Error("Unknown color syntax: " + t2);
  }
  static alternative(t2, e2, i2) {
    const s2 = Vt({ r: t2.r, g: t2.g, b: t2.b }, e2 ? { r: e2.r, g: e2.g, b: e2.b } : void 0, i2 ? { r: i2.r, g: i2.g, b: i2.b } : void 0);
    return this.fromRGB(s2.r, s2.g, s2.b);
  }
  static interpolate(t2, e2, i2, s2 = "rgb") {
    if ("hsl" == s2) {
      const s3 = e2.toHSL(), r2 = i2.toHSL();
      return _Xt.fromHSL(Zt(t2, s3.h, r2.h), Zt(t2, s3.s, r2.s), Zt(t2, s3.l, r2.l));
    }
    return _Xt.fromRGB(Zt(t2, e2.r, i2.r), Zt(t2, e2.g, i2.g), Zt(t2, e2.b, i2.b));
  }
  static lighten(t2, e2) {
    const i2 = Lt({ r: t2.r, g: t2.g, b: t2.b }, e2);
    return _Xt.fromRGB(i2.r, i2.g, i2.b);
  }
...
function qt(t2, e2, i2) {
  return new K(Zt(t2, e2.percent, i2.percent));
}
function Qt(t2, e2, i2) {
  return Xt.interpolate(t2, e2, i2);
}
function te(t2, e2) {
  return "number" == typeof t2 && "number" == typeof e2 ? Zt : t2 instanceof K && e2 instanceof K ? qt : t2 instanceof Xt && e2 instanceof Xt ? Qt : Jt;
}
var ee = Math.PI;
var ie = ee / 180;
var se = 180 / ee;
...
function de(t2, e2, i2, s2, r2) {
  ...
  for (let p2 = d2; p2 <= u2; p2 += 90)
    p2 >= i2 && p2 <= s2 && l2.push(ue(r2, p2));
  for (let p2 = 0; p2 < l2.length; p2++) {
    let t3 = l2[p2];
    t3.x < a2 && (a2 = t3.x), t3.y < n2 && (n2 = t3.y), t3.x > o2 && (o2 = t3.x), t3.y > h2 && (h2 = t3.y);
  }
  return { left: t2 + a2, top: e2 + n2, right: t2 + o2, bottom: e2 + h2 };
}
function ue(t2, e2) {
  return { x: t2 * he(e2), y: t2 * oe(e2) };
}
function pe(t2) {
  const e2 = t2.length;
  if (e2 > 0) {
    let i2 = t2[0], s2 = i2.left, r2 = i2.top, a2 = i2.right, n2 = i2.bottom;
    if (e2 > 1)
      for (let o2 = 1; o2 < e2; o2++)
        i2 = t2[o2], s2 = Math.min(i2.left, s2), a2 = Math.max(i2.right, a2), r2 = Math.min(i2.top, r2), n2 = Math.max(i2.bottom, n2);
...
var me = class {
  ...
  applyAnimate(t2) {
    ...
    null == e2 && (e2 = this.get("stateAnimationEasing", this._entity.get("stateAnimationEasing", ge)));
    ...
    return this._eachSetting((a2, n2) => {
      if (!s2[a2]) {
        ...
        const o2 = this._entity.animate({ key: a2, to: n2, duration: t2, easing: e2 });
        o2 && (r2[a2] = o2);
      }
    }), r2;
  }
...
var fe = class {
  ...
  create(t2, e2) {
    ...
    {
      const i3 = new me(this._entity, e2);
...
function Pe(t2, e2, i2) {
  const s2 = t2.length, r2 = e2.length, a2 = Math.min(s2, r2);
  for (let n2 = 0; n2 < a2; ++n2) {
    const s3 = i2(t2[n2], e2[n2]);
    if (0 !== s3)
      return s3;
  }
  return we(s2, r2);
...
var ke = class {
  constructor(t2, e2, i2, s2, r2, a2, n2) {
    Object.defineProperty(this, "_animation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_from", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_to", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_duration", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_easing", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_loops", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_interpolate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_oldTime", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_time", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_stopped", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_playing", { enumerable: true, configurable: true, writable: true, value: true }), Object.defineProperty(this, "events", { enumerable: true, configurable: true, writable: true, value: new L() }), this._animation = t2, this._from = e2, this._to = i2, this._duration = s2, this._easing = r2, this._loops = a2, this._interpolate = te(e2, i2), this._oldTime = n2;
  }
  get to() {
    return this._to;
  }
...
var Te = class {
  constructor(t2) {
    Object.defineProperty(this, "uid", { enumerable: true, configurable: true, writable: true, value: ++Oe }), Object.defineProperty(this, "_settings", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_privateSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_settingEvents", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_privateSettingEvents", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_prevSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_prevPrivateSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_animatingSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_animatingPrivateSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_disposed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_userProperties", { enumerable: true, configurable: true, writable: true, value: {} }), this._settings = t2;
  }
  _checkDirty() {
    Y(this._settings).forEach((t2) => {
  ...
  _runAnimation(t2) {
    ...
    {
      let e2 = false;
      return Z(this._animatingSettings, (i2, s2) => {
        if (s2._stopped)
          this._stopAnimation(i2);
        else if (s2._playing) {
          s2._run(t2);
          const r2 = s2.percentage;
          r2 >= 1 ? s2._checkEnded() ? this.set(i2, s2._value(1)) : (e2 = true, s2._reset(t2), this._set(i2, s2._value(1))) : (e2 = true, this._set(i2, s2._value(r2)));
        }
      }), Z(this._animatingPrivateSettings, (i2, s2) => {
        if (s2._stopped)
          this._stopAnimationPrivate(i2);
        else if (s2._playing) {
          s2._run(t2);
          const r2 = s2.percentage;
          r2 >= 1 ? s2._checkEnded() ? this.setPrivate(i2, s2._value(1)) : (e2 = true, s2._reset(t2), this._setPrivate(i2, s2._value(1))) : (e2 = true, this._setPrivate(i2, s2._value(r2)));
        }
      }), e2;
    }
  }
  ...
  _stopAnimation(t2) {
    ...
    e2 && (delete this._animatingSettings[t2], e2.stop());
  }
  set(t2, e2) {
  ...
  _stopAnimationPrivate(t2) {
    ...
    e2 && (e2.stop(), delete this._animatingPrivateSettings[t2]);
  }
  setPrivate(t2, e2) {
  ...
  animate(t2) {
    const e2 = t2.key, i2 = t2.to, s2 = t2.duration || 0, r2 = t2.loops || 1, a2 = void 0 === t2.from ? this.get(e2) : t2.from, n2 = void 0 === t2.easing ? ce : t2.easing;
    if (0 === s2)
      this.set(e2, i2);
    else {
      if (void 0 !== a2 && a2 !== i2) {
        this.set(e2, a2);
        const t3 = this._animatingSettings[e2] = new ke(this, a2, i2, s2, n2, r2, this._animationTime());
        return this._startAnimation(), t3;
      }
      this.set(e2, i2);
    }
    const o2 = new ke(this, a2, i2, s2, n2, r2, null);
    return o2.stop(), o2;
  }
  animatePrivate(t2) {
    const e2 = t2.key, i2 = t2.to, s2 = t2.duration || 0, r2 = t2.loops || 1, a2 = void 0 === t2.from ? this.getPrivate(e2) : t2.from, n2 = void 0 === t2.easing ? ce : t2.easing;
    if (0 === s2)
      this.setPrivate(e2, i2);
    else {
      if (void 0 !== a2 && a2 !== i2) {
        this.setPrivate(e2, a2);
        const t3 = this._animatingPrivateSettings[e2] = new ke(this, a2, i2, s2, n2, r2, this._animationTime());
        return this._startAnimation(), t3;
      }
      this.setPrivate(e2, i2);
    }
...
var je = class extends Te {
  ...
  _clearDirty() {
    Y(this._dirty).forEach((t2) => {
      this._dirty[t2] = false;
    }), Y(this._dirtyPrivate).forEach((t2) => {
  ...
  _applyTemplate(t2, e2) {
    this._templateDisposers.push(t2._apply(this, e2)), Z(t2._settings, (t3, i2) => {
      e2.settings[t3] || this._userProperties[t3] || (e2.settings[t3] = true, super.set(t3, i2));
    }), Z(t2._privateSettings, (t3, i2) => {
  ...
  _findTemplate(t2) {
    ...
    if (void 0 === e2) {
      ...
      return void 0 === e3 ? T(this._templates, t2) : e3;
    }
    return e2;
  }
  ...
  _applyThemes() {
    ...
    return r2 && m(r2, (t3) => {
      ...
      const a2 = r3.get("themes");
      a2 && i2.push(a2);
      const n2 = r3.get("themeTags");
      n2 && m(n2, (t3) => {
        s2.add(t3);
      });
        ...
        m(i3, (i4) => {
          ...
          r3 && f(r3, (t4) => {
            if (t4.tags.every((t5) => s2.has(t5))) {
              const i5 = E(e3, (e4) => {
                const i6 = we(t4.tags.length, e4.tags.length);
                return 0 === i6 ? Pe(t4.tags, e4.tags, we) : i6;
              });
  ...
  _beforeChanged() {
    if (this.isDirty("id")) {
      ...
      e2 && delete ve.entitiesById[e2];
    }
  }
  _registerId(t2) {
    if (ve.entitiesById[t2] && ve.entitiesById[t2] !== this)
      throw new Error('An entity with id "' + t2 + '" already exists.');
    ve.entitiesById[t2] = this;
  }
  _afterChanged() {
  }
  addDisposer(t2) {
  ...
  _dispose() {
    ...
    t2 && t2._removeObjectTemplate(this), m(this._internalTemplates, (t3) => {
      ...
      t3.dispose();
    }), Z(this._disposerProperties, (t3, e3) => {
      m(e3, (t4) => {
        t4.dispose();
      });
    });
...
Object.defineProperty(je, "className", { enumerable: true, configurable: true, writable: true, value: "Entity" }), Object.defineProperty(je, "classNames", { enumerable: true, configurable: true, writable: true, value: ["Entity"] });
var Se = class {
...
var Ee = class {
  ...
  create(t2, e2) {
    ...
    if (i2)
      return i2.setAll(e2), i2;
    {
      const i3 = new Se(t2, this._template, e2);
  ...
  _apply(t2, e2) {
    Z(this._states, (i2, s2) => {
      let r2 = e2.states[i2];
      null == r2 && (r2 = e2.states[i2] = {});
      const a2 = t2.states.create(i2, {});
      s2._apply(a2, r2);
    });
  }
};
var Ce = class {
  ...
  _apply(t2) {
    const e2 = [];
    return Z(this._callbacks, (i2, s2) => {
      m(s2, (s3) => {
...
var Me = class _Me {
  constructor(t2, e2) {
    if (Object.defineProperty(this, "_settings", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_privateSettings", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_settingEvents", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_privateSettingEvents", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_entities", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "states", { enumerable: true, configurable: true, writable: true, value: new Ee(this) }), Object.defineProperty(this, "adapters", { enumerable: true, configurable: true, writable: true, value: new Ce() }), Object.defineProperty(this, "events", { enumerable: true, configurable: true, writable: true, value: new L() }), Object.defineProperty(this, "setup", { enumerable: true, configurable: true, writable: true, value: void 0 }), !e2)
      throw new Error("You cannot use `new Class()`, instead use `Class.new()`");
    this._settings = t2;
  }
  static new(t2) {
    return new _Me(t2, true);
  }
  get entities() {
  ...
  _apply(t2, e2) {
    const i2 = [];
    return Z(this._settingEvents, (e3, s2) => {
      m(s2, (s3) => {
        i2.push(t2.on(e3, s3));
      });
    }), Z(this._privateSettingEvents, (e3, s2) => {
      m(s2, (s3) => {
        i2.push(t2.onPrivate(e3, s3));
      });
    }), this.states._apply(t2, e2), i2.push(this.adapters._apply(t2)), i2.push(t2.events.copyFrom(this.events)), new A(i2);
  }
...
var Be = class _Be extends L {
  ...
  _onRenderer(t2, e2) {
    ...
    if (void 0 === i2) {
      ...
      i2 = this._rendererDisposers[t2] = new H(() => {
  ...
  _on(t2, e2, i2, s2, r2, a2) {
    const n2 = super._on(t2, e2, i2, s2, r2, a2), o2 = _Be.RENDERER_EVENTS[e2];
    return void 0 !== o2 && (n2.disposer = new A([n2.disposer, this._onRenderer(e2, o2)])), n2;
  }
  stopParentDispatch() {
...
Object.defineProperty(Be, "RENDERER_EVENTS", { enumerable: true, configurable: true, writable: true, value: { click: function(t2) {
...
var Ie = class extends je {
  ...
  _processTemplateField() {
    ...
    if (e2) {
      ...
      if (i2) {
        ...
        s2 && (t2 = s2[e2], t2 instanceof Me || !t2 || (t2 = Me.new(t2)));
      }
    }
  ...
  _addPercentageSizeChildren() {
    let t2 = this.parent;
    t2 && (this.get("width") instanceof K || this.get("height") instanceof K ? w(t2._percentageSizeChildren, this) : y(t2._percentageSizeChildren, this));
  }
  _addPercentagePositionChildren() {
    let t2 = this.parent;
    t2 && (this.get("x") instanceof K || this.get("y") instanceof K ? w(t2._percentagePositionChildren, this) : y(t2._percentagePositionChildren, this));
  }
  markDirtyPosition() {
  ...
  updatePivotPoint() {
    ...
    if (t2) {
      ...
      null != e2 && (this._display.pivot.x = t2.left + mt(e2, t2.right - t2.left));
      const i2 = this.get("centerY");
      null != i2 && (this._display.pivot.y = t2.top + mt(i2, t2.bottom - t2.top));
    }
  }
  _beforeChanged() {
    ...
    if ((this.isDirty("layer") || this.isDirty("layerMargin")) && (this._display.setLayer(this.get("layer"), this.get("layerMargin")), this.markDirtyLayer()), this.isDirty("tooltipPosition")) {
      ...
      e2 && (e2.dispose(), this._tooltipPointerDp = void 0), "pointer" == this.get("tooltipPosition") && (this._tooltipPointerDp = new A([this.events.on("pointerover", () => {
  ...
  _changed() {
    ...
    if (this.isDirty("draggable")) {
      ...
      i2 ? (this.set("interactive", true), this._dragDp = new A([e2.on("pointerdown", (t3) => {
        this.dragStart(t3);
    ...
    if (this.isDirty("tooltipText") || this.isDirty("tooltipHTML") || this.isDirty("showTooltipOn")) {
      ...
      this._tooltipDp && (this._tooltipDp.dispose(), this._tooltipDp = void 0), (t3 || i2) && ("click" == s2 ? this._tooltipDp = new A([e2.on("click", () => {
        this.setTimeout(() => this.showTooltip(), 10);
      }), tt(document, "click", (t4) => {
        this.hideTooltip();
      })]) : "always" == s2 || (this._tooltipDp = new A([e2.on("pointerover", () => {
        this.showTooltip();
      }), e2.on("pointerout", () => {
        this.hideTooltip();
      })])));
    ...
    if ((this.isDirty("tabindexOrder") || this.isDirty("focusableGroup")) && (this.get("focusable") ? this._root._registerTabindexOrder(this) : this._root._unregisterTabindexOrder(this)), this.isDirty("filter") && (t2.filter = this.get("filter")), this.isDirty("cursorOverStyle") && (t2.cursorOverStyle = this.get("cursorOverStyle")), this.isDirty("hoverOnFocus") && (this.get("hoverOnFocus") ? this._focusDp = new A([e2.on("focus", () => {
      ...
      this.get("interactive") ? this._hoverDp = new A([t3.on("click", (t4) => {
        ot(t4.originalEvent) && (this.getPrivate("touchHovering") || this.setTimeout(() => {
  ...
  _handleUp(t2) {
    if (!this.isHidden()) {
      ...
      const e2 = st(t2.originalEvent);
      delete this._downPoints[e2], 0 == Y(this._downPoints).length && (this._isDown = false);
    }
  }
  _hasMoved(t2) {
    const e2 = st(t2.originalEvent), i2 = this._downPoints[e2];
    if (i2) {
  ...
  _hasDown() {
    return Y(this._downPoints).length > 0;
  }
  _handleDown(t2) {
  ...
  dragMove(t2) {
    ...
    if (e2) {
      ...
      let r2 = t2.point.x - e2.point.x, a2 = t2.point.y - e2.point.y;
      const n2 = this.events;
      if (e2.simulated && !this._isDragging) {
        this._isDragging = true, this._dragEvent = t2, this._dragPoint = { x: this.x(), y: this.y() };
        const e3 = "dragstart";
        n2.isEnabled(e3) && n2.dispatch(e3, { type: e3, target: this, originalEvent: t2.originalEvent, point: t2.point, simulated: t2.simulated });
      }
      if (this._isDragging) {
        let e3 = this._dragPoint;
        this.set("x", e3.x + r2 * he(i2) + a2 * oe(i2)), this.set("y", e3.y + a2 * he(i2) - r2 * oe(i2));
        const s3 = "dragged";
        n2.isEnabled(s3) && n2.dispatch(s3, { type: s3, target: this, originalEvent: t2.originalEvent, point: t2.point, simulated: t2.simulated });
      } else if (Math.hypot(r2, a2) > 5) {
        this._isDragging = true, this._dragEvent = t2, this._dragPoint = { x: this.x(), y: this.y() };
        const e3 = "dragstart";
        n2.isEnabled(e3) && n2.dispatch(e3, { type: e3, target: this, originalEvent: t2.originalEvent, point: t2.point, simulated: t2.simulated });
      }
  ...
  showTooltip(t2) {
    ...
    if ((i2 || s2) && e2) {
      ...
      "fixed" != r2 && t2 || (this._display._setMatrix(), t2 = this.toGlobal(a2._getTooltipPoint())), e2.set("pointTo", t2), e2.set("tooltipTarget", a2), e2.get("x") || e2.set("x", t2.x), e2.get("y") || e2.set("y", t2.y), i2 && e2.label.set("text", i2), s2 && e2.label.set("html", s2);
      const n2 = this.dataItem;
      if (n2 && e2.label._setDataItem(n2), "always" == this.get("showTooltipOn") && (t2.x < 0 || t2.x > this._root.width() || t2.y < 0 || t2.y > this._root.height()))
  ...
  hideTooltip() {
    ...
    if (t2 && t2.get("tooltipTarget") == this.getPrivate("tooltipTarget", this)) {
  ...
  _getTooltipPoint() {
    ...
    if (t2) {
      let e2 = 0, i2 = 0;
      return this.get("isMeasured") ? (e2 = t2.left + mt(this.get("tooltipX", 0), t2.right - t2.left), i2 = t2.top + mt(this.get("tooltipY", 0), t2.bottom - t2.top)) : (e2 = mt(this.get("tooltipX", 0), this.width()), i2 = mt(this.get("tooltipY", 0), this.height())), { x: e2, y: i2 };
    }
    return { x: 0, y: 0 };
  }
  getTooltip() {
  ...
  _updatePosition() {
    ...
    let e2 = this.get("dx", 0), i2 = this.get("dy", 0), s2 = this.get("x"), r2 = this.getPrivate("x"), a2 = 0, n2 = 0;
    const o2 = this.get("position");
    s2 instanceof K && (s2 = t2 ? t2.innerWidth() * s2.value + t2.get("paddingLeft", 0) : 0), l(s2) ? a2 = s2 + e2 : null != r2 ? a2 = r2 : t2 && "relative" == o2 && (a2 = t2.get("paddingLeft", 0) + e2);
    let h2 = this.get("y"), d2 = this.getPrivate("y");
    h2 instanceof K && (h2 = t2 ? t2.innerHeight() * h2.value + t2.get("paddingTop", 0) : 0), l(h2) ? n2 = h2 + i2 : null != d2 ? n2 = d2 : t2 && "relative" == o2 && (n2 = t2.get("paddingTop", 0) + i2);
    const u2 = this._display;
    if (u2.x != a2 || u2.y != n2) {
      u2.invalidateBounds(), u2.x = a2, u2.y = n2;
  ...
  x() {
    ...
    return i2 ? t2 instanceof K ? mt(t2, i2.innerWidth()) + i2.get("paddingLeft", 0) : l(t2) ? t2 : null != e2 ? e2 : i2.get("paddingLeft", this._display.x) : this._display.x;
  }
  y() {
    ...
    let e2 = this.get("y");
    const i2 = this.parent;
    return i2 ? e2 instanceof K ? mt(e2, i2.innerHeight()) + i2.get("paddingTop", 0) : l(e2) ? e2 : null != t2 ? t2 : i2.get("paddingTop", this._display.y) : this._display.y;
  }
  _dispose() {
  ...
  show(e2) {
    return t(this, void 0, void 0, function* () {
      if (!this._isShowing) {
        ...
        yield $t(t2), this._isShowing = false;
      }
    });
  }
  hide(e2) {
  ...
  _getDownPointId() {
    if (this._downPoints)
      return X(this._downPoints, (t2, e2) => t2 > e2 ? 1 : t2 < e2 ? -1 : 0)[0];
  }
  toFront() {
    const t2 = this.parent;
...
Object.defineProperty(Ie, "className", { enumerable: true, configurable: true, writable: true, value: "Sprite" }), Object.defineProperty(Ie, "classNames", { enumerable: true, configurable: true, writable: true, value: je.classNames.concat([Ie.className]) });
...
Object.defineProperty(Ae, "className", { enumerable: true, configurable: true, writable: true, value: "Pattern" }), Object.defineProperty(Ae, "classNames", { enumerable: true, configurable: true, writable: true, value: je.classNames.concat([Ae.className]) });
var He = class extends Ae {
  ...
  _draw() {
    ...
    if (t2) {
      ...
      let r2 = 0, a2 = 0;
      "pattern" == s2 ? (r2 = e2, a2 = i2) : (r2 = t2.width, a2 = t2.height, "image" == s2 && (this.set("width", r2), this.set("height", a2)));
      let n2 = 0, o2 = 0;
      this.get("centered", true) && (n2 = e2 / 2 - r2 / 2, o2 = i2 / 2 - a2 / 2), this._display.image(t2, r2, a2, n2, o2);
    }
  }
  _load() {
...
var Le;
Object.defineProperty(He, "className", { enumerable: true, configurable: true, writable: true, value: "PicturePattern" }), Object.defineProperty(He, "classNames", { enumerable: true, configurable: true, writable: true, value: Ae.classNames.concat([He.className]) }), function(t2) {
...
var Ne = ["fill", "fillOpacity", "stroke", "strokeWidth", "strokeOpacity", "fillPattern", "strokePattern", "fillGradient", "strokeGradient", "strokeDasharray", "strokeDashoffset"];
var Re = class extends Ie {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      ...
      const i2 = this.get("blendMode", Le.NORMAL);
  ...
  _afterChanged() {
    if (super._afterChanged(), this._clear) {
      const t2 = this.get("fill"), e2 = this.get("fillGradient"), i2 = this.get("fillPattern"), s2 = this.get("fillOpacity"), r2 = this.get("stroke"), a2 = this.get("strokeGradient"), n2 = this.get("strokePattern"), o2 = this.get("shadowColor"), h2 = this.get("shadowBlur"), l2 = this.get("shadowOffsetX"), d2 = this.get("shadowOffsetY"), u2 = this.get("shadowOpacity");
      if (o2 && (h2 || l2 || d2) && this._display.shadow(o2, h2, l2, d2, u2), i2) {
        ...
        const a3 = i2.pattern;
        a3 && (this._display.beginFill(a3, s2), this._display.endFill(), i2 instanceof He && i2.events.once("loaded", () => {
      ...
      if (r2 || a2 || n2) {
        ...
        if (n2) {
          let s3 = false;
          !r2 || n2.get("color") && !n2.get("colorInherited") || (n2.set("color", r2), n2.set("colorInherited", true), s3 = true), s3 && n2._changed();
          const a3 = n2.pattern;
          a3 && (this._display.lineStyle(e3, a3, t3, i3), this._display.endStroke(), n2 instanceof He && n2.events.once("loaded", () => {
            this._clear = true, this.markDirty();
          }));
        } else if (a2) {
          ...
          n3 && (this._display.lineStyle(e3, n3, t3, i3), this._display.endStroke());
        } else
...
Object.defineProperty(Re, "className", { enumerable: true, configurable: true, writable: true, value: "Graphics" }), Object.defineProperty(Re, "classNames", { enumerable: true, configurable: true, writable: true, value: Ie.classNames.concat([Re.className]) });
var Fe = class extends Re {
  _beforeChanged() {
...
Object.defineProperty(Fe, "className", { enumerable: true, configurable: true, writable: true, value: "Rectangle" }), Object.defineProperty(Fe, "classNames", { enumerable: true, configurable: true, writable: true, value: Re.classNames.concat([Fe.className]) });
var Ve = class extends je {
};
Object.defineProperty(Ve, "className", { enumerable: true, configurable: true, writable: true, value: "Layout" }), Object.defineProperty(Ve, "classNames", { enumerable: true, configurable: true, writable: true, value: je.classNames.concat([Ve.className]) });
  ...
  updateContainer(t2) {
    ...
    We(t2, (t3) => {
      if (t3.isVisible() && "relative" == t3.get("position")) {
        ...
        if (e3 instanceof K) {
          s2 += e3.value;
          let r3 = i2 * e3.value, a2 = t3.get("minWidth", t3.getPrivate("minWidth", -1 / 0));
          a2 > r3 && (i2 -= a2, s2 -= e3.value);
          let n2 = t3.get("maxWidth", t3.getPrivate("maxWidth", 1 / 0));
          r3 > n2 && (i2 -= n2, s2 -= e3.value);
        } else
          l(e3) || (e3 = t3.width()), i2 -= e3 + t3.get("marginLeft", 0) + t3.get("marginRight", 0);
      }
    }), (i2 <= 0 || i2 == 1 / 0) && (i2 = 0.1), We(t2, (t3) => {
      if (t3.isVisible() && "relative" == t3.get("position")) {
        let e3 = t3.get("width");
        if (e3 instanceof K) {
          let r3 = i2 * e3.value / s2 - t3.get("marginLeft", 0) - t3.get("marginRight", 0), a2 = t3.get("minWidth", t3.getPrivate("minWidth", -1 / 0)), n2 = t3.get("maxWidth", t3.getPrivate("maxWidth", 1 / 0));
          r3 = Math.min(Math.max(a2, r3), n2), t3.setPrivate("width", r3);
        }
      }
    });
    let r2 = e2;
    We(t2, (t3) => {
      if ("relative" == t3.get("position"))
        if (t3.isVisible()) {
          let e3 = t3.adjustedLocalBounds(), i3 = t3.get("marginLeft", 0), s3 = t3.get("marginRight", 0), a2 = t3.get("maxWidth"), n2 = e3.left, o2 = e3.right;
          a2 && o2 - n2 > a2 && (o2 = n2 + a2);
          let h2 = r2 + i3 - n2;
...
Object.defineProperty(Ke, "className", { enumerable: true, configurable: true, writable: true, value: "HorizontalLayout" }), Object.defineProperty(Ke, "classNames", { enumerable: true, configurable: true, writable: true, value: Ve.classNames.concat([Ke.className]) });
  ...
  updateContainer(t2) {
    ...
    We(t2, (t3) => {
      if (t3.isVisible() && "relative" == t3.get("position")) {
        ...
        if (e3 instanceof K) {
          s2 += e3.value;
          let r3 = i2 * e3.value, a2 = t3.get("minHeight", t3.getPrivate("minHeight", -1 / 0));
          a2 > r3 && (i2 -= a2, s2 -= e3.value);
          let n2 = t3.get("maxHeight", t3.getPrivate("maxHeight", 1 / 0));
          r3 > n2 && (i2 -= n2, s2 -= e3.value);
        } else
      ...
      if (t3.isVisible() && "relative" == t3.get("position")) {
        let e3 = t3.get("height");
        if (e3 instanceof K) {
          let r3 = i2 * e3.value / s2 - t3.get("marginTop", 0) - t3.get("marginBottom", 0), a2 = t3.get("minHeight", t3.getPrivate("minHeight", -1 / 0)), n2 = t3.get("maxHeight", t3.getPrivate("maxHeight", 1 / 0));
          r3 = Math.min(Math.max(a2, r3), n2), t3.setPrivate("height", r3);
        }
      }
    });
    let r2 = e2;
    We(t2, (t3) => {
      if ("relative" == t3.get("position"))
        if (t3.isVisible()) {
          let e3 = t3.adjustedLocalBounds(), i3 = t3.get("marginTop", 0), s3 = e3.top, a2 = e3.bottom, n2 = t3.get("maxHeight");
          n2 && a2 - s3 > n2 && (a2 = s3 + n2);
          let o2 = t3.get("marginBottom", 0), h2 = r2 + i3 - s3;
          t3.setPrivate("y", h2), r2 = h2 + a2 + o2;
        } else
          t3.setPrivate("y", void 0);
    });
  }
};
Object.defineProperty(Ue, "className", { enumerable: true, configurable: true, writable: true, value: "VerticalLayout" }), Object.defineProperty(Ue, "classNames", { enumerable: true, configurable: true, writable: true, value: Ve.classNames.concat([Ue.className]) });
var ze = class extends Ve {
  _afterNew() {
    this._setRawDefault("maxColumns", Number.MAX_VALUE), super._afterNew();
  }
  updateContainer(t2) {
    let e2 = t2.get("paddingLeft", 0), i2 = t2.get("paddingRight", 0), s2 = t2.get("paddingTop", 0), r2 = t2.maxWidth() - e2 - i2, a2 = r2, n2 = 1;
    We(t2, (t3) => {
      if (t3.get("visible") && t3.getPrivate("visible") && !t3.get("forceHidden") && "absolute" != t3.get("position")) {
        let e3 = t3.width();
        e3 < a2 && (a2 = e3), e3 > n2 && (n2 = e3);
      }
    }), a2 = ne(a2, 1, r2), n2 = ne(n2, 1, r2);
    let o2 = 1;
    o2 = this.get("fixedWidthGrid") ? r2 / n2 : r2 / a2, o2 = Math.max(1, Math.floor(o2)), o2 = Math.min(this.get("maxColumns", Number.MAX_VALUE), o2);
    let h2 = this.getColumnWidths(t2, o2, n2, r2), l2 = s2, d2 = 0, u2 = 0;
    o2 = h2.length;
    let p2 = e2;
    We(t2, (t3) => {
      if ("relative" == t3.get("position") && t3.isVisible()) {
        const i3 = t3.get("marginTop", 0), s3 = t3.get("marginBottom", 0);
        let r3 = t3.adjustedLocalBounds(), a3 = t3.get("marginLeft", 0), n3 = t3.get("marginRight", 0), c2 = p2 + a3 - r3.left, g2 = l2 + i3 - r3.top;
        t3.setPrivate("x", c2), t3.setPrivate("y", g2), p2 += h2[d2] + n3, u2 = Math.max(u2, t3.height() + i3 + s3), d2++, d2 >= o2 && (d2 = 0, p2 = e2, l2 += u2);
      }
    });
  }
  getColumnWidths(t2, e2, i2, s2) {
    ...
    return We(t2, (s3) => {
      ...
      "absolute" != s3.get("position") && s3.isVisible() && (this.get("fixedWidthGrid") ? a2[n2] = i2 : a2[n2] = Math.max(0 | a2[n2], r3.right - r3.left + s3.get("marginLeft", 0) + s3.get("marginRight", 0)), n2 < t2.children.length - 1 && (n2++, n2 == e2 && (n2 = 0)));
    }), m(a2, (t3) => {
      r2 += t3;
    }), r2 > s2 ? e2 > 2 ? (e2 -= 1, this.getColumnWidths(t2, e2, i2, s2)) : [s2] : a2;
  }
};
Object.defineProperty(ze, "className", { enumerable: true, configurable: true, writable: true, value: "GridLayout" }), Object.defineProperty(ze, "classNames", { enumerable: true, configurable: true, writable: true, value: Ve.classNames.concat([ze.className]) });
var Ge = class {
  static escape(t2) {
...
function Ye(t2, e2) {
  if (null != e2) {
    e2 = "" + e2;
    let i2, s2 = (e2 = Ge.escape(e2)).match(/\{([^}]+)\}/g);
    if (s2)
      for (i2 = 0; i2 < s2.length; i2++) {
        let r2 = Xe(t2, s2[i2].replace(/\{([^}]+)\}/, "$1"));
...
function Xe(t2, e2, i2) {
  ...
  for (; a2 = o2.exec(e2), null !== a2; )
    if (a2[3]) {
      ...
      n2.push({ method: a2[1], params: t3 });
    }
  if (r2) {
    s2 = Ze(t2, n2, r2._settings), (null == s2 || d(s2)) && (s2 = Ze(t2, n2, r2));
    let i3 = r2.dataContext;
    null == s2 && i3 && (s2 = Ze(t2, n2, i3), null == s2 && (s2 = Ze(t2, [{ prop: e2 }], i3)), null == s2 && i3.dataContext && (s2 = Ze(t2, n2, i3.dataContext))), null == s2 && r2.component && r2.component.dataItem !== r2 && (s2 = Xe(r2.component, e2));
  }
  return null == s2 && (s2 = Ze(t2, n2, t2)), null == s2 && t2.parent && (s2 = Xe(t2.parent, e2)), s2;
}
function $e(t2, e2) {
  ...
  for (let l2 = 0, u2 = i2.length; l2 < u2; l2++) {
    ...
    if (u3.prop) {
      if (h2 instanceof Ie) {
        ...
        null == t3 && (t3 = h2.getPrivate(u3.prop)), null == t3 && (t3 = $e(h2, u3.prop)), null == t3 && (t3 = h2[u3.prop]), h2 = t3;
      } else if (h2.get) {
        let t3 = h2.get(u3.prop);
      ...
      switch (u3.method) {
        case "formatNumber":
          let i3 = s(h2);
          null != i3 && (h2 = t2.getNumberFormatter().format(i3, n2 || u3.params[0] || void 0), d2 = true);
          break;
        case "formatDate":
          let l3 = r(h2);
          if (!o(l3) || e(l3.getTime()))
            return;
          null != l3 && (h2 = t2.getDateFormatter().format(l3, n2 || u3.params[0] || void 0), d2 = true);
          break;
        case "formatDuration":
          let p2 = s(h2);
          null != p2 && (h2 = t2.getDurationFormatter().format(p2, n2 || u3.params[0] || void 0, u3.params[1] || void 0), d2 = true);
          break;
        case "urlEncode":
        case "encodeURIComponent":
          ...
          break;
        default:
          h2[u3.method] && h2[u3.method].apply(a2, u3.params);
      }
  }
  if (!d2) {
    let e2 = [{ method: "", params: n2 }];
    if (null == n2)
...
var Je = class _Je extends Ie {
  ...
  _changed() {
    if (super._changed(), this.isDirty("interactiveChildren") && (this._display.interactiveChildren = this.get("interactiveChildren", false)), this.isDirty("layout") && (this._prevWidth = 0, this._prevHeight = 0, this.markDirtyBounds(), this._prevSettings.layout && this.children.each((t2) => {
      ...
      this.get("maskContent") ? e2 || (e2 = Fe.new(this._root, { x: -0.5, y: -0.5, width: this.width() + 1, height: this.height() + 1 }), this._contentMask = e2, t2.addChildAt(e2._display, 0), t2.mask = e2._display) : e2 && (t2.removeChild(e2._display), t2.mask = null, e2.dispose(), this._contentMask = void 0);
    }
  }
  _updateSize() {
  ...
  updateBackground() {
    ...
    if (e2 && !this.isHidden()) {
      let i2 = e2.left, s2 = e2.top, r2 = e2.right - i2, a2 = e2.bottom - s2, n2 = this.get("maxWidth"), o2 = this.get("maxHeight");
      o2 && a2 > o2 && (a2 = o2), n2 && r2 > n2 && (r2 = n2);
      let h2 = this.width(), l2 = this.height();
      t2 && (t2.setAll({ width: r2, height: a2, x: i2, y: s2 }), this._display.interactive && (t2._display.interactive = true));
  ...
  _getBounds() {
    let t2 = this.get("width"), e2 = this.get("height"), i2 = this.getPrivate("width"), s2 = this.getPrivate("height"), r2 = { left: 0, top: 0, right: this.width(), bottom: this.height() }, a2 = this.get("layout"), n2 = false, o2 = false;
    if ((a2 instanceof Ke || a2 instanceof ze) && (n2 = true), a2 instanceof Ue && (o2 = true), null == t2 && null == i2 || null == e2 && null == s2 || this.get("verticalScrollbar")) {
      let t3 = Number.MAX_VALUE, e3 = t3, i3 = -t3, s3 = t3, a3 = -t3;
      ...
      this.children.each((t4) => {
        if ("absolute" != t4.get("position") && t4.get("isMeasured")) {
          ...
          n2 && (d3 -= t4.get("marginLeft", 0), u3 += t4.get("marginRight", 0)), o2 && (p2 -= t4.get("marginTop", 0), c2 += t4.get("marginBottom", 0)), d3 < e3 && (e3 = d3), u3 > i3 && (i3 = u3), p2 < s3 && (s3 = p2), c2 > a3 && (a3 = c2);
        }
      }), e3 == t3 && (e3 = 0), i3 == -t3 && (i3 = 0), s3 == t3 && (s3 = 0), a3 == -t3 && (a3 = 0), r2.left = e3 - h2, r2.top = s3 - l2, r2.right = i3 + d2, r2.bottom = a3 + u2;
    } else
      ;
  ...
  _prepareChildren() {
    ...
    if (t2 != this._prevWidth || e2 != this._prevHeight) {
      ...
      i2 && ((i2 instanceof Ke || i2 instanceof ze) && (s2 = true), i2 instanceof Ue && (r2 = true)), m(this._percentageSizeChildren, (i3) => {
        if (!s2) {
          let e3 = i3.get("width");
  ...
  _updateChildren() {
    if (this.isDirty("html")) {
      ...
      t2 && "" !== t2 ? this._root._setHTMLContent(this, Ye(this, this.get("html", ""))) : this._root._removeHTMLContent(this), this._root._positionHTMLElement(this);
    }
    if (this.isDirty("verticalScrollbar")) {
      const t2 = this.get("verticalScrollbar");
      if (t2) {
        t2._setParent(this), t2.children.removeValue(t2.startGrip), t2.children.removeValue(t2.endGrip), this.set("maskContent", true), this.set("paddingRight", t2.width() + t2.get("marginRight", 0) + t2.get("marginLeft", 0));
        let e2 = this.get("background");
        e2 || (e2 = this.set("background", Fe.new(this._root, { themeTags: ["background"], fillOpacity: 0, fill: this._root.interfaceColors.get("alternativeBackground") }))), this._vsbd0 = this.events.on("wheel", (e3) => {
          const i2 = e3.originalEvent;
          if (!pt(i2, this))
            return;
          i2.preventDefault();
          let s2 = i2.deltaY / 5e3;
          const r2 = t2.get("start", 0), a2 = t2.get("end", 1);
          r2 + s2 <= 0 && (s2 = -r2), a2 + s2 >= 1 && (s2 = 1 - a2), r2 + s2 >= 0 && a2 + s2 <= 1 && (t2.set("start", r2 + s2), t2.set("end", a2 + s2));
    ...
    if (this.isDirty("background")) {
      ...
      e2 instanceof Ie && (e2.set("isMeasured", false), e2._setParent(this), this._display.addChildAt(e2._display, 0));
    }
  ...
  walkChildren(t2) {
    this.children.each((e2) => {
      e2 instanceof _Je && e2.walkChildren(t2), t2(e2);
    });
  }
  eachChildren(t2) {
    const e2 = this.get("background");
  ...
  _setDataItem(t2) {
    ...
    i2 && "" !== i2 && e2 && this._root._setHTMLContent(this, Ye(this, i2));
  }
};
Object.defineProperty(Je, "className", { enumerable: true, configurable: true, writable: true, value: "Container" }), Object.defineProperty(Je, "classNames", { enumerable: true, configurable: true, writable: true, value: Ie.classNames.concat([Je.className]) });
var qe = class extends Ie {
  ...
  _getText() {
    ...
    return this.get("populateText") ? Ye(this, t2) : t2;
  }
  markDirtyText() {
...
Object.defineProperty(qe, "className", { enumerable: true, configurable: true, writable: true, value: "Text" }), Object.defineProperty(qe, "classNames", { enumerable: true, configurable: true, writable: true, value: Ie.classNames.concat([qe.className]) });
var Qe = class extends Je {
  ...
  _makeText() {
    this._text = this.children.push(qe.new(this._root, {}));
  }
  _updateChildren() {
    if (super._updateChildren(), m(this._textKeys, (t2) => {
      ...
      let e2;
      null != this.get("width") ? e2 = "right" == t2 ? z : "center" == t2 ? G : 0 : "left" == t2 || "start" == t2 ? e2 = this.get("paddingLeft") : "right" != t2 && "end" != t2 || (e2 = -this.get("paddingRight")), this.text.set("x", e2);
    }
  }
  _setMaxDimentions() {
...
Object.defineProperty(Qe, "className", { enumerable: true, configurable: true, writable: true, value: "Label" }), Object.defineProperty(Qe, "classNames", { enumerable: true, configurable: true, writable: true, value: Je.classNames.concat([Qe.className]) });
var ti = class {
  constructor(t2, e2) {
  ...
  ruleRaw(t2, e2 = []) {
    ...
    i2 || (i2 = this._rules[t2] = []), e2.sort(we);
    const { index: s2, found: r2 } = S(i2, (t3) => {
      const i3 = we(t3.tags.length, e2.length);
      return 0 === i3 ? Pe(t3.tags, e2, we) : i3;
    });
    if (r2)
...
//# sourceMappingURL=chunk-QFWYJYBZ.js.map
