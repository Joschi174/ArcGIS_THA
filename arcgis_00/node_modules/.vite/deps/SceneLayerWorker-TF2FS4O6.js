...
async function d(s3) {
  ...
  if ("georeferenced" === y3.type) {
    const { projectBuffer: e3, initializeProjection: r } = await import("./projection-GQHM454N.js");
    await r(u2, m4), p3 = new Float64Array(f2.length), e3(f2, u2, 0, p3, m4, 0, p3.length / 3);
  } else {
    const { project: e3 } = await import("./georeference-AD34643R.js");
...
//# sourceMappingURL=SceneLayerWorker-TF2FS4O6.js.map
