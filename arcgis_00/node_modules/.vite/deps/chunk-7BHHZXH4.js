...
var ie = class extends w2(c(a3(a5(t2(p2(l3(c5(j2(O(o3(i2(a4(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayersCollectionChanged = false, this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.subtypes = null, this.sublayers = new (V2.ofType(Z))(), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this.addHandles(l(() => this.sublayers, (e4, r3) => this._handleSublayersChange(e4, r3), U));
  }
  destroy() {
    var _a;
  ...
  async createGraphicsSource(e3) {
    const { default: r3 } = await p(import("./FeatureLayerSource-HFQ7DQ4H.js"), e3);
...
//# sourceMappingURL=chunk-7BHHZXH4.js.map
