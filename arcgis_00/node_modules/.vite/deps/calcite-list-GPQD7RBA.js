import {
  ...
  disconnectForm,
  submitForm
} from "./chunk-UA72YJDX.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-AUY6JIBE.js";
import {
  defineCustomElement as defineCustomElement3
} from "./chunk-DFTHIQF6.js";
import {
  Symbol as Symbol2,
  baseGetTag,
  debounce,
  ...
  isSymbol,
  root
} from "./chunk-N6RBHYAE.js";
import {
  MAX_COLUMNS,
  getListItemChildren,
  updateListItemChildren
} from "./chunk-Y7I3RPX7.js";
import {
  defineCustomElement as defineCustomElement2
} from "./chunk-CAEIDMLC.js";
import {
  connectInteractive,
  disconnectInteractive,
  updateHostInteraction
} from "./chunk-QQRWAIIW.js";
import {
  BigDecimal,
  ...
  setUpMessages,
  updateMessages
} from "./chunk-AX7O67XH.js";
import {
  numberKeys
} from "./chunk-OXFTP463.js";
import {
  componentFocusable,
  setComponentLoaded,
  setUpLoadableComponent
} from "./chunk-WIN6ZTDU.js";
import {
  defineCustomElement
} from "./chunk-LRNHKKDC.js";
import {
  createObserver
} from "./chunk-ZJEFL7SI.js";
import {
  CSS_UTILITY,
  getElementDir,
  getSlotted,
...
var Stack = proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
var filter = (data, value) => {
  ...
  const result = data.filter((item) => {
    return find2(item, regex);
  });
  return result;
};

// node_modules/@esri/calcite-components/dist/components/progress.js
var progressCss = ":host{position:relative;display:block;inline-size:100%}.track,.bar{position:absolute;inset-block-start:0px;block-size:2px}.track{z-index:var(--calcite-app-z-index);inline-size:100%;overflow:hidden;background:var(--calcite-ui-border-3)}.bar{z-index:var(--calcite-app-z-index);background-color:var(--calcite-ui-brand)}@media (forced-colors: active){.track{background-color:highlightText}.bar{background-color:linkText}}.indeterminate{inline-size:20%;animation:looping-progress-bar-ani calc(var(--calcite-internal-animation-timing-medium) / var(--calcite-internal-duration-factor) * 11 / var(--calcite-internal-duration-factor)) linear infinite}.indeterminate.calcite--rtl{animation-name:looping-progress-bar-ani-rtl}.reversed{animation-direction:reverse}.text{padding-inline:0px;padding-block:1rem 0px;text-align:center;font-size:var(--calcite-font-size--2);line-height:1rem;font-weight:var(--calcite-font-weight-medium);color:var(--calcite-ui-text-2)}@keyframes looping-progress-bar-ani{0%{transform:translate3d(-100%, 0, 0)}50%{inline-size:40%}100%{transform:translate3d(600%, 0, 0)}}@keyframes looping-progress-bar-ani-rtl{0%{transform:translate3d(100%, 0, 0)}50%{inline-size:40%}100%{transform:translate3d(-600%, 0, 0)}}:host([hidden]){display:none}[hidden]{display:none}";
...
var Input = proxyCustomElement(class extends H {
  constructor() {
    ...
    this.setValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      ...
      if (this.type === "number") {
        ...
        this.localizedValue = hasTrailingDecimalSeparator && isValueDeleted ? `${newLocalizedValue}${numberStringFormatter.decimal}` : newLocalizedValue;
  ...
  syncHiddenFormInput(input) {
    ...
    input.type = type;
    if (type === "number") {
      input.min = ((_a = this.min) == null ? void 0 : _a.toString(10)) ?? "";
      input.max = ((_b = this.max) == null ? void 0 : _b.toString(10)) ?? "";
    } else if (type === "text") {
  ...
  render() {
    const dir = getElementDir(this.el);
    const loader = h("div", { class: CSS3.loader }, h("calcite-progress", { label: this.messages.loading, type: "indeterminate" }));
    const inputClearButton = h("button", { "aria-label": this.messages.clear, class: CSS3.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" }));
    const iconEl = h("calcite-icon", { class: CSS3.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: this.scale === "l" ? "m" : "s" });
    const isHorizontalNumberButton = this.numberButtonType === "horizontal";
    const numberButtonsHorizontalUp = h("button", { "aria-hidden": "true", class: {
      [CSS3.numberButtonItem]: true,
      [CSS3.buttonItemHorizontal]: isHorizontalNumberButton
    ...
    const numberButtonsVertical = h("div", { class: CSS3.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown);
    const prefixText = h("div", { class: CSS3.prefix }, this.prefixText);
    const suffixText = h("div", { class: CSS3.suffix }, this.suffixText);
    ...
    const childEl = this.type !== "number" ? [
      ...
      this.isTextarea ? h("div", { class: CSS3.resizeIconWrapper }, h("calcite-icon", { icon: "chevron-down", scale: this.scale === "l" ? "m" : "s" })) : null
    ] : null;
    return h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h("div", { class: { [CSS3.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalDown : null, this.prefixText ? prefixText : null, h("div", { class: CSS3.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { class: CSS3.actionWrapper }, h("slot", { name: SLOTS2.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalUp : null, h(HiddenFormInputSlot, { component: this })));
  }
...
var Filter = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Fragment, null, h("div", { class: CSS4.container }, h("label", null, h("calcite-input", {
...
var List = proxyCustomElement(class extends H {
  constructor() {
    ...
    this.updateFilteredItems = (emit = false) => {
      ...
      const lastDescendantItems = listItems == null ? void 0 : listItems.filter((listItem) => listItems.every((li) => li === listItem || !listItem.contains(li)));
  ...
  async setFocus() {
    ...
    return (_b = this.enabledListItems.find((listItem) => listItem.active)) == null ? void 0 : _b.setFocus();
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  render() {
    ...
    return h("div", { class: CSS5.container }, this.dragEnabled ? h("span", { "aria-live": "assertive", class: CSS5.assistiveText }, this.assistiveText) : null, loading ? h("calcite-scrim", { class: CSS5.scrim, loading }) : null, h("table", { "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS5.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? h("thead", null, h("tr", { class: { [CSS5.sticky]: true } }, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS5.stack }, h("slot", { name: SLOTS3.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS.actionsStart }), h("calcite-filter", {
    ...
    }), h("slot", { name: SLOTS3.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS.actionsEnd }))))) : null, h("tbody", { class: CSS5.tableContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange }))));
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
  ...
  handleNudgeEvent(event) {
    ...
    const parentEl2 = sortItem == null ? void 0 : sortItem.parentElement;
    if (!parentEl2) {
      return;
    }
    const { enabledListItems } = this;
    const sameParentItems = enabledListItems.filter((item) => item.parentElement === parentEl2);
    const lastIndex = sameParentItems.length - 1;
    const oldIndex2 = sameParentItems.indexOf(sortItem);
    ...
    if (direction === "up") {
      if (oldIndex2 === 0) {
        ...
        newIndex2 = oldIndex2 - 1;
      }
    } else {
      if (oldIndex2 === lastIndex) {
        newIndex2 = 0;
      } else if (oldIndex2 === lastIndex - 1) {
        appendInstead = true;
        newIndex2 = lastIndex;
      } else {
        newIndex2 = oldIndex2 + 2;
      }
    }
    this.disconnectObserver();
    if (appendInstead) {
      parentEl2.appendChild(sortItem);
    } else {
      parentEl2.insertBefore(sortItem, sameParentItems[newIndex2]);
    }
    this.updateListItems();
    this.connectObserver();
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-GPQD7RBA.js.map
