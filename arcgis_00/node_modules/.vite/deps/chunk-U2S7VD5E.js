...
import {
  e as e7,
  e2 as e8
} from "./chunk-OW4XGQQP.js";
import {
  c as c4
} from "./chunk-64NBUS2F.js";
import {
  T as T2,
  e2 as e5
...
var l8 = class {
  constructor(e13 = 300, t12 = 12, i7 = 0.84) {
    this._minimumInitialVelocity = e13, this._stopVelocity = t12, this._friction = i7, this.enabled = true, this._time = new t9(0.6), this._screen = [new t9(0.4), new t9(0.4)], this._scene = [new t9(0.6), new t9(0.6), new t9(0.6)], this._tmpDirection = n2();
  }
  add(e13, t12, i7) {
    if (this.enabled) {
...
var v = class extends m2 {
  constructor(t12) {
    super(t12), this.animationTime = 0, this.momentumEstimator = new l8(500, 6, 0.92), this.momentum = null, this.tmpMomentum = n2(), this.momentumFinished = false, this.viewpoint = new l2({ targetGeometry: new x(), scale: 0, rotation: 0 }), this._previousDrag = null, f(() => this.momentumFinished, () => this.navigation.stop());
  }
  begin(t12, i7) {
...
var j2 = class extends m2 {
  ...
  update(t12, e13) {
    ...
    r2(u4, e13.center.x, e13.center.y), X2(d7, o9, r12), t12.viewpoint = gt(this.viewpoint, t12.state.paddedViewState.viewpoint, lt(d7, this._previousCenter, u4)), a3(this._previousCenter, u4);
  }
  end() {
    this.navigation.end();
  }
...
//# sourceMappingURL=chunk-U2S7VD5E.js.map
