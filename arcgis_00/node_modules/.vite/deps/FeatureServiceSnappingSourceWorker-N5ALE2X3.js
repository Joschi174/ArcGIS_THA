...
var T3 = class {
  constructor(e5, t6 = []) {
    this.missingTiles = t6, this.fullArea = 0, this.coveredArea = 0, this.fullArea = l(e5.extent), this.coveredArea = this.fullArea;
  }
  prepend(e5) {
...
var F = class {
  ...
  addMissing(e5, t6, s5, i5) {
    ...
    this._tileInfo.updateTileInfo(r8, j2.ExtrapolateOptions.POWER_OF_TWO), null == r8.extent || null != this._extent && !q(this._extent, r8.extent) || (this.info.missingTiles.push({ data: r8, resolution: i5 }), this.info.coveredArea -= l(r8.extent));
  }
};
var j3 = 0.18751;
var I2;
...
var I3 = class extends n.EventedAccessor {
  ...
  async setup(e5) {
    ...
    return this._elevationAligner = i2(d4, { elevationInfo: null != e5.elevationInfo ? h.fromJSON(e5.elevationInfo) : null, alignPointsInFeatures: this._alignPointsInFeatures, spatialReference: l4 }), this._elevationFilter = r4(d4), this._handles.add([l2(() => this._featureFetcher.availability, (e6) => this.emit("notify-availability", { availability: e6 }), U), l2(() => this.updating, () => this._notifyUpdating())]), this._whenSetup.resolve(), this._isInitializing = false, this.configure(e5.configuration);
  }
  async configure(e5) {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-N5ALE2X3.js.map
