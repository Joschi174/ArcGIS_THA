...
var k = E2 = class extends v(p2) {
  ...
  _watchUniqueValueInfos() {
    ...
    if (e3) {
      const t2 = [];
      for (const s6 of e3)
        t2.push(l(() => ({ symbol: s6.symbol, value: s6.value, label: s6.label, description: s6.description }), (e4, t3) => {
  ...
  _watchUniqueValueGroups() {
    ...
    if (e3) {
      const t2 = [];
      for (const s6 of e3) {
        t2.push(l(() => ({ classes: s6.classes }), (e4, t3) => {
          e4 !== t3 && (this._updateInfosFromGroups(), this._isInfosSource = false);
        }, { sync: true }));
        for (const e4 of s6.classes ?? [])
          t2.push(l(() => ({ symbol: e4.symbol, values: e4.values, label: e4.label, description: e4.description }), (e5, t3) => {
...
//# sourceMappingURL=chunk-S6UQK27H.js.map
