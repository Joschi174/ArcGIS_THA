...
var M = S = class extends u(_) {
  ...
  async _loadLayersFromJSON(e2, r3, t2) {
    const s4 = this.resourceInfo && this.resourceInfo.context, o = this.portalItem && this.portalItem.portal || s4 && s4.portal || null, a5 = x2[(s4 == null ? void 0 : s4.origin) || ""] ?? "web-map", { populateOperationalLayers: i } = await import("./layersCreator-WI777537.js"), n2 = [];
  ...
  static fromId(e2) {
    ...
    if (r3.deprecated) {
      let r4 = null;
      "dark-gray" === e2 ? r4 = "dark-gray-vector" : "gray" === e2 ? r4 = "gray-vector" : "streets" === e2 ? r4 = "streets-vector" : "topo" === e2 && (r4 = "topo-vector"), r(s.getLogger(_2), `The ${e2} basemap has entered mature support and is no longer being updated.`, { replacement: r4, see: "https://arcg.is/1iq8aD", warnOnce: true });
    }
...
e([y2({ json: { write: { ignoreOrigin: true, target: "baseMapLayers", writer(e2, r3, t2, s4) {
  ...
  this._writeBaseLayers(e2, r3, s4);
} } } } } })], M.prototype, "baseLayers", null), e([y2({ type: String, json: { origins: { "web-scene": { write: true } } } })], M.prototype, "id", void 0), e([y2({ type: x })], M.prototype, "portalItem", void 0), e([y2()], M.prototype, "referenceLayers", null), e([y2({ readOnly: true })], M.prototype, "resourceInfo", void 0), e([y2({ type: f })], M.prototype, "spatialReference", void 0), e([y2()], M.prototype, "thumbnailUrl", void 0), e([y2({ type: String, json: { origins: { "web-scene": { write: { isRequired: true } } } } })], M.prototype, "title", void 0), e([r2("title")], M.prototype, "writeTitle", null), M = S = e([a2(_2)], M);
...
//# sourceMappingURL=chunk-TLSRC4VD.js.map
