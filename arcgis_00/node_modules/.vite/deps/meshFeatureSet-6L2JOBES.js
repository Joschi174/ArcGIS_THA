import {
  ...
  m as m4,
  o as o3
} from "./chunk-C7RRY6MR.js";
import {
  i
} from "./chunk-Z3XU4R74.js";
import {
  g as g4,
  p as p4
} from "./chunk-C6NFHKR7.js";
import "./chunk-2SQERXEW.js";
import {
  e as e3
} from "./chunk-EXV6EXJY.js";
import {
  t
...
import {
  ...
  p as p3,
  t as t2
} from "./chunk-5AH5IDTK.js";
import {
  m as m2
} from "./chunk-7ZHPCAJ3.js";
...
async function c4(e9, r4, n2) {
  const { source: o4 } = r4, { loadGLTFMesh: i4 } = await p(import("./loadGLTFMesh-VEKZCLYB.js"), n2), a9 = await f5(o4, n2);
  s3(n2);
...
var N2 = B = class extends a5(_.LoadableMixin(m(p2))) {
  ...
  async toBinaryGLTF(e9) {
    const t3 = import("./gltfexport-X3QVZAUC.js"), r4 = this.load(), o4 = await Promise.all([t3, r4]), { toBinaryGLTF: s4 } = o4[0];
    return s4(this, e9);
  }
  get memoryUsage() {
    let e9 = 0;
  ...
  static async createFromGLTF(e9, r4, o4) {
    ...
    const { loadGLTFMesh: n2 } = await p(import("./loadGLTFMesh-VEKZCLYB.js"), o4);
...
//# sourceMappingURL=meshFeatureSet-6L2JOBES.js.map
