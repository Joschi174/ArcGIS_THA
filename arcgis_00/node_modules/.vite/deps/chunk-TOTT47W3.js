...
var p2;
var h2 = new s3({ esriSLSSolid: "solid", esriSLSDash: "dash", esriSLSDot: "dot", esriSLSDashDot: "dash-dot", esriSLSDashDotDot: "long-dash-dot-dot", esriSLSNull: "none", esriSLSInsideFrame: "inside-frame", esriSLSShortDash: "short-dash", esriSLSShortDot: "short-dot", esriSLSShortDashDot: "short-dash-dot", esriSLSShortDashDotDot: "short-dash-dot-dot", esriSLSLongDash: "long-dash", esriSLSLongDashDot: "long-dash-dot" });
...
function s7(e8, t12) {
  var _a;
  return p7(t12) && !Y(e8) && ((_a = t12 == null ? void 0 : t12.layer) == null ? void 0 : _a.parsedUrl) ? V(t12.layer.parsedUrl.path, "images", e8) : i2(e8, t12);
}
...
var h4;
var m9 = new s3({ esriSMSCircle: "circle", esriSMSSquare: "square", esriSMSCross: "cross", esriSMSX: "x", esriSMSDiamond: "diamond", esriSMSTriangle: "triangle", esriSMSPath: "path" });
...
var C = V2.ofType({ base: a10, key: "type", typeMap: v2, errorContext: "symbol-layer" });
var T2 = class extends a4 {
  constructor(e8) {
    super(e8), this.styleOrigin = null, this.thumbnail = null, this.type = null;
    const t12 = this.__accessor__ && this.__accessor__.metadatas && this.__accessor__.metadatas.symbolLayers, o9 = t12 && t12.type || V2;
...
var n14;
var u8 = V2.ofType({ base: null, key: "type", typeMap: { text: z } });
...
var l16;
var a16 = V2.ofType({ base: null, key: "type", typeMap: { line: h7, path: d8 } });
var n15 = V2.ofType({ base: null, key: "type", typeMap: { line: h7, path: d8 } });
...
var i10;
var y6 = V2.ofType({ base: null, key: "type", typeMap: { fill: h6 } });
...
var b4;
var f4 = V2.ofType({ base: null, key: "type", typeMap: { icon: w, object: c13, text: z } });
...
var f5;
var u10 = V2.ofType({ base: null, key: "type", typeMap: { extrude: c9, fill: h6, icon: w, line: h7, object: c13, text: z, water: n12 } });
...
var y7 = m19 = class extends a4 {
  ...
  async _fetchSymbol(t12, o9) {
    ...
    const { resolveWebStyleSymbol: i11 } = await import("./webStyleSymbolUtils-GHQ6SYSR.js");
    s4(o9);
...
//# sourceMappingURL=chunk-TOTT47W3.js.map
