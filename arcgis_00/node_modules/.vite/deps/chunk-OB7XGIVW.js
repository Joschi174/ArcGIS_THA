...
async function h(n2, r2) {
  ...
  if (-1 === u)
    return null;
  const s = `${n2.substring(0, u)}/rest/info`, a = null != r2 ? r2.signal : null, { data: c2 } = await j(s, { query: { f: "json" }, responseType: "json", signal: a });
...
//# sourceMappingURL=chunk-OB7XGIVW.js.map
