...
function f(e4, t2, r2, n3, f3) {
  let a6 = s5(t2[r2], f3);
  i(a6) && (e4[r2] = true);
  for (const i2 of Object.getOwnPropertyNames(t2))
    a6 = s5(t2[i2], f3), s6(a6, r2, n3) && (e4[i2] = true);
}
function a4(e4, t2, r2, o3) {
...
function u2(t2, n3, s8 = c2) {
  ...
  if (!s8 || !s8.ignoreDefaults) {
    ...
    for (const e4 of Object.getOwnPropertyNames(u4))
      d2[e4] || a4(t2, e4, i2, s8);
  }
  i2.setDefaultOrigin("user");
}
function d(e4, t2, r2, o3 = c2) {
  var _a;
...
function c3(r2, e4, t2, i2) {
  const o3 = e2(r2), n3 = o3.metadatas, u4 = a2(n3[e4], i2);
  return !!u4 && f2(r2, o3, e4, u4, t2, i2);
}
function g(r2, e4, t2) {
  var _a, _b;
  ...
  for (const s8 in n3) {
    ...
    if (!f2(r2, o3, s8, p3, void 0, t2))
      continue;
    const c4 = r2.get(s8), g2 = a5(r2, p3, p3.write && "string" == typeof p3.write.target ? p3.write.target : s8, c4, t2);
...
var u3 = (t2) => {
  let u4 = class extends t2 {
    constructor(...r2) {
      super(...r2);
      const t3 = p(e2(this)), i2 = t3.store, p3 = new s7();
...
//# sourceMappingURL=chunk-O6HKLIZS.js.map
