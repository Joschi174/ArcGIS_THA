  ...
  render() {
    ...
    return (
      ...
      h("span", {
        ...
        class: { [CSS2.handle]: true, [CSS2.handleActivated]: this.activated },
        onBlur: this.handleBlur,
        onKeyDown: this.handleKeyDown,
        role: "button",
        tabindex: "0",
        title: (_a = this.messages) == null ? void 0 : _a.dragHandle,
        // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
        ref: (el) => {
          this.handleButton = el;
        }
      }, h("calcite-icon", { icon: ICONS2.drag, scale: "s" }))
    );
  }
...
var ListItem = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    }, this.renderDragHandle(), this.renderSelected(), this.renderOpen(), this.renderActionsStart(), this.renderContentContainer(), this.renderActionsEnd()), h("div", { class: {
...
@esri/calcite-components/dist/components/calcite-list-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-item-LZZGWTCL.js.map
