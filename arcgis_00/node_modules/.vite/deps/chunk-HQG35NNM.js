...
var s = class extends je {
  ...
  generateColors() {
    ...
    const e = this.getPrivate("currentPass"), s2 = this.get("colors", [this.get("baseColor", Xt.fromHex(16711680))]);
    ...
    for (let n = a; n < r; n++)
      if (o)
        ...
        for (; l > 1; )
          l -= 1;
        s2.push(Xt.fromHSL(a2, o2, l));
      }
  }
  getIndex(e) {
    const s2 = this.get("colors", []), r = this.get("saturation");
    return e >= s2.length ? (this.generateColors(), this.getIndex(e)) : null != r ? Xt.saturate(s2[e], r) : s2[e];
  }
  next() {
...
Object.defineProperty(s, "className", { enumerable: true, configurable: true, writable: true, value: "ColorSet" }), Object.defineProperty(s, "classNames", { enumerable: true, configurable: true, writable: true, value: je.classNames.concat([s.className]) });

export {
  s
};
//# sourceMappingURL=chunk-HQG35NNM.js.map
