...
var s = class extends ti {
  setupDefaultRules() {
    ...
    u("InterfaceColors").setAll({ stroke: Xt.fromHex(15066597), fill: Xt.fromHex(15987699), primaryButton: Xt.fromHex(6788316), primaryButtonHover: Xt.fromHex(6779356), primaryButtonDown: Xt.fromHex(6872182), primaryButtonActive: Xt.fromHex(6872182), primaryButtonText: Xt.fromHex(16777215), primaryButtonStroke: Xt.fromHex(16777215), secondaryButton: Xt.fromHex(14277081), secondaryButtonHover: Xt.fromHex(10724259), secondaryButtonDown: Xt.fromHex(9276813), secondaryButtonActive: Xt.fromHex(15132390), secondaryButtonText: Xt.fromHex(0), secondaryButtonStroke: Xt.fromHex(16777215), grid: Xt.fromHex(0), background: Xt.fromHex(16777215), alternativeBackground: Xt.fromHex(0), text: Xt.fromHex(0), alternativeText: Xt.fromHex(16777215), disabled: Xt.fromHex(11382189), positive: Xt.fromHex(5288704), negative: Xt.fromHex(11730944) });
    {
      const e2 = u("ColorSet");
      e2.setAll({ passOptions: { hue: 0.05, saturation: 0, lightness: 0 }, colors: [Xt.fromHex(6797276)], step: 1, reuse: false, startIndex: 0 }), e2.setPrivate("currentStep", 0), e2.setPrivate("currentPass", 0);
    }
    u("Entity").setAll({ stateAnimationDuration: 0, stateAnimationEasing: _e(ge) }), u("Component").setAll({ interpolationDuration: 0, interpolationEasing: _e(ge) }), u("Sprite").setAll({ visible: true, scale: 1, opacity: 1, rotation: 0, position: "relative", tooltipX: G, tooltipY: G, tooltipPosition: "fixed", isMeasured: true }), u("Sprite").states.create("default", { visible: true, opacity: 1 }), u("Container").setAll({ interactiveChildren: true, setStateOnChildren: false }), u("Graphics").setAll({ strokeWidth: 1 }), u("Chart").setAll({ width: z, height: z, interactiveChildren: false }), u("Sprite", ["horizontal", "center"]).setAll({ centerX: G, x: G }), u("Sprite", ["vertical", "center"]).setAll({ centerY: G, y: G }), u("Container", ["horizontal", "layout"]).setAll({ layout: d }), u("Container", ["vertical", "layout"]).setAll({ layout: c }), u("Pattern").setAll({ repetition: "repeat", width: 50, height: 50, rotation: 0, fillOpacity: 1 }), u("LinePattern").setAll({ gap: 6, colorOpacity: 1, width: 49, height: 49 }), u("RectanglePattern").setAll({ gap: 6, checkered: false, centered: true, maxWidth: 5, maxHeight: 5, width: 48, height: 48, strokeWidth: 0 }), u("CirclePattern").setAll({ gap: 5, checkered: false, centered: false, radius: 3, strokeWidth: 0, width: 45, height: 45 }), u("LinearGradient").setAll({ rotation: 90 }), u("Legend").setAll({ fillField: "fill", strokeField: "stroke", nameField: "name", layout: ze.new(this._root, {}), layer: 30, clickTarget: "itemContainer" }), u("Container", ["legend", "item", "itemcontainer"]).setAll({ paddingLeft: 5, paddingRight: 5, paddingBottom: 5, paddingTop: 5, layout: d, setStateOnChildren: true, interactiveChildren: false, ariaChecked: true, focusable: true, ariaLabel: e.translate("Press ENTER to toggle"), role: "checkbox" });
    {
      const e2 = u("Rectangle", ["legend", "item", "background"]);
      e2.setAll({ fillOpacity: 0 }), l(e2, "fill", s2, "background");
    }
    u("Container", ["legend", "marker"]).setAll({ setStateOnChildren: true, centerY: G, paddingLeft: 0, paddingRight: 0, paddingBottom: 0, paddingTop: 0, width: 18, height: 18 }), u("RoundedRectangle", ["legend", "marker", "rectangle"]).setAll({ width: z, height: z, cornerRadiusBL: 3, cornerRadiusTL: 3, cornerRadiusBR: 3, cornerRadiusTR: 3 });
    {
      const e2 = u("RoundedRectangle", ["legend", "marker", "rectangle"]).states.create("disabled", {});
      l(e2, "fill", s2, "disabled"), l(e2, "stroke", s2, "disabled");
    }
    u("Label", ["legend", "label"]).setAll({ centerY: G, marginLeft: 5, paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0, populateText: true });
    l(u("Label", ["legend", "label"]).states.create("disabled", {}), "fill", s2, "disabled");
    u("Label", ["legend", "value", "label"]).setAll({ centerY: G, marginLeft: 5, paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0, width: 50, centerX: z, populateText: true });
    l(u("Label", ["legend", "value", "label"]).states.create("disabled", {}), "fill", s2, "disabled");
    u("HeatLegend").setAll({ stepCount: 1 }), u("RoundedRectangle", ["heatlegend", "marker"]).setAll({ cornerRadiusTR: 0, cornerRadiusBR: 0, cornerRadiusTL: 0, cornerRadiusBL: 0 }), u("RoundedRectangle", ["vertical", "heatlegend", "marker"]).setAll({ height: z, width: 15 }), u("RoundedRectangle", ["horizontal", "heatlegend", "marker"]).setAll({ width: z, height: 15 }), u("HeatLegend", ["vertical"]).setAll({ height: z }), u("HeatLegend", ["horizontal"]).setAll({ width: z }), u("Label", ["heatlegend", "start"]).setAll({ paddingLeft: 5, paddingRight: 5, paddingTop: 5, paddingBottom: 5 }), u("Label", ["heatlegend", "end"]).setAll({ paddingLeft: 5, paddingRight: 5, paddingTop: 5, paddingBottom: 5 });
    {
      const e2 = u("Label");
    ...
    u("RadialLabel").setAll({ textType: "regular", centerY: G, centerX: G, inside: false, radius: 0, baseRadius: z, orientation: "auto", textAlign: "center" }), u("RoundedRectangle").setAll({ cornerRadiusTL: 8, cornerRadiusBL: 8, cornerRadiusTR: 8, cornerRadiusBR: 8 }), u("PointedRectangle").setAll({ pointerBaseWidth: 15, pointerLength: 10, cornerRadius: 8 }), u("Slice").setAll({ shiftRadius: 0, dRadius: 0, dInnerRadius: 0 });
    {
      const e2 = u("Tick");
      e2.setAll({ strokeOpacity: 0.15, isMeasured: false, length: 4.5, position: "absolute", crisp: true }), l(e2, "stroke", s2, "grid");
    }
    u("Bullet").setAll({ locationX: 0.5, locationY: 0.5 }), u("Tooltip").setAll({ position: "absolute", getFillFromSprite: true, getStrokeFromSprite: false, autoTextColor: true, paddingTop: 9, paddingBottom: 8, paddingLeft: 10, paddingRight: 10, marginBottom: 5, pointerOrientation: "vertical", centerX: G, centerY: G, animationEasing: _e(ge), exportable: false });
    u("PointedRectangle", ["tooltip", "background"]).setAll({ strokeOpacity: 0.9, cornerRadius: 4, pointerLength: 4, pointerBaseWidth: 8, fillOpacity: 0.9, stroke: Xt.fromHex(16777215) });
    {
    ...
    u("Button", ["zoom"]).setAll({ paddingTop: 18, paddingBottom: 18, paddingLeft: 12, paddingRight: 12, centerX: 46, centerY: -10, y: 0, x: z, role: "button", ariaLabel: e.translate("Zoom Out"), layer: 30 });
    {
    ...
    u("Button", ["resize"]).setAll({ paddingTop: 9, paddingBottom: 9, paddingLeft: 13, paddingRight: 13, draggable: true, centerX: G, centerY: G, position: "absolute", role: "slider", ariaValueMin: "0", ariaValueMax: "100", ariaLabel: e.translate("Use up and down arrows to move selection") });
    {
    ...
    u("Graphics", ["switch", "icon"]).states.create("active", { dx: 16 }), u("Scrollbar").setAll({ start: 0, end: 1, layer: 30, animationEasing: _e(ge) }), u("Scrollbar", ["vertical"]).setAll({ marginRight: 13, marginLeft: 13, minWidth: 12, height: z }), u("Scrollbar", ["horizontal"]).setAll({ marginTop: 13, marginBottom: 13, minHeight: 12, width: z }), this.rule("Button", ["scrollbar"]).setAll({ exportable: false });
    {
    ...
    u("RoundedRectangle", ["scrollbar", "thumb", "vertical"]).setAll({ x: G, width: z, centerX: G, ariaLabel: e.translate("Use up and down arrows to move selection") }), u("RoundedRectangle", ["scrollbar", "thumb", "horizontal"]).setAll({ y: G, centerY: G, height: z, ariaLabel: e.translate("Use left and right arrows to move selection") });
    {
...
//# sourceMappingURL=chunk-CMEKTGZ4.js.map
