...
function x(n, t2) {
  const e2 = n && (c2(n) ? n : n.spatialReference), a5 = t2 && (c2(t2) ? t2 : t2.spatialReference);
  return !(n && "type" in n && "mesh" === n.type || t2 && "type" in t2 && "mesh" === t2.type || !e2 || !a5) && (!!S(a5, e2) || (A(a5) && u(e2) || A(e2) && u(a5)));
}
function g(e2, a5) {
  if (null == e2)
    return null;
  const o3 = e2.spatialReference, u3 = a5 && (c2(a5) ? a5 : a5.spatialReference);
...
function M(n, t2, i = [0, 0]) {
  ...
  const r2 = l2(t2);
  return i[0] = l2(n) * s3.radius, i[1] = s3.halfSemiMajorAxis * Math.log((1 + Math.sin(r2)) / (1 - Math.sin(r2))), i;
}
function y2(n, t2, i = [0, 0], r2 = false) {
  const s4 = u2(n / s3.radius);
  return i[0] = r2 ? s4 : s4 - 360 * Math.floor((s4 + 180) / 360), i[1] = u2(Math.PI / 2 - 2 * Math.atan(Math.exp(-t2 / s3.radius))), i;
}
...
var g2 = y3 = class extends p {
  ...
  equals(e2) {
    ...
    let { x: n, y: u3, spatialReference: c3 } = e2;
    if (!o3.equals(c3))
    ...
    return t2 === n && r2 === u3 && i === a5 && s4 === l3 && o3.wkid === c3.wkid;
  }
  offset(e2, t2, r2) {
...
//# sourceMappingURL=chunk-FNONMLXB.js.map
