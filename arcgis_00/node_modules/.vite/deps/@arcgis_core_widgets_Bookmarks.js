...
var _ = class extends W {
  ...
  render() {
    ...
    return n2("div", { afterCreate: this._afterRootCreate, class: this.classes(u.base, t3 ? u.open : null), styles: m2, lang: c() }, n2("div", { dir: v((_a = this.owner) == null ? void 0 : _a.container), afterCreate: this._afterContentCreate, afterUpdate: this._updatePosition }, t3 && (o2 == null ? void 0 : o2.call(e6))));
  }
  _buildPopper() {
  ...
  _getAnchor() {
    ...
    return e4("function" == typeof t3 ? t3() : t3);
  }
};
...
var b2 = class extends a3(W) {
  ...
  render() {
    return n2("div", { afterCreate: this._afterRootNodeCreate, bind: this, "data-node-ref": "_rootNode", class: this.classes(h4.base, h4.widget), key: "menu" }, this.renderMenuButton());
  }
  renderMenuButton() {
    ...
    return n2("button", { "aria-pressed": o2.toString(), "aria-controls": `${t3}-menu`, "aria-expanded": o2.toString(), "aria-haspopup": "true", "aria-label": n6, bind: this, class: s5, disabled: this.disabled, id: `${t3}-button`, title: n6 ?? "", selected: o2, onclick: this._toggleOpen, tabindex: this.disabled ? -1 : 0, type: "button" });
  }
  renderMenuContent() {
    var _a;
    const { id: e6, open: t3 } = this;
    return n2("div", { afterCreate: this._afterMenuContentNodeCreate, bind: this, class: h4.content, "data-node-ref": "_menuContentNode", key: "esri-button-menu-content", hidden: !t3 }, n2("ul", { "aria-labelledby": `${e6}-button`, bind: this, class: h4.itemWrapper, id: `${e6}-menu`, role: "menu" }, ((_a = this.items) == null ? void 0 : _a.length) && this.renderItems()));
  }
  renderItems() {
    var _a;
  ...
  renderItem(e6, t3, n6) {
    ...
    return n2("li", { afterCreate: this._afterMenuItemCreate, bind: this, class: i5, "data-item-index": t3, "data-item-subIndex": n6, for: o2, key: o2, onkeydown: (t4) => this._handleMenuItemKeydown(t4, e6), onclick: (t4) => this._handleMenuItemInteraction(t4, e6), role: "menuitem", tabindex: this.disabled ? -1 : 0 }, n2("input", { disabled: true, checked: e6.selected, class: h4.checkbox, id: o2, name: o2, tabindex: "-1", type: "checkbox" }), n2("label", { bind: this, class: this.classes(h4.button, h4.itemLabel), for: o2, id: s5 }, n2("span", { class: this.classes(h4.icon, e6.iconClass), "aria-hidden": "true" }), n2("span", { class: h4.itemLabelContent }, j.sanitize(e6.label))), n2("ul", { "aria-labelledby": s5, class: h4.embeddedContentWrapper, id: `${this.id}-submenu`, role: "menu" }, (_a = e6 == null ? void 0 : e6.items) == null ? void 0 : _a.map((e7, n7) => this.renderItem(e7, t3, n7))));
  }
...
var C = class extends W {
  ...
  loadDependencies() {
    return n3({ label: () => import("./calcite-label-AO3KDKAR.js"), switch: () => import("./calcite-switch-EKHFIY3H.js"), tooltip: () => import("./calcite-tooltip-62WSSQ3C.js") });
  }
  get _editMenuItems() {
    var _a, _b;
  ...
  render() {
    ...
    return n2("div", { class: this.classes(n5.base, n5.esriWidget, { [n5.esriWidgetDisabled]: this.disabled }) }, e6);
  }
  startAddBookmark() {
  ...
  renderBookmarkTooltip(t3) {
    ...
    return t3 ? n2("calcite-tooltip", { key: `tooltip-${t3.uid}`, label: i5, referenceElement: e6.get(t3.uid) }, i5) : null;
  }
  renderLoading() {
    return n2("div", { class: n5.loaderContainer, key: "loader", tabIndex: this.disabled ? -1 : void 0 }, n2("div", { class: n5.loader }));
  }
  renderNoBookmarksContainer() {
    const { messages: t3, disabled: e6 } = this;
    return n2("div", { class: n5.noBookmarksContainer, key: "no-bookmarks", tabIndex: e6 ? -1 : void 0 }, n2("span", { "aria-hidden": "true", class: this.classes(n5.noBookmarksIcon, n5.widgetIcon) }), n2(n4, { level: this.headingLevel, class: this.classes(n5.header, n5.noBookmarksHeader) }, t3 == null ? void 0 : t3.noBookmarksHeading), n2("p", { class: n5.noBookmarksDescription }, t3 == null ? void 0 : t3.noBookmarksDescription));
  }
  renderAddBookmarkLoading() {
    var _a;
    return n2("div", { key: "adding-bookmark", class: n5.addingBookmark }, n2("span", { "aria-hidden": "true", class: this.classes(n5.loading, n5.rotating) }), (_a = this.messages) == null ? void 0 : _a.addingBookmark);
  }
  ...
  renderBookmarksContainer(t3) {
    ...
    return [n2("ul", { key: "bookmark-list", "aria-label": (_a = this.messages) == null ? void 0 : _a.widgetLabel, class: this.classes(n5.bookmarkList, { [n5.bookmarkListSortable]: this.editingEnabled }), afterCreate: this._sortNodeCreated, afterRemoved: this._destroySortable, "data-node-ref": "_sortableNode", bind: this, tabIndex: s5 ? -1 : void 0 }, this.renderBookmarkItems(t3)), r2, a7];
  }
  renderAddBookmarkButton() {
    var _a;
    return this.visibleElements.addBookmark ? n2("div", { key: "add-bookmark-item", class: n5.addBookmark }, n2("button", { class: this.classes(n5.esriButton, n5.esriButtonTertiary, n5.addBookmarkButton), disabled: this.disabled, onclick: this.startAddBookmark, afterCreate: this._storeAddBookmarkButton, afterUpdate: this._storeAddBookmarkButton, "data-node-ref": "_addBookmarkButtonNode", bind: this, type: "button" }, n2("span", { "aria-hidden": "true", class: this.classes(n5.addBookmarkIcon, n5.iconPlus) }), (_a = this.messages) == null ? void 0 : _a.addBookmark)) : null;
  }
  renderBookmarks() {
  ...
  renderEditContainer(t3) {
    ...
    return n2("div", { class: n5.bookmarkEditButtonContainer, key: "edit-container" }, n2("button", { disabled: o2, title: `${e6 == null ? void 0 : e6.edit} ${s5}`, "aria-label": `${e6 == null ? void 0 : e6.edit} ${s5}`, "data-bookmark": t3, onclick: this._showEditBookmarkForm, bind: this, class: n5.bookmarkEditButton, type: "button" }, n2("span", { "aria-hidden": "true", class: n5.iconEdit })));
  }
  renderDragHandle(t3) {
    const { messagesCommon: e6, disabled: o2 } = this, s5 = this._getBookmarkTitle(t3), i5 = { [T2]: t3.uid };
    return n2("div", { role: "button", tabIndex: o2 ? -1 : 0, key: "drag-handle", bind: this, class: n5.bookmarkDragHandle, onkeydown: this._dragHandleKeydown, "data-bookmark": t3, afterCreate: this._focusDragHandle, afterUpdate: this._focusDragHandle, onblur: this._dragHandleBlur, "aria-pressed": this._selectedSortUid === t3.uid ? "true" : "false", "aria-label": `${e6 == null ? void 0 : e6.dragHandleTitle} ${s5}`, ...i5 }, n2("span", { "aria-hidden": "true", class: this.classes(n5.bookmarkDragHandleIcon, n5.iconHandle) }));
  }
  renderBookmarkImageIcon() {
    return n2("span", { "aria-hidden": "true", class: this.classes(n5.bookmarkIcon, n5.widgetIcon) });
  }
  renderBookmarkImage(t3) {
    const { visibleElements: e6 } = this, { thumbnail: o2 } = t3, s5 = o2 && o2.url || "";
    return e6.thumbnail && s5 ? n2("img", { src: s5, alt: "", class: n5.bookmarkImage }) : null;
  }
  renderBookmarkTimeSwitch(t3) {
    const { messages: e6, disabled: o2 } = this, { timeExtent: s5 } = t3, { view: i5 } = this.viewModel;
    return (i5 == null ? void 0 : i5.timeExtent) ?? s5 ? n2("calcite-label", { layout: "inline-space-between" }, e6 == null ? void 0 : e6.includeTimeExtent, n2("calcite-switch", { scale: "s", disabled: o2, checked: !!s5, onCalciteSwitchChange: (t4) => {
  ...
  renderBookmarkTimeExtent(t3) {
    ...
    return o2 ? n2("span", { class: n5.timeExtent }, [null != o2.start && n2("span", { key: "start-date-group", class: n5.timeExtentGroup }, n2("span", { key: "start-date", class: n5.timeExtentDate }, this._formatDate(o2.start)), e6.time && n2("span", { key: "start-time", class: n5.timeExtentTime }, this._formatTime(o2.start))), null != o2.end && (null == o2.start || o2.start.getTime() !== o2.end.getTime()) && n2("span", { key: "end-date-group", class: n5.timeExtentGroup }, n2("span", { key: "end-date", class: n5.timeExtentDate }, this._formatDate(o2.end)), e6.time && n2("span", { key: "end-time", class: n5.timeExtentTime }, this._formatTime(o2.end)))]) : null;
  }
  renderBookmarkButton(t3) {
    const { disabled: e6 } = this, { timeExtent: o2 } = t3, { capabilities: s5 } = this.viewModel, i5 = this._getBookmarkTitle(t3), { thumbnail: r2 } = t3, a7 = n2("div", { class: this.classes(n5.bookmarkImageContainer, r2 && r2.url ? n5.bookmarkImageContainerHasImage : null) }, this.renderBookmarkImage(t3) || this.renderBookmarkImageIcon()), n6 = s5.time && o2 ? n2("span", { key: "time-extent", class: n5.bookmarkTimeExtent }, this.renderBookmarkTimeExtent(t3)) : null;
    return n2("button", { disabled: e6, key: "bookmark-button", class: n5.bookmarkButton, bind: this, "data-bookmark": t3, onclick: this._goToBookmark, type: "button" }, a7, n2("div", { class: n5.bookmarkLabel }, n2("span", { key: "bookmark-title", class: n5.bookmarkName }, i5), n6));
  }
  renderBookmark(t3) {
    ...
    return n2("li", { key: t3, class: this.classes(n5.bookmark, o2), ...i5 }, r2, this.renderBookmarkButton(t3), s5);
  }
  renderEditingBookmarkName(t3) {
    ...
    return n2("label", { class: this.classes({ [n5.authoringLabel]: true, [n5.authoringLabelStartPadding]: !!((_a = this.visibleElements) == null ? void 0 : _a.thumbnail) }) }, e6 == null ? void 0 : e6.title, i5 ? n2("strong", null, e6 == null ? void 0 : e6.invalidTitle) : null, n2("input", { required: true, disabled: s5, bind: this, class: this.classes(n5.esriInput, i5 ? n5.authoringInputInvalid : null), type: "text", value: t3.name, afterCreate: this._storeEditInput, afterUpdate: this._focusEditInput, "data-bookmark": t3, "data-node-ref": "_editInputNode", placeholder: e6 == null ? void 0 : e6.titlePlaceholder }));
  }
  renderEditingBookmarkUrlActions() {
    const { messagesCommon: t3, disabled: e6 } = this;
    return n2("div", { class: n5.authoringActions }, n2("input", { type: "button", disabled: e6, value: t3 == null ? void 0 : t3.back, class: this.classes(n5.esriButton, n5.esriButtonTertiary), onclick: this._closeUrlEditBookmarkForm, bind: this }), n2("input", { class: n5.esriButton, disabled: e6, type: "submit", value: t3 == null ? void 0 : t3.add }));
  }
  renderEditingBookmarkActions() {
    var _a;
    const { messagesCommon: t3, disabled: e6 } = this, o2 = (_a = this._userState) == null ? void 0 : _a.bookmark;
    return n2("div", { class: n5.authoringActions }, n2("input", { type: "button", disabled: e6, value: t3 == null ? void 0 : t3.delete, class: this.classes(n5.esriButton, n5.esriButtonTertiary, n5.authoringDeleteButton), "data-bookmark": o2, onclick: this._deleteBookmark, bind: this }), n2("input", { disabled: e6, type: "button", value: t3 == null ? void 0 : t3.cancel, class: this.classes(n5.esriButton, n5.esriButtonTertiary), onclick: this._closeEditBookmarkForm, bind: this }), n2("input", { class: n5.esriButton, disabled: e6, type: "submit", value: t3 == null ? void 0 : t3.save }));
  }
  renderEditingBookmarkUrlInput(t3) {
    ...
    return n2("label", { class: this.classes({ [n5.authoringLabel]: true, [n5.authoringLabelStartPadding]: !!((_b = this.visibleElements) == null ? void 0 : _b.thumbnail) }) }, a7 ? n2("strong", null, e6 == null ? void 0 : e6.invalidImageUrl) : null, n2("input", { required: true, disabled: s5, bind: this, class: this.classes(n5.esriInput, a7 ? n5.authoringInputInvalid : null), type: "text", value: r2, afterCreate: this._storeUrlEditInput, afterUpdate: this._focusUrlEditInput, "data-bookmark": t3, "data-node-ref": "_urlEditInputNode", title: e6 == null ? void 0 : e6.imageUrlTooltip, placeholder: e6 ? `https://<${e6.imageUrlPlaceholder}>` : void 0 }));
  }
  renderEditingBookmarkUrl(t3) {
    if (!t3)
      return null;
    const e6 = { [T2]: t3.uid };
    return n2("li", { key: "edit-bookmark-url-form", class: n5.authoringCard, ...e6 }, n2("form", { class: n5.authoringForm, disabled: this.disabled, onsubmit: this._editBookmarkUrlSubmit, bind: this }, this.renderEditingBookmarkUrlInput(t3), this.renderEditingBookmarkUrlActions()));
  }
  renderEditingBookmark(t3) {
    if (!t3)
      return null;
    const e6 = { [T2]: t3.uid }, { capabilities: o2 } = this.viewModel, s5 = o2.time ? n2("div", { key: "edit-bookmark-time-container", class: n5.timeExtentContainer }, this.renderBookmarkTimeSwitch(t3), this._editIncludeTimeExtent && this.renderBookmarkTimeExtent(t3)) : null;
    return n2("li", { key: "edit-bookmark-form", class: n5.authoringCard, ...e6 }, n2("form", { class: n5.authoringForm, disabled: this.disabled, onsubmit: this._editBookmarkSubmit, bind: this }, n2("div", { class: n5.authoringContainer }, this.visibleElements.thumbnail ? n2("div", { class: n5.bookmarkImageContainer }, this.renderBookmarkImage(t3), this._editMenu.render()) : null, this.renderEditingBookmarkName(t3)), s5, this.renderEditingBookmarkActions()));
  }
  renderAddingBookmarkName() {
    ...
    return n2("label", { class: n5.authoringLabel }, e6 == null ? void 0 : e6.title, s5 ? n2("strong", null, e6 == null ? void 0 : e6.invalidTitle) : null, n2("input", { required: true, disabled: o2, bind: this, class: this.classes(n5.esriInput, s5 ? n5.authoringInputInvalid : null), type: "text", afterCreate: this._storeAddInput, afterUpdate: this._focusAddInput, "data-node-ref": "_addInputNode", value: "", placeholder: e6 == null ? void 0 : e6.titlePlaceholder }));
  }
  renderAddingBookmarkActions() {
    const { messagesCommon: t3, disabled: e6 } = this;
    return n2("div", { class: this.classes(n5.authoringActions) }, n2("input", { type: "button", disabled: e6, value: t3 == null ? void 0 : t3.cancel, class: this.classes(n5.esriButton, n5.esriButtonTertiary, n5.authoringCancelButton), onclick: this._endAddBookmark.bind(this), bind: this }), n2("input", { class: n5.esriButton, disabled: e6, type: "submit", value: t3 == null ? void 0 : t3.add }));
  }
  renderAddingBookmark() {
    return n2("div", { key: "add-bookmark-form", class: n5.authoringCard }, n2("form", { class: this.classes(n5.authoringForm, n5.authoringFormAdding), onsubmit: this._addBookmarkSubmit, bind: this }, this.renderAddingBookmarkName(), this.renderAddingBookmarkActions()));
  }
