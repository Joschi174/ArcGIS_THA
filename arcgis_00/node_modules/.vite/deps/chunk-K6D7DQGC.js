...
var T2 = class {
  ...
  setRotation(t19) {
    if (0 === t19 && 0 === this._rotation)
      return;
    this._rotation = t19;
    const i18 = this._transform, n23 = h2(n3(), t19);
    o4(i18, n23, i18);
    ...
    if (e20 && t19) {
      if ("symbolLayers" in e20 && e20.symbolLayers) {
        ...
        if (!o10 || "calcitewebcoreicons" === o10.toLowerCase())
          return;
        const { style: s17, weight: i18 } = S(a13), n23 = k3(e20), l12 = new m2({ family: o10, style: s17, weight: i18, decoration: n23 });
...
//# sourceMappingURL=chunk-K6D7DQGC.js.map
