...
`), t3;
  ...
  _createResources() {
    ...
    const e2 = { shared: D.sharedArrayBuffer && !("local" === this._client.type), size: this._size, blocks: s2(this._blocks, (t3) => ({ textureOnly: t3.textureOnly, buffer: t3.buffer, pixelType: t3.pixelType })) }, i3 = this._client.initialize(e2, this._signal).catch((e3) => {
  ...
  async _getFilter(t3, e2) {
    ...
    if (null != i3)
      return i3;
    const { default: s6 } = await import("./FeatureFilter-3DCXTMPD.js"), r4 = new s6({ geometryType: e2.geometryType, hasM: false, hasZ: false, timeInfo: e2.timeInfo, fieldsIndex: new r(e2.fields) });
...
//# sourceMappingURL=chunk-46OTPSVO.js.map
