import {
  o as o4
} from "./chunk-5UZ6I7DT.js";
import {
  e as e2
} from "./chunk-2ICHOIV7.js";
import {
  L as L2,
  p as p3
} from "./chunk-ER26KRJU.js";
import {
  o as o2
} from "./chunk-ASGBM4KX.js";
import {
  o as o3
} from "./chunk-EZFM2V6A.js";
import {
  j as j3
...
var $ = W = class extends a4(p(t2(c(j3(O2(b)))))) {
  constructor(...e3) {
    super(...e3), this.activeLayer = null, this.copyright = "", this.customParameters = null, this.customLayerParameters = null, this.fullExtent = null, this.operationalLayerType = "WebTiledLayer", this.resourceInfo = null, this.serviceMode = "RESTful", this.sublayers = null, this.type = "wmts", this.version = "1.0.0", this.addHandles([l(() => this.activeLayer, (e4, t3) => {
      var _a;
...
//# sourceMappingURL=WMTSLayer-Z7Y77MXM.js.map
