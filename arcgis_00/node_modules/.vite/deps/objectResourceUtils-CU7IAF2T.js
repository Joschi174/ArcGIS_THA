...
import {
  Z as Z2,
  i as i7
} from "./chunk-FHAFNQEZ.js";
import {
  R
} from "./chunk-6TG3XFW2.js";
import {
  E as E4,
  V,
  a as a4,
...
import "./chunk-ROHI5H6P.js";
import "./chunk-NZQA5R3L.js";
import {
  a as a5
...
import {
  v
} from "./chunk-W7SPF7K5.js";
import {
  _ as _3,
  s as s7
} from "./chunk-Y3JMDVEU.js";
import {
  H as H2
...
var o10 = class _o {
  constructor(i12, s15, o16, c13) {
    ...
    const P6 = A2(n2(), this.bbMin, this.bbMax, 0.5);
  ...
  getChildren() {
    ...
    const i12 = A2(n2(), this.bbMin, this.bbMax, 0.5), e15 = this.primitiveIndices.length, n12 = new Uint8Array(e15), h10 = new Array(8);
...
function j2(t19) {
  return t19 ? { p0: t3(t19.p0), p1: t3(t19.p1), p2: t3(t19.p2) } : { p0: n2(), p1: n2(), p2: n2() };
}
function w2(t19, n12, o16) {
  return e4(O5, n12, t19), e4(V2, o16, t19), s5(_(O5, O5, V2)) / 2;
}
var M2 = new s7(v);
var x2 = new s7(() => j2());
var O5 = n2();
...
var b = class _b extends r7 {
  ...
  set transformation(i12) {
    this._transformation = i12 && i12 !== o3 ? r5(i12) : null;
  }
...
var w4 = class extends r7 {
  constructor(t19, r15) {
    super(), this._data = t19, this.type = e11.Texture, this._glTexture = null, this._loadingPromise = null, this._loadingController = null, this.events = new n3(), this.parameters = r15 || {}, this.parameters.mipmap = false !== this.parameters.mipmap, this.parameters.noUnpackFlip = this.parameters.noUnpackFlip || false, this.parameters.preMultiplyAlpha = this.parameters.preMultiplyAlpha || false, this.parameters.wrap = this.parameters.wrap || { s: D.REPEAT, t: D.REPEAT }, this._startPreload(t19);
  }
  _startPreload(t19) {
  ...
  load(t19) {
    ...
    return null == e15 ? (this._glTexture = new T(t19, this._createDescriptor(t19), null), this._glTexture) : "string" == typeof e15 ? this._loadFromURL(t19, e15) : e15 instanceof Image ? this._loadFromImageElement(t19, e15) : e15 instanceof HTMLVideoElement ? this._loadFromVideoElement(t19, e15) : e15 instanceof ImageData || e15 instanceof HTMLCanvasElement ? this._loadFromImage(t19, e15) : (n(e15) || t(e15)) && this.parameters.encoding === u5.DDS_ENCODING ? (this._data = void 0, this._loadFromDDSData(t19, e15)) : (n(e15) || t(e15)) && this.parameters.encoding === u5.KTX2_ENCODING ? (this._data = void 0, this._loadFromKTX2(t19, e15)) : (n(e15) || t(e15)) && this.parameters.encoding === u5.BASIS_ENCODING ? (this._data = void 0, this._loadFromBasis(t19, e15)) : t(e15) ? this._loadFromPixelData(t19, e15) : n(e15) ? this._loadFromPixelData(t19, new Uint8Array(e15)) : null;
  }
  ...
  _loadFromImageElement(t19, e15) {
    return e15.complete ? this._loadFromImage(t19, e15) : this._loadAsync(async (r15) => {
      const a12 = await i2(e15, e15.src, false, r15);
      return s4(r15), this._loadFromImage(t19, a12);
    });
  }
...
var M3 = class {
  constructor(t19 = 0) {
    this.offset = t19, this.tmpVertex = n2();
  }
...
var T4 = class {
  constructor(t19 = 0) {
    this.componentLocalOriginLength = 0, this._tmpVertex = n2(), this._mbs = _3(), this._obb = { center: n2(), halfSize: n5(), quaternion: null }, this._totalOffset = 0, this._offset = 0, this._resetOffset(t19);
  }
  _resetOffset(t19) {
...
var g6 = class {
  constructor(t19 = 0) {
    this.offset = t19, this.sphere = _3(), this.tmpVertex = n2();
  }
  applyToVertex(t19, s15, e15) {
...
var k = class extends f5 {
  constructor() {
    super(...arguments), this.isSchematic = false, this.usePBR = false, this.mrrFactors = e3(n11), this.hasVertexColors = false, this.hasSymbolColors = false, this.doubleSided = false, this.doubleSidedType = "normal", this.cullFace = n8.Back, this.isInstanced = false, this.hasInstancedColor = false, this.emissiveFactor = r(0, 0, 0), this.instancedDoublePrecision = false, this.normalType = a4.Attribute, this.receiveSSAO = true, this.receiveShadows = true, this.castShadows = true, this.shadowMappingEnabled = false, this.ambient = r(0.2, 0.2, 0.2), this.diffuse = r(0.8, 0.8, 0.8), this.externalColor = r4(1, 1, 1, 1), this.colorMixMode = "multiply", this.opacity = 1, this.layerOpacity = 1, this.origin = n2(), this.hasSlicePlane = false, this.hasSliceHighlight = true, this.offsetTransparentBackfaces = false, this.vvSize = null, this.vvColor = null, this.vvOpacity = null, this.vvSymbolAnchor = null, this.vvSymbolRotationMatrix = null, this.modelTransformation = null, this.transparent = false, this.writeDepth = true, this.customDepthTest = e9.Less, this.textureAlphaMode = i6.Blend, this.textureAlphaCutoff = o8, this.textureAlphaPremultiplied = false, this.hasOccludees = false, this.renderOccluded = o6.Occlude;
  }
};
...
function z3(e15) {
  return e15.cullFace !== n8.None || !e15.hasSlicePlane && (!e15.transparent && !e15.doubleSidedMode);
}
q3.shader = new t12(Z2, () => import("./DefaultMaterial.glsl-MV4FVBXP.js"));
...
t18.shader = new t12(R, () => import("./RealisticTree.glsl-5EM2XD5D.js"));
...
function I3(e15, t19) {
  var _a;
  const r15 = new Array(), n12 = new Array(), s15 = new Array(), o16 = new t10(), u11 = e15.resource, c13 = r3.parse(u11.version || "1.0", "wosr");
  O8.validate(c13);
  ...
  for (let a12 = 0; a12 < d4.length; a12++) {
    ...
    if (null == O9) {
      ...
      const r16 = M5 && M5.alphaChannelUsage, n13 = e17.transparency > 0 || "transparency" === r16 || "maskAndTransparency" === r16, s16 = M5 ? E10(M5.alphaChannelUsage) : void 0, a13 = { ambient: e3(e17.diffuse), diffuse: e3(e17.diffuse), opacity: 1 - (e17.transparency || 0), transparent: n13, textureAlphaMode: s16, textureAlphaCutoff: 0.33, textureId: U3, initTextureTransparent: true, doubleSided: true, cullFace: n8.None, colorMixMode: e17.externalColorMixMode || "tint", textureAlphaPremultiplied: (M5 == null ? void 0 : M5.parameters.preMultiplyAlpha) ?? false };
...
function U2(e15) {
  ...
  return e15.forEach((e16) => {
    ...
    null != r15 && (h(t19, r15.bbMin), h(t19, r15.bbMax));
  }), t19;
}
...
async function X(t19, r15) {
  ...
  const s15 = await (r15.cache ? r15.cache.loadGLTF(o16.url, r15, !!r15.usePBR) : l2(new n7(r15.streamDataRequester), o16.url, r15, r15.usePBR)), i12 = (_a = s15.model.meta) == null ? void 0 : _a.ESRI_proxyEllipsoid, n12 = s15.meta.isEsriSymbolResource && null != i12 && s15.meta.uri.includes("/RealisticTrees/");
...
function Z3(e15, t19, r15, o16) {
  ...
  return s15.lods.forEach((e16, c13) => {
    ...
    e16.parts.forEach((e17) => {
      ...
      null != p6 && 0 === c13 && (h(a12, p6.bbMin), h(a12, p6.bbMax)), null != o17 && (f9.stageResources.geometries.push(i13), f9.numberOfVertices += u12);
    }), m5 || i12.push(f9);
...
function te(e15, r15) {
  ...
  if (null != e15.attributes.texCoord0) {
    ...
    n6(t19, r16, 2, i13), u11.push([O4.UV0, new s8(t19, 2, true)]), a12.push([O4.UV0, s15]);
  }
...
function se(e15, t19) {
  for (let r15 = 0; r15 < e15.model.lods.length; ++r15) {
    ...
    for (const d4 of f9.parts) {
      ...
      if (null == f10)
        return;
      const p6 = d4.attributes.position, g7 = p6.count, b3 = n2(), T6 = n2(), y4 = n2(), R3 = new Uint8Array(4 * g7), w5 = new Float64Array(3 * g7), v6 = h2(e6(), d4.transform);
      let M5 = 0, j6 = 0;
      for (let o16 = 0; o16 < g7; o16++) {
        p6.getVec(o16, T6), f10.getVec(o16, b3), O(T6, T6, d4.transform), e4(y4, T6, t19.center), i(y4, y4, t19.radius);
        const s15 = y4[2], m5 = s5(y4), g8 = Math.min(0.45 + 0.55 * m5 * m5, 1);
        i(y4, y4, t19.radius), null !== v6 && O(y4, y4, v6), z(y4, y4), r15 + 1 !== e15.model.lods.length && e15.model.lods.length > 1 && A2(y4, y4, b3, s15 > -1 ? 0.2 : Math.min(-4 * s15 - 3.8, 1)), w5[M5] = y4[0], w5[M5 + 1] = y4[1], w5[M5 + 2] = y4[2], M5 += 3, R3[j6] = 255 * g8, R3[j6 + 1] = 255 * g8, R3[j6 + 2] = 255 * g8, R3[j6 + 3] = 255, j6 += 4;
      }
...
//# sourceMappingURL=objectResourceUtils-CU7IAF2T.js.map
