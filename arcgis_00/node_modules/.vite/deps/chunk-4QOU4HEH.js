import {
  c as c2
} from "./chunk-FHXCZTIG.js";
import {
  p as p3
} from "./chunk-QRO5NJB4.js";
import {
  a as a2
} from "./chunk-252NVZW4.js";
import {
  t as t2
} from "./chunk-C5HWYH4Q.js";
import {
  Be
...
async function s4(e4, t4) {
  if ("Utility Network Layer" === e4) {
    const { default: e5 } = await import("./UtilityNetwork-EGP6GAEG.js");
...
var v = class extends O(_) {
  ...
  async queryNamedTraceConfigurations(e4, t4) {
    var _a;
    const { queryNamedTraceConfigurations: r2 } = await import("./queryNamedTraceConfigurations-S4L52CQW.js"), o3 = this.networkServiceUrl, a6 = new p5({ ...e4 });
  ...
  async validateTopology(e4, t4) {
    ...
    const [{ validateNetworkTopology: r2 }, { default: a6 }] = await Promise.all([import("./validateNetworkTopology-SXT3GURK.js"), import("./ValidateNetworkTopologyParameters-BBK2O2JB.js")]), s6 = a6.from(e4), i2 = this.networkServiceUrl, n4 = this.featureServiceUrl, l5 = l2(n4, null, true), d3 = await r2(i2, s6, { ...t4 });
  ...
  async submitTopologyValidationJob(e4, t4) {
    ...
    const [{ submitValidateNetworkTopologyJob: r2 }, { default: a6 }] = await Promise.all([import("./validateNetworkTopology-SXT3GURK.js"), import("./ValidateNetworkTopologyParameters-BBK2O2JB.js")]), s6 = a6.from(e4), i2 = this.networkServiceUrl, n4 = this.featureServiceUrl ? l2(this.featureServiceUrl, null, true) : void 0, l5 = await r2(i2, s6, { ...t4 });
...
var b2 = class extends j2 {
  ...
  async trace(e4) {
    const [{ trace: t4 }, { default: r2 }] = await Promise.all([import("./trace-6QT36CTR.js"), import("./TraceParameters-UM52BWSK.js")]), s6 = r2.from(e4);
    return t4(this.networkServiceUrl, s6);
  }
  async submitTraceJob(e4) {
    const [{ submitTraceJob: t4 }, { default: r2 }] = await Promise.all([import("./trace-6QT36CTR.js"), import("./TraceParameters-UM52BWSK.js")]), s6 = r2.from(e4), a6 = await t4(this.networkServiceUrl, s6);
...
//# sourceMappingURL=chunk-4QOU4HEH.js.map
