...
var Notice = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    }, this.requestedIcon ? h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: this.scale === "l" ? "m" : "s" })) : null, h("div", { class: CSS.content }, h("slot", { name: SLOTS.title }), h("slot", { name: SLOTS.message }), h("slot", { name: SLOTS.link })), hasActionEnd ? h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd })) : null, this.closable ? closeButton : null);
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
@esri/calcite-components/dist/components/calcite-notice.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-notice-3DXUSTLE.js.map
