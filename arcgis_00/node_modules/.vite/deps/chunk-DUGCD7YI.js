...
function u(n8, r5, u6 = 0) {
  return "string" != typeof r5 || r5.includes(".") ? i5(n8, s2(r5), u6) : e4(r5, n8);
}
function o3(t13, n8) {
  return u(t13, n8);
}
function s4(t13, n8) {
  return void 0 !== u(n8, t13);
}

// node_modules/@arcgis/core/core/accessorSupport/set.js
function t3(o6, e9, s9) {
  if (o6 && e9)
    if ("object" == typeof e9)
      ...
      if (e9.includes(".")) {
        ...
        return void t3(o3(o6, n8), i9, s9);
      }
      const i8 = o6.__accessor__;
      null != i8 && n2(e9, i8), o6[e9] = s9;
    }
}
function n2(r5, t13) {
  if (has("esri-unknown-property-errors") && !e5(r5, t13))
    throw new s3("set:unknown-property", s5(r5, t13));
}
function e5(o6, r5) {
...
function y3(n8 = {}) {
  return (o6, s9) => {
    ...
    const i8 = Object.getOwnPropertyDescriptor(o6, s9), a5 = o(o6, s9);
    i8 && (i8.get || i8.set ? (a5.get = i8.get || a5.get, a5.set = i8.set || a5.set) : "value" in i8 && ("value" in n8 && s.getLogger("esri.core.accessorSupport.decorators.property").warn(`@property() will redefine the value of "${s9}" on "${o6.constructor.name}" already defined in the metadata`, n8), a5.value = n8.value = i8.value)), null != n8.readOnly && (a5.readOnly = n8.readOnly);
    const p5 = n8.aliasOf;
    if (p5) {
    ...
    a5.cast || (u6 ? a5.cast = h3(u6) : c5 && (Array.isArray(c5) ? a5.cast = b(S(c5[0])) : a5.cast = S(c5))), n(a5, n8), n8.range && (a5.cast = j3(a5.cast, n8.range));
  };
}
function d2(t13, e9, r5) {
  const n8 = o(t13, r5);
  n8.json || (n8.json = {});
  let o6 = n8.json;
...
var l3 = 0;
var p2 = 0;
var u2 = { time: n5(0), deltaTime: n5(0), elapsedFrameTime: n5(0), frameDuration: n5(0) };
...
var k2 = { frameTasks: d3, willDispatch: false, clearFrameTasks: j4, dispatch: b3, executeFrameTasks: D };
function v(e9) {
  const r5 = new m(e9);
  return h4.push(r5), k2.willDispatch || (k2.willDispatch = true, t2(b3)), r5;
}
function A(e9) {
  const t13 = new c3(e9);
  return d3.push(t13), null == T && (l3 = performance.now(), T = requestAnimationFrame(x)), new w2(t13);
}
var T = null;
function j4(e9 = false) {
  d3.forAll((e10) => {
    e10.removed = true;
  }), e9 && _2();
}
function x() {
  ...
  T = null, T = d3.length > 0 ? requestAnimationFrame(x) : null, k2.executeFrameTasks(e9);
}
function D(e9) {
  const t13 = n5(e9 - l3);
  l3 = e9;
  const r5 = p2 > 0 ? p2 : 1e3 / 60, s9 = Math.max(0, t13 - r5);
  u2.time = e9, u2.frameDuration = n5(r5 - s9);
  for (let o6 = 0; o6 < f2.length; o6++) {
    ...
    d3.forAll((r7) => {
      ...
      if (r7.paused || r7.removed)
        return;
      0 === o6 && r7.ticks++;
      r7.phases[s10] && (u2.elapsedFrameTime = n5(performance.now() - e9), u2.deltaTime = 0 === r7.ticks ? n5(0) : t13, (_a = r7.phases[s10]) == null ? void 0 : _a.call(r7, u2));
...
function y4(e9 = 1, r5) {
  const s9 = C(), i8 = () => {
    a3(r5) ? s9.reject(c()) : 0 === e9 ? s9() : (--e9, t2(() => i8()));
  };
  return i8(), s9.promise;
}
var R = f2.map((e9) => new s6(e9));
var q = new s6("total");
...
var e8 = [];
function o5(e9, o6) {
  let u6 = new t9(s9), l6 = null, f5 = false;
  function s9() {
    if (!u6 || f5)
      return;
    if (r4)
...
var p3;
function k3(e9) {
  v2.delete(e9), v2.add(e9), p3 || (p3 = v(q2));
}
function _3(e9) {
  if (e9.removed)
    return;
...
function q2() {
  ...
  for (; p3 && e9--; ) {
    p3 = null;
    const e10 = j5(), t13 = m2.acquire();
    for (const r5 of e10) {
      const e11 = r5.uid;
      _3(r5), e11 === r5.uid && r5.removed && t13.push(r5);
    }
    for (const r5 of v2)
      r5.removed && (t13.push(r5), v2.delete(r5));
    for (const r5 of t13)
      f3.pool.release(r5);
    m2.release(t13), m2.release(e10), V.forEach((e11) => e11());
  }
}
function j5() {
  const e9 = m2.acquire();
...
function U(e9, t13, r5) {
  let o6 = y(e9, t13, r5, (e10, t14, r6) => {
    let l6, i8, n8 = u3(() => u(e10, t14), (n9, s9) => {
...
function x2(e9) {
  return n6(v2, (t13) => t13.oldValue === e9);
}

// node_modules/@arcgis/core/core/accessorSupport/Property.js
var a4 = class {
  constructor(t13, e9) {
    this.propertyName = t13, this.metadata = e9, this.observerObject = new l5(), this._accessed = null, this._handles = null, this.observerObject.flags = i3.Dirty | (e9.nonNullable ? i3.NonNullable : 0) | (e9.hasOwnProperty("value") ? i3.HasDefaultValue : 0) | (void 0 === e9.get ? i3.DepTrackingInitialized : 0) | (void 0 === e9.dependsOn ? i3.AutoTracked : 0);
  }
  destroy() {
...
function g4(t13, e9, r5) {
  return void 0 !== t13;
}
function u4(t13, e9, r5, i8) {
...
var m3 = class {
  constructor(t13) {
    this.host = t13, this.propertiesByName = /* @__PURE__ */ new Map(), this.ctorArgs = null, this.destroyed = false, this.lifecycle = I.INITIALIZING, this.store = new t11(), this._origin = r2.USER;
...
`;
  ...
  _setAtOrigin(e9, r5, s9) {
    ...
    i8.has(o6, s9) && j(r5, i8.get(o6)) && ~e9.observerObject.flags & i3.Overriden && s9 === i8.originOf(o6) || (e9.invalidate(), i8.set(o6, r5, s9), e9.commit(), b2(this.host, e9));
  }
  _cast(t13, e9) {
    const r5 = y6.acquire();
...
var m4 = class _m {
  ...
  constructor(...t13) {
    ...
    const r5 = new m3(this);
    Object.defineProperty(this, "__accessor__", { enumerable: false, value: r5 }), t13.length > 0 && this.normalizeCtorArgs && (r5.ctorArgs = this.normalizeCtorArgs.apply(this, t13)), (_a = t12()) == null ? void 0 : _a.onInstanceConstruct(this), v4.register(this, r5.propertiesByName, this);
  }
  postscript(t13) {
  ...
  destroy() {
    var _a;
    this.destroyed || (v4.unregister(this), g3(this), this.__accessor__.destroy(), (_a = t12()) == null ? void 0 : _a.onInstanceDestroy(this));
  }
  get constructed() {
  ...
  addHandles(r5, e9) {
    ...
    let s9 = this[y7];
    null == s9 && (s9 = this[y7] = new t5()), s9.add(r5, e9);
  }
  removeHandles(t13) {
    const r5 = this[y7];
...
//# sourceMappingURL=chunk-DUGCD7YI.js.map
