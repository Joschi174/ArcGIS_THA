import {
  a as a4,
  n as n2
} from "./chunk-GL4GM2K3.js";
import {
  g as g2
} from "./chunk-4QOU4HEH.js";
import "./chunk-FHXCZTIG.js";
import "./chunk-QRO5NJB4.js";
import "./chunk-252NVZW4.js";
import "./chunk-R6QVSZHI.js";
import "./chunk-C5HWYH4Q.js";
import {
  i as i4
...
import "./chunk-XAH2FM2Y.js";
import {
  f as f2
} from "./chunk-D4WZD5FR.js";
...
e([y({ type: Boolean, json: { write: true } })], a12.prototype, "exactMatch", void 0), e([y({ type: String, json: { write: true } })], a12.prototype, "name", void 0), e([o3(i)], a12.prototype, "type", void 0), a12 = c10 = e([a2("esri.webdoc.applicationProperties.SearchLayerField")], a12);
var i13 = a12;
...
e([y({ type: Boolean, json: { write: true } })], a14.prototype, "exactMatch", void 0), e([y({ type: String, json: { write: true } })], a14.prototype, "name", void 0), e([o3(i)], a14.prototype, "type", void 0), a14 = c12 = e([a2("esri.webdoc.applicationProperties.SearchTableField")], a14);
var i14 = a14;
...
async function i16(e3, n10, i17) {
  ...
  if (s11.isWebMercator)
    return d2(a16);
  const { getGeometryServiceURL: c16 } = await import("./geometryServiceUtils-QTLWFXTH.js");
  try {
...
var Ae = class extends O(_.LoadableMixin(m2(j4))) {
  ...
  async save(e3) {
    ...
    const t4 = import("./saveUtils-MHM2C4S5.js");
  ...
  async saveAs(e3, t4) {
    t4 = t4 || {};
    const r3 = this._getPortalItem(e3), i17 = import("./saveUtils-MHM2C4S5.js");
    await this._updateFromPromise, await this.load(), await this._loadLayerContainers(), await this._beforeSave(), await this._validateMap();
  ...
  _loadFromJSON(e3, t4) {
    ...
    return this.portalItem && (r3.context.portal = this.portalItem.portal || j3.getDefault()), import("./layersCreator-WI777537.js").then(({ populateOperationalLayers: t5 }) => {
  ...
  async _projectToWGS84(e3) {
    ...
    if (t4.isWebMercator)
      return R2(e3);
    const { getGeometryServiceURL: r3 } = await import("./geometryServiceUtils-QTLWFXTH.js"), i17 = await r3(this.portalItem), o6 = new a4();
