...
var s6 = 8;
var l3 = s6 - 2;
var a3 = s.getLogger("esri.views.2d.layers.features.support.rendererUtils");
var n6 = (e6) => {
...
var x3 = s.getLogger("esri.views.2d.layers.features.schemaUtils");
...
var j3 = s.getLogger("esri.views.2d.engine.webgl.AttributeStoreView");
var k2 = n4(l, j3);
var M2 = class {
...
var O2 = class {
  ...
  initialize(t3) {
    ...
    if (this.shared = s8, this.size = r5, k2("Initializing AttributeStoreView", t3), null == this._data)
      this._data = s2(e6, (t4) => new M2(t4, r5, s8));
    else
  ...
  destroy() {
    n(this._data, (t3) => s2(t3, (t4) => t4.destroy())), n(this._defaultTexture, (t3) => t3.dispose());
  }
  isEmpty() {
...
//# sourceMappingURL=chunk-IL44YAUG.js.map
