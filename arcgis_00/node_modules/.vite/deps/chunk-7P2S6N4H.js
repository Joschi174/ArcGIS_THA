...
import {
  p
} from "./chunk-BI26XH27.js";
import {
  c as c3
} from "./chunk-PPY3JRDD.js";
import {
  M
...
var D;
var U;
var b = { PortalGroup: () => import("./PortalGroup-5VZ2FAG2.js"), PortalItem: () => import("./PortalItem-EUAZUYIG.js"), PortalUser: () => import("./PortalUser-XB5YU3TO.js") };
var Q = D = class extends u(_) {
  ...
  load(e3) {
    const t2 = import("./Basemap-GXPWPLBK.js").then(({ default: t3 }) => {
      s3(e3), U = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-SDC3K3TG.js")).default;
  ...
  fetchCategorySchema(e3) {
    return this.hasCategorySchema ? this.request(this.restUrl + "/portals/self/categorySchema", e3).then((e4) => e4.categorySchema) : a2(e3) ? Promise.reject(c2()) : Promise.resolve([]);
  }
  fetchFeaturedGroups(e3) {
    ...
    return a2(e3) ? Promise.reject(c2()) : Promise.resolve([]);
  }
  fetchRegions(e3) {
    var _a;
    const t2 = ((_a = this.user) == null ? void 0 : _a.culture) || this.culture || c();
  ...
  fetchSelf(e3 = this.authMode, t2 = false, r2) {
    const o3 = this.restUrl + "/portals/self", s4 = { authMode: e3, query: { culture: c().toLowerCase() }, ...r2 };
...
//# sourceMappingURL=chunk-7P2S6N4H.js.map
