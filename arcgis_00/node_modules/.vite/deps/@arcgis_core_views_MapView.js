...
var w3 = (w9) => {
  let d16 = class extends w9 {
    constructor(...e16) {
      super(...e16), this._breakpointsHandles = new t2(), this.orientation = null, this.widthBreakpoint = null, this.heightBreakpoint = null, this.breakpoints = o7;
    }
    initialize() {
    ...
    _updateClassNames() {
      if (!this.container)
        return;
      const e16 = t3.acquire(), s19 = t3.acquire();
      let a29, t23 = false;
      for (a29 in n14) {
      ...
      t23 && (this._applyClassNameChanges(e16, s19), t3.release(e16), t3.release(s19));
    }
  ...
  let p21 = class extends i26 {
    ...
    set container(e16) {
      ...
      if (o20 || "string" != typeof e16 || s.getLogger(this).error("#container", `element with id '${e16}' not found`), i27 === o20)
        return;
      if (this._stopMeasuring(), i27 && (i27.classList.remove("esri-view"), this._overlayRenderTaskHandle && (this._overlayRenderTaskHandle.remove(), this._overlayRenderTaskHandle = null), this.overlay && (this.overlay.destroy(), this._set("overlay", null)), this.root && (m7(this.root), this._set("root", null)), this.userContent && (i2(this.userContent, i27), m7(this.userContent), this._set("userContent", null))), !o20)
      ...
      h12.className = "esri-view-user-storage", i2(o20, h12), o20.appendChild(h12), this._set("userContent", h12);
      ...
      const p22 = new c10();
      l17.appendChild(p22.surface), this._set("overlay", p22), this.addHandles(l3(() => p22.needsRender, (e17) => {
...
var w5 = (w9) => {
  let m15 = class extends w9 {
    ...
    initialize() {
      this.addHandles([l3(() => [this.ui, this.popup], ([e16, p21], t23) => {
      ...
      }, _3.WIDGET)]), j2(() => this.ready && this.popupEnabled && !this.updating).then(() => {
        import("./Popup-QQGE6UQZ.js");
      });
    }
    destroy() {
    ...
    async setupPopup() {
      ...
      if ((_a = this._popupSetupTask) == null ? void 0 : _a.abort(), this.popup && !d7(this.popup))
        return this._popupSetupTask = d3(async (e16) => {
          const { default: p21 } = await import("./Popup-QQGE6UQZ.js");
          if (s4(e16), !this.popup || d7(this.popup))
            return;
  ...
  return e([y({ cast(e16) {
    return !e16 || d7(e16) || "object" == typeof e16 && (e16.open = (e17) => (r2(s.getLogger(this), "view.popup is no longer created by default. view.popup.open() will stop working when the popup isn't created", { replacement: "Use view.openPopup() instead.", version: "4.27" }), this.openPopup(e17)), e16.close = () => (r2(s.getLogger(this), "view.popup is no longer created by default. view.popup.close() will stop working when the popup isn't created", { replacement: "Use view.closePopup() instead.", version: "4.27" }), this.closePopup())), e16;
  ...
  async start() {
    ...
    try {
      ...
      if (await r19.load({ signal: e16 }), "prefetchResources" in r19 && await ((_a = r19.prefetchResources) == null ? void 0 : _a.call(r19, { signal: e16 })), M3(r19))
        ...
        s4(e16), o20 = "default" in s19 ? new s19.default({ layer: r19, view: t23 }) : new s19({ layer: r19, view: t23 });
      }
      const n28 = () => {
        l17 = o(l17), o20.destroyed || o20.destroy(), o20.layer = null, o20.parent = null, o20.view = null, this.done = true;
      };
      l17 = w(e16, n28), s4(e16);
      try {
        await o20.when();
      } catch (s19) {
        throw n28(), s19;
...
var i9 = class extends m {
  constructor(o20) {
    super(o20), this.factor = 1.5, this.offset = c4(0, 0), this.position = null, this.size = 120, this.maskUrl = null, this.maskEnabled = true, this.overlayUrl = null, this.overlayEnabled = true, this.visible = true;
  }
  get version() {
...
var c11 = class extends i8 {
  ...
  _wrapClick(t23) {
    ...
    return { type: "click", pointerType: a29, button: n28, buttons: r19, x: i26, y: o20, native: s19, timestamp: l17, screenPoint: c4(i26, o20), mapPoint: this._getMapPoint(i26, o20), eventId: p21, cancelable: c23, stopPropagation: () => t23.stopPropagation(), async: (e16) => t23.async(e16), preventDefault: () => t23.preventDefault() };
  }
  ...
  _getMapPoint(t23, a29) {
    return this.view.toMap(c4(t23, a29), { exclude: [] });
  }
  _wrapDrag(e16) {
    ...
    return "end" === i26 && (this._latestDragStart = void 0), { type: "drag", action: i26, x: n28, y: r19, origin: m15, pointerType: o20, button: s19, buttons: c23, radius: a29.radius, angle: m2(a29.angle), native: p21, timestamp: u9, cancelable: l17, stopPropagation: () => e16.stopPropagation(), async: (t23) => e16.async(t23), preventDefault: () => e16.preventDefault() };
  }
  _wrapKeyDown(t23) {
...
var s10 = class {
    ...
    switch (t23.type) {
      ...
      case "pointer-drag": {
        ...
        if (null == s19 || null == l17)
          break;
        const u9 = n16(t23);
        u9.x = i(u9.x, 0, e16.view.width), u9.y = i(u9.y, 0, e16.view.height);
  ...
  updateHoveredStateFromKnownPointers(t23) {
    this._pointerLocations.forEach((e16, o20) => {
      this._updateHoveredStateForPointerAtScreenPosition(c4(e16.x, e16.y), o20, e16.pointerType, t23);
    });
  }
...
var w6 = class extends d4 {
  ...
  attach() {
    var _a;
    "3d" === this.view.type ? (this._set("textures", new a8(this.view._stage, this.view.resourceController.scheduler)), this.handles.add([l3(() => {
      const { state: t23 } = this.view;
      return "camera" in t23 && t23.camera;
    }, () => this._forEachManipulator((t23) => t23.onViewChange())), (_a = this.view.elevationProvider) == null ? void 0 : _a.on("elevation-change", (t23) => this._forEachManipulator((e16) => e16.onElevationChange(t23))), e2(() => this._set("textures", l(this.textures)))], f6)) : this.handles.add(l3(() => this.view.extent, () => this._forEachManipulator((t23) => t23.onViewChange())));
  }
  detach() {
...
function l8(e16) {
  var _a;
  const i26 = e16.url ? p2(e16.url) : void 0, r19 = (_a = e16.spatialReference) == null ? void 0 : _a.vcsWkid;
...
async function c13(r19) {
  s12 || (s12 = import("./geometryServiceUtils-JDAQ4LZZ.js").then((e16) => n18 = e16)), await s12, s4(r19);
}
...
var k;
var W2 = k = class extends a4(n4.EventedMixin(m3(m))) {
  constructor(e16) {
    super(e16), this._userSpatialReference = null, this._cursor = null, this.allLayerViews = new n8({ getCollections: () => {
      var _a, _b, _c;
...
W2.views = new V(), e([y()], W2.prototype, "_userSpatialReference", void 0), e([y()], W2.prototype, "activeTool", null), e([y({ readOnly: true })], W2.prototype, "allLayerViews", void 0), e([y()], W2.prototype, "groundView", void 0), e([y()], W2.prototype, "animation", null), e([y()], W2.prototype, "basemapView", void 0), e([y()], W2.prototype, "center", null), e([y({ readOnly: true })], W2.prototype, "_defaultsFromMapSettings", null), e([y()], W2.prototype, "defaultsFromMap", null), e([y()], W2.prototype, "fatalError", void 0), e([y({ type: M })], W2.prototype, "extent", null), e([y(p4(i7, "graphics"))], W2.prototype, "graphics", void 0), e([y(p4(t10, "analyses"))], W2.prototype, "analyses", void 0), e([y({ readOnly: true, type: v3 })], W2.prototype, "heightModelInfo", null), e([y({ readOnly: true })], W2.prototype, "interacting", null), e([y({ readOnly: true })], W2.prototype, "navigating", null), e([y({ readOnly: true, dependsOn: ["fatalError", "_isValid", "_readyCycleForced", "map", "map.loaded?", "width", "height", "spatialReference", "_currentSpatialReference", "defaultsFromMap.ready", "typeSpecificPreconditionsReady"] })], W2.prototype, "preconditionsReady", null), e([y({ readOnly: true })], W2.prototype, "typeSpecificPreconditionsReady", void 0), e([y({ type: V, readOnly: true })], W2.prototype, "layerViews", void 0), e([y()], W2.prototype, "resolution", null), e([y({ type: p6 })], W2.prototype, "magnifier", void 0), e([y({ value: null, type: j4 })], W2.prototype, "map", null), e([y()], W2.prototype, "padding", void 0), e([y({ readOnly: true })], W2.prototype, "ready", void 0), e([y({ type: f })], W2.prototype, "spatialReference", null), e([y()], W2.prototype, "spatialReferenceWarningDelay", void 0), e([y()], W2.prototype, "stationary", null), e([y({ readOnly: true })], W2.prototype, "supportsGround", void 0), e([y({ type: c5 })], W2.prototype, "timeExtent", void 0), e([y({ type: c3, nonNullable: true })], W2.prototype, "timeReference", void 0), e([y()], W2.prototype, "tools", null), e([y()], W2.prototype, "toolViewManager", void 0), e([y({ readOnly: true })], W2.prototype, "type", void 0), e([y({ type: Number })], W2.prototype, "scale", void 0), e([y({ readOnly: true })], W2.prototype, "updating", void 0), e([y({ readOnly: true })], W2.prototype, "initialExtentRequired", void 0), e([y({ readOnly: true })], W2.prototype, "initialExtent", null), e([y()], W2.prototype, "cursor", null), e([y({ readOnly: true })], W2.prototype, "input", void 0), e([y({ type: p10, nonNullable: true })], W2.prototype, "navigation", void 0), e([y()], W2.prototype, "layerViewManager", void 0), e([y()], W2.prototype, "analysisViewManager", void 0), e([y()], W2.prototype, "width", void 0), e([y()], W2.prototype, "height", void 0), e([y({ readOnly: true })], W2.prototype, "resizing", void 0), e([y({ value: null, readOnly: true })], W2.prototype, "size", null), e([y({ readOnly: true })], W2.prototype, "suspended", void 0), e([y({ readOnly: true })], W2.prototype, "viewEvents", void 0), e([y({ readOnly: true })], W2.prototype, "persistableViewModels", void 0), e([y()], W2.prototype, "_isValid", void 0), e([y()], W2.prototype, "_readyCycleForced", void 0), e([y()], W2.prototype, "_currentSpatialReference", void 0), W2 = k = e([a("esri.views.View")], W2);
var z2 = W2;
function A2(e16) {
...
var a15 = class {
  ...
  start() {
    if (this._frameTaskHandle)
      return;
    const a29 = this.view;
    this.stationary = a29.stationary, this._updateParameters = { state: a29.state, pixelRatio: window.devicePixelRatio, stationary: this.stationary, renderingOptions: a29.renderingOptions }, this._stationaryHandle = l3(() => a29.stationary, (t23) => {
...
function r11() {
  return Promise.all([import("./webglDeps-U2IEIAIS.js"), import("./mapViewDeps-5WNVVINO.js")]);
}
var a16 = () => r11().then(() => import("./TileLayerView2D-OVMN5G2Q.js"));
var t13 = () => r11().then(() => import("./FeatureLayerView2D-QMWXVZKP.js"));
var s13 = { "base-dynamic": () => r11().then(() => import("./BaseDynamicLayerView2D-LD5R4ZIM.js")), "base-tile": a16, "bing-maps": a16, csv: t13, "geo-rss": () => r11().then(() => import("./GeoRSSLayerView2D-L7LCHBHA.js")), feature: t13, geojson: t13, graphics: () => r11().then(() => import("./GraphicsLayerView2D-UAS6SROI.js")), group: () => r11().then(() => import("./GroupLayerView2D-G4EJ4YJI.js")), imagery: () => r11().then(() => import("./ImageryLayerView2D-3QZSLVQ5.js")), "imagery-tile": () => r11().then(() => import("./ImageryTileLayerView2D-WYLWRGGS.js")), kml: () => r11().then(() => import("./KMLLayerView2D-OSUJMWT3.js")), "knowledge-graph": () => r11().then(() => import("./KnowledgeGraphLayerView2D-4AEANL2P.js")), "link-chart": () => r11().then(() => import("./KnowledgeGraphLayerView2D-4AEANL2P.js")), "knowledge-graph-sublayer": t13, "map-image": () => r11().then(() => import("./MapImageLayerView2D-WQV24ULD.js")), "map-notes": () => r11().then(() => import("./MapNotesLayerView2D-AIXMIXJ7.js")), media: () => r11().then(() => import("./MediaLayerView2D-CZ3FBA23.js")), "ogc-feature": () => r11().then(() => import("./OGCFeatureLayerView2D-VGXI5VZD.js")), "open-street-map": a16, "oriented-imagery": t13, route: () => r11().then(() => import("./RouteLayerView2D-ISFYZHVT.js")), stream: () => r11().then(() => import("./StreamLayerView2D-CVYB2MNH.js")), "subtype-group": () => r11().then(() => import("./SubtypeGroupLayerView2D-YXIZE2KZ.js")), tile: a16, "vector-tile": () => r11().then(() => import("./VectorTileLayerView2D-D5TUY3CN.js")), video: () => r11().then(() => import("./VideoLayerView2D-B4UWRT5R.js")), wcs: () => r11().then(() => import("./ImageryTileLayerView2D-WYLWRGGS.js")), "web-tile": a16, wfs: t13, wms: () => r11().then(() => import("./WMSLayerView2D-OT2AM3EM.js")), wmts: () => r11().then(() => import("./WMTSLayerView2D-FVGJGWOV.js")), "line-of-sight": null, "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "integrated-mesh": null, "point-cloud": null, voxel: null, scene: null, unknown: null, unsupported: null };
function i17(r19) {
...
var l11 = p13 = class extends i4(m) {
  ...
  constrain(e16, r19) {
    ...
    if ("extent" === this.normalizedGeometry.type ? t5(this.normalizedGeometry, t23) : f2(this.normalizedGeometry, t23))
      return e16;
...
var p14 = { base: null, key: "type", typeMap: { extent: M, polygon: j } };
...
var O = b = class extends l2 {
  ...
  _update() {
    ...
    const x2 = r5(this.viewMat3), z5 = t7(m15[0] / 2, m15[1] / 2), g11 = t7(-m15[0] / 2, -m15[1] / 2), D2 = r(o20);
...
var z3 = class extends m {
  ...
  toScreen(t23) {
    ...
    return this.state.toScreen(i26, i26), c4(i26[0], i26[1]);
  }
  _project(t23, e16) {
    var _a;
...
var d11 = class extends i8 {
  constructor(i26) {
    super(true), this._view = i26, this._frameTask = null, this._watchHandles = new t2(), this._currentDevice = null, this._transformation = { translation: [0, 0, 0], heading: 0, tilt: 0, zoom: 0 }, this._handle = this.registerIncoming("gamepad", (t23) => this._handleGamePadEvent(t23)), this._handle.pause();
  }
  onInstall(t23) {
...
function r15(e16, n28) {
  if (n28 ? (n28.radius = 0, n28.center.x = 0, n28.center.y = 0) : n28 = { radius: 0, center: c4() }, 0 === e16.length)
    return n28;
  if (1 === e16.length)
  ...
  const f13 = 0.5 * (y9 + h12), g11 = 0.5 * (a29 + l17), p21 = u9 * i26 - x2 * x2, d16 = (f13 * i26 - g11 * x2) / p21, m15 = (u9 * g11 - x2 * f13) / p21, M4 = c4(d16 + r19, m15 + c23);
...
var p15 = class extends i8 {
  constructor(e16 = l14.maximumDoubleClickDelay, a29 = l14.maximumDoubleClickDistance, r19 = l14.maximumDoubleTouchDelay, n28 = l14.maximumDoubleTouchDistance, u9 = t4) {
    super(false), this._maximumDoubleClickDelay = e16, this._maximumDoubleClickDistance = a29, this._maximumDoubleTouchDelay = r19, this._maximumDoubleTouchDistance = n28, this._clock = u9, this._doubleTapDragReady = false, this._doubleTapDragActive = false, this._dragStartCenter = c4(0, 0), this._pointerState = /* @__PURE__ */ new Map(), this._doubleTapDrag = this.registerOutgoing("double-tap-drag"), this._dragEventSeparator = new t16({ start: (t23, e17) => this._dragStart(t23, e17), update: (t23, e17) => this._dragUpdate(e17), end: (t23, e17) => this._dragEnd(e17) }), this.registerIncoming("drag", (t23) => this._dragEventSeparator.handle(t23)), this.registerIncoming("pointer-down", (t23) => this._handlePointerDown(t23)), this.registerIncoming("pointer-up", () => this._handlePointerUp());
  }
  onUninstall() {
  ...
  _dragStart(t23, e16) {
    ...
    const s19 = this._createDoubleTapDragData("begin", c4(0, 0), a29);
    this._doubleTapDrag.emit(s19, void 0, o20), e16.stopPropagation();
  }
  _dragUpdate(t23) {
    if (!this._doubleTapDragActive)
      return;
    const { data: e16, modifiers: a29 } = t23, { center: o20 } = e16, r19 = c4(o20.x - this._dragStartCenter.x, o20.y - this._dragStartCenter.y), s19 = this._createDoubleTapDragData("update", r19, e16);
    this._doubleTapDrag.emit(s19, void 0, a29), t23.stopPropagation();
  }
  _dragEnd(t23) {
    if (!this._doubleTapDragActive)
      return;
    const { data: e16, modifiers: a29 } = t23, { center: o20 } = e16, r19 = c4(o20.x - this._dragStartCenter.x, o20.y - this._dragStartCenter.y), s19 = this._createDoubleTapDragData("end", r19, e16);
...
function r16(e16) {
  ...
  return e16.forEach((e17) => {
    i26.push(c4(e17.event.x, e17.event.y));
  }), r15(i26);
}
function a24(t23) {
  const e16 = r16(t23);
...
var m11 = class extends i8 {
  constructor(e16 = l14.maximumDoubleClickDelay, o20 = l14.maximumDoubleClickDistance, a29 = l14.maximumDoubleTouchDelay, m15 = l14.maximumDoubleTouchDistance, n28 = t4) {
...
var r17 = class extends i8 {
  constructor(e16 = o18.maximumClickDelay, i26 = o18.movementUntilMouseDrag, n28 = o18.movementUntilPenDrag, r19 = o18.movementUntilTouchDrag, s19 = o18.holdDelay, a29 = t4) {
...
var k2 = class extends m {
  ...
  initialize() {
    ...
    this._handles.add([f3(() => !e16(), () => this._disconnect()), f3(e16, () => this._connect())]);
  }
  destroy() {
...
e([y({ dependsOn: [] })], p17.prototype, "id", null), e([y()], p17.prototype, "node", null), e([s5("node")], p17.prototype, "castNode", null), e([y({ readOnly: true })], p17.prototype, "widget", void 0), p17 = e([a("esri.views.ui.Component")], p17);
var l15 = p17;
...
var P2 = class extends n4.EventedAccessor {
  ...
  _place(t23) {
    ...
    if (0 === e16)
      return void (r19.firstChild ? o4(n28.node, r19.firstChild) : r19.appendChild(n28.node));
    e16 >= a29.length ? r19.appendChild(n28.node) : o4(n28.node, a29[e16]);
  }
...
e([y()], P2.prototype, "_locale", void 0), e([y()], P2.prototype, "container", null), e([y()], P2.prototype, "height", null), e([y({ value: _6 })], P2.prototype, "padding", null), e([s5("padding")], P2.prototype, "castPadding", null), e([y()], P2.prototype, "view", void 0), e([y()], P2.prototype, "width", null), P2 = e([a("esri.views.ui.UI")], P2);
var L2 = P2;
...
var _7 = class extends d4 {
  constructor(t23) {
    ...
    }, "change", (t24) => this._allLayerViewsChange(t24), { onListenerAdd: () => this._allLayerViewsChange(), onListenerRemove: this._clear }), f3(() => {
      var _a;
  ...
  _createContributionIndex(t23, e16) {
    ...
    for (let o20 = 0; o20 < i26.length; o20++) {
      ...
      for (const i27 of s19) {
        const s20 = i27.bbox, n28 = i27.zoomMin - (e16 && i27.zoomMin ? 1 : 0), a29 = i27.zoomMax - (e16 && i27.zoomMax ? 1 : 0), c23 = new M({ xmin: s20[1], ymin: s20[0], xmax: s20[3], ymax: s20[2], spatialReference: f.WGS84 }), l17 = { extent: d2(c23), attribution: t24.attribution || "", score: null != i27.score ? i27.score : 100, id: o20 };
  ...
  _getDynamicAttribution(t23, e16, i26) {
    ...
    return n28 ? n28.filter((t24) => {
      const e17 = t24.id, i27 = !c23.has(e17) && a29 && t24.extent && t5(t24.extent, a29);
...
var d14 = class extends t9(m) {
  constructor(t23) {
    super(t23), this._handles = new t2(), this.orientation = { x: 0, y: 0, z: 0 }, this.view = null, this._updateForCamera = this._updateForCamera.bind(this), this._updateForRotation = this._updateForRotation.bind(this), this._updateRotationWatcher = this._updateRotationWatcher.bind(this);
  }
  initialize() {
...
var n26 = class extends W {
  ...
  render() {
    ...
    return n6("div", { bind: this, class: this.classes(i24.base, a29), onclick: this._reset, onkeydown: this._reset, role: "button", tabIndex: r19, "aria-label": n28.reset, title: n28.reset }, n6("span", { "aria-hidden": "true", class: this.classes(i24.icon, p21), styles: this._toRotationTransform(e16) }), n6("span", { class: i24.text }, n28.reset));
  }
  _reset() {
...
e([y()], n26.prototype, "goToOverride", null), e([y()], n26.prototype, "iconClass", void 0), e([y()], n26.prototype, "icon", void 0), e([y()], n26.prototype, "label", null), e([y(), e5("esri/widgets/Compass/t9n/Compass")], n26.prototype, "messages", void 0), e([y()], n26.prototype, "view", null), e([y({ type: c19 })], n26.prototype, "viewModel", void 0), e([t6()], n26.prototype, "_reset", null), n26 = e([a("esri.widgets.Compass")], n26);
var d15 = n26;
...
e([y()], n27.prototype, "action", void 0), e([y()], n27.prototype, "enabled", void 0), e([y()], n27.prototype, "iconClass", void 0), e([y()], n27.prototype, "icon", void 0), e([y()], n27.prototype, "title", void 0), e([t6()], n27.prototype, "_triggerAction", null), n27 = e([a("esri.widgets.IconButton")], n27);
var a27 = n27;
...
e([y()], a28.prototype, "iconClass", void 0), e([y()], a28.prototype, "icon", void 0), e([y()], a28.prototype, "label", null), e([y({ value: "vertical" })], a28.prototype, "layout", null), e([y(), e5("esri/widgets/Zoom/t9n/Zoom")], a28.prototype, "messages", void 0), e([y()], a28.prototype, "view", null), e([y({ type: p19 })], a28.prototype, "viewModel", void 0), a28 = e([a("esri.widgets.Zoom")], a28);
var c22 = a28;
...
var re;
async function se() {
  const [, { GraphicsView2D: e16, GraphicContainer: t23, LabelManager: i26, MapViewNavigation: r19, MagnifierView2D: s19, Stage: a29 }] = await Promise.all([import("./webglDeps-U2IEIAIS.js"), import("./mapViewDeps-5WNVVINO.js")]);
...
var oe = class extends w3(w5(C2(z2))) {
  constructor(e16) {
    super(e16), this._magnifierView = null, this._stage = null, this._resolveWhenReady = [], this.rootLayerViews = new n8({ getCollections: () => {
      var _a, _b;
