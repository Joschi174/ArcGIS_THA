...
function T2(e3, t4) {
  const r5 = n2(), o4 = `${V("media", r5)}.${t3(e3)}`;
...
var g = class extends a2(t(c3(O(b)))) {
  ...
  load(e3) {
    ...
    const s5 = S3(t4) ? new V3({ elements: new V2([t4]) }) : t4;
  ...
  castSource(e3) {
    return e3 ? Array.isArray(e3) ? new V3({ elements: new V2(e3) }) : e3 instanceof V2 ? new V3({ elements: e3 }) : e3 : null;
  }
  readSource(e3, r5, o4) {
...
//# sourceMappingURL=MediaLayer-QJP2FFBC.js.map
