import {
  n as n2
} from "./chunk-TLOQJEGE.js";
import {
  n,
  s as s2
} from "./chunk-IMFP6AK3.js";
import {
  a as a2
...
var F = class extends m {
  ...
  async featureSetFromJSON(e2, t, r) {
    if (!this._queryIs3DObjectFormat(e2) || null == this.infoFor3D || !t.features)
      return d.fromJSON(t);
    const { meshFeatureSetFromJSON: s3 } = await p(import("./meshFeatureSet-6L2JOBES.js"), r);
  ...
  async executeRelationshipQuery(e2, t) {
    const [{ default: r }, { executeRelationshipQuery: s3 }] = await p(Promise.all([import("./RelationshipQuery-EIM4FEED.js"), import("./executeRelationshipQuery-YS4O3LMP.js")]), t);
  ...
  async executeRelationshipQueryForCount(e2, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: s3 }] = await p(Promise.all([import("./RelationshipQuery-EIM4FEED.js"), import("./executeRelationshipQuery-YS4O3LMP.js")]), t);
    return e2 = r.from(e2), (this.gdbVersion || this.dynamicDataSource) && ((e2 = e2.clone()).gdbVersion = e2.gdbVersion || this.gdbVersion, e2.dynamicDataSource = e2.dynamicDataSource || this.dynamicDataSource), s3(this.url, e2, t);
  }
  async executeAttachmentQuery(e2, t) {
    const { executeAttachmentQuery: r, fetchAttachments: s3, processAttachmentQueryResult: i } = await p(import("./queryAttachments-FIXN2SC4.js"), t), u2 = f(this.url);
    return i(u2, await (this.queryAttachmentsSupported ? r(u2, e2, t) : s3(u2, e2, t)));
  }
  async executeTopFeaturesQuery(e2, t) {
    const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-CKD525UY.js"), t);
    return r(this.parsedUrl, e2, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e2, t) {
    const { executeForTopIds: r } = await p(import("./executeForTopIds-ZZVQACVW.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopExtents(e2, t) {
    const { executeForTopExtents: r } = await p(import("./executeForTopExtents-4GZJFPWJ.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopCount(e2, t) {
    const { executeForTopCount: r } = await p(import("./executeForTopCount-YT7NYHRD.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  _normalizeQuery(e2) {
    let t = b.from(e2);
...
//# sourceMappingURL=chunk-VDZE3Y76.js.map
