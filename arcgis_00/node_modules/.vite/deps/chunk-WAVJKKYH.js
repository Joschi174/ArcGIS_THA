...
function T2(N4, y4) {
  N4.today = function(r4, o2) {
    return y4(r4, o2, (a3, s4, u3) => {
      ...
      return c4.setHours(0, 0, 0, 0), c.dateJSAndZoneToArcadeDate(c4, Pe(r4));
    });
    ...
    return y4(r4, o2, (a3, s4, u3) => {
      Q(u3, 0, 0, r4, o2);
      const c4 = c.nowToArcadeDate(Pe(r4));
    ...
    return y4(s4, l5, (i4, f3, h5) => {
      if (Q(h5, 0, 8, s4, l5), 3 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), 0, 0, 0, 0, Pe(s4)));
      if (4 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), fe(h5[3]), 0, 0, 0, Pe(s4)));
      if (5 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), fe(h5[3]), fe(h5[4]), 0, 0, Pe(s4)));
      if (6 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), fe(h5[3]), fe(h5[4]), fe(h5[5]), 0, Pe(s4)));
      if (7 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), fe(h5[3]), fe(h5[4]), fe(h5[5]), fe(h5[6]), Pe(s4)));
      if (8 === h5.length)
        return w2(c.fromParts(fe(h5[0]), fe(h5[1]) + 1, fe(h5[2]), fe(h5[3]), fe(h5[4]), fe(h5[5]), fe(h5[6]), D(oe(h5[7]), s4)));
      if (2 === h5.length) {
        let e4, t7 = oe(h5[1]);
        return "" === t7 ? null : (t7 = te(t7), e4 = "X" === t7 ? DateTime.fromSeconds(fe(h5[0])) : "x" === t7 ? DateTime.fromMillis(fe(h5[0])) : DateTime.fromFormat(oe(h5[0]), t7, { locale: c2(), numberingSystem: "latn" }), e4.isValid ? c.dateTimeToArcadeDate(e4) : null);
      }
      if (1 === h5.length) {
        if (L(h5[0])) {
        ...
        if (false === isNaN(e4)) {
          ...
          return r4.isValid ? c.dateTimeAndZoneToArcadeDate(r4, Pe(s4)) : null;
        }
        return ce(h5[0], Pe(s4));
      }
      return 0 === h5.length ? c.nowToArcadeDate(Pe(s4)) : null;
    });
...
//# sourceMappingURL=chunk-WAVJKKYH.js.map
