import {
  ...
  h as h3,
  r as r4
} from "./chunk-46OTPSVO.js";
import "./chunk-2GLJOVSV.js";
import {
  X,
  Y,
  b as b3
} from "./chunk-BI63LNBK.js";
import {
  S as S2
} from "./chunk-6UIMJE2V.js";
import {
  o
} from "./chunk-VQ3WLH7N.js";
import {
  I as I2,
  a as a3,
  r as r3,
  u as u3
} from "./chunk-7ESCKDCT.js";
import {
  I
} from "./chunk-C454H62Q.js";
import {
  t as t4
...
import {
  f as f4,
  m as m4
} from "./chunk-VJFVVRIB.js";
import "./chunk-SSJP5KD5.js";
import {
  b as b2,
  h
} from "./chunk-CSMMS4NB.js";
import {
  n as n4
} from "./chunk-E5YRWFQU.js";
import "./chunk-B5VZ5MGX.js";
import "./chunk-PISYP3ZS.js";
import {
  ee
...
import {
  e as e2,
  t as t2
} from "./chunk-NUGAWFAM.js";
import {
  t as t3
} from "./chunk-KBZKT5PQ.js";
...
function o2(o6) {
  return "heatmap" === o6 ? import("./HeatmapProcessor-YLCJG5TQ.js") : import("./SymbolProcessor-NWUAFG4Z.js");
}
...
var m7 = class {
  ...
  async _onMessage(e3) {
    ...
    return y2(this._onTileUpdateMessage(t6, s10.options));
  }
  update(s10, t6) {
    var _a;
...
e([y()], s9.prototype, "connection", void 0), e([y()], s9.prototype, "connectionStatus", null), e([y()], s9.prototype, "errorString", null), s9 = e([a("esri.views.2d.layers.features.sources.StreamConnectionState")], s9);
...
var I4 = class extends m7 {
  constructor(t6) {
    ...
    this._connectionState = new s9({ connection: j7 }), this._store = b4, this._manager = T4, this._connection = j7, this._quantize = m8(i6), this._enabledEventTypes = new Set(I5), this._handlesGroup = n([this._connection.on("data-received", (e3) => this._onFeature(e3)), this._connection.on("message-received", (e3) => this._onWebSocketMessage(e3))]), this._initUpdateInterval = () => {
...
var c8 = class {
  ...
  getGeometry(t6, e3) {
    const o6 = this.getLngLatBounds(), [l5, h8, c9, u7] = o6, d8 = g2({ rings: [[[l5, h8], [l5, u7], [c9, u7], [c9, h8], [l5, h8]]] }, f2.WGS84, t6), f8 = K(new t3(), d8, false, false);
    if (null != e3) {
  ...
  getGeometryCentroid(t6, e3) {
    const i6 = this.getLngLatBounds(), [l5, h8, c9, u7] = i6, d8 = g2({ x: (l5 + c9) / 2, y: (h8 + u7) / 2 }, f2.WGS84, t6), f8 = L(new t3(), d8);
    if (null != e3) {
...
var A = class extends a3 {
  ...
  getAggregate(e3) {
    ...
    return n2(r6, (e4) => this._toFeatureJSON(e4));
  }
  getAggregates() {
  ...
  _setGeohash(e3, t6, s10) {
    ...
    if (this._spatialReference.isWebMercator) {
      ...
      const i6 = g2({ x: t6, y: s10 }, this._spatialReference, f2.WGS84);
      if (!i6)
        return false;
...
var V = class extends a3 {
  ...
  _setGeohash(e3, t6, s10) {
    ...
    if (this._spatialReference.isWebMercator) {
      ...
      const o6 = g2({ x: t6, y: s10 }, this._spatialReference, f2.WGS84);
      if (!o6)
        return false;
  ...
  _getClustersForTile(e3, s10, r6, o6, i6, a7 = true) {
    ...
    for (let I5 = b4; I5 <= R4; I5++)
      for (let r7 = v3; r7 <= M3; r7++) {
        ...
        if (null != d9) {
          const s11 = n2(i6, (e4) => n9 ? e4.left : u8 ? e4.right : e4.tile);
          if (a7 && null == s11)
            continue;
          if (!d9.count)
            continue;
  ...
  _getGeohashBounds(e3, t6) {
    ...
    const r6 = j4.fromExtent(M.fromBounds(t6, this._spatialReference)), o6 = g2(r6, this._spatialReference, f2.WGS84, { densificationStep: e3.resolution * L3 });
    if (!o6)
      return null;
...
var U = class extends d3 {
  ...
  initialize() {
    this._initStores(), this._initSource(), this._updateQueue = new u2({ concurrency: "stream" === this._source.type ? 1 : 4, process: (e3, t6) => this._onTileMessage(e3, { signal: t6 }) }), this.addHandles([this.tileStore.on("update", this.onTileUpdate.bind(this)), f(() => !this.updating, () => this.onIdle())]);
  }
  _initSource() {
  ...
  _initAttributeStore(e3) {
    this.attributeStore || (this.attributeStore = new B({ type: "remote", initialize: (e4, t6) => y2(this.remoteClient.invoke(w3, e4, { signal: t6 }).catch(A2)), update: (e4, t6) => y2(this.remoteClient.invoke(T3, e4, { signal: t6 }).catch(A2)), render: (e4) => y2(this.remoteClient.invoke(j6, void 0, { signal: e4 }).catch(A2)) }, e3));
  }
  _initStores() {
...
`, console.log(s10);
  ...
  _initAggregateStore(e3) {
    var _a, _b;
    const t6 = (_b = (_a = e3.schema.targets) == null ? void 0 : _a.aggregate) == null ? void 0 : _b.type, r6 = n2(this.config, (e4) => {
      var _a2, _b2;
  ...
  async queryVisibleFeatures(e3) {
    ...
    return t6.features = t6.features.filter((e4) => {
      ...
      return n2(i6, (e5) => this.attributeStore.isVisible(e5));
    }), t6;
  }
  ...
  async _onTileMessage(e3, t6) {
    if (s3(t6), has("esri-2d-update-debug")) {
      const t7 = n2(e3.addOrUpdate, (e4) => e4.hasFeatures);
...
e([y({ constructOnly: true })], U.prototype, "tileStore", void 0), e([y()], U.prototype, "config", void 0), e([y({ readOnly: true })], U.prototype, "fieldsIndex", null), e([y()], U.prototype, "processor", void 0), e([y({ constructOnly: true })], U.prototype, "remoteClient", void 0), e([y({ constructOnly: true })], U.prototype, "service", void 0), e([y()], U.prototype, "spatialReference", null), e([y()], U.prototype, "updating", null), U = e([a("esri.views.2d.layers.features.controllers.FeatureController2D")], U);
var R3 = U;
...
e([y()], d7.prototype, "controller", void 0), e([y()], d7.prototype, "processor", void 0), e([y()], d7.prototype, "updating", null), e([y()], d7.prototype, "viewState", void 0), d7 = e([a("esri.views.2d.layers.features.Pipeline")], d7);
var u6 = d7;
export {
  u6 as default
};
//# sourceMappingURL=Pipeline-S5QRHZRI.js.map
