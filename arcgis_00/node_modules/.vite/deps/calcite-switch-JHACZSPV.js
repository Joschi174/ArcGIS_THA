...
var Switch = proxyCustomElement(class extends H {
  ...
  // --------------------------------------------------------------------------
  render() {
    return h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h("div", {
...
@esri/calcite-components/dist/components/calcite-switch.js:
  (*!
   * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
   * See https://github.com/Esri/calcite-design-system/blob/main/LICENSE.md for details.
   * v1.9.2
   *)
*/
//# sourceMappingURL=calcite-switch-JHACZSPV.js.map
