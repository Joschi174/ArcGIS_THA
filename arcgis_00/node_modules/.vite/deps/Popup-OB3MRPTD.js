import {
  e as e5
} from "./chunk-A4WIJ3HW.js";
import "./chunk-HCN3CHSG.js";
import "./chunk-AEQRO7YN.js";
import "./chunk-LM7G4MIZ.js";
import {
  It
} from "./chunk-X5AWQCYO.js";
import "./chunk-PZBCO4WH.js";
import "./chunk-CMEKTGZ4.js";
import "./chunk-QFWYJYBZ.js";
import {
  D,
  I as I2,
  b as b3,
...
import {
  n as n5
} from "./chunk-DTPPIGQA.js";
import {
  e as e3
} from "./chunk-CMPWGJTS.js";
import {
  t as t5
} from "./chunk-3EWBE2NT.js";
import {
  W,
  e as e2,
  n2 as n4
} from "./chunk-DAEZVHIQ.js";
import {
  L,
  b,
  h as h2,
  n as n3,
  w
} from "./chunk-ZPE6EYJA.js";
import "./chunk-NUL4Z7H5.js";
import "./chunk-GMPW5PT4.js";
import "./chunk-HLZGEFIU.js";
import "./chunk-KQYZ7H7W.js";
import {
  t as t4
} from "./chunk-6DVUGIPD.js";
import {
  s as s5
...
var T = ["B", "kB", "MB", "GB", "TB"];
function v3(n14, e12) {
  let o8 = 0 === e12 ? 0 : Math.floor(Math.log(e12) / Math.log(E2.KILOBYTES));
  o8 = i3(o8, 0, T.length - 1);
  const u9 = c2(e12 / E2.KILOBYTES ** o8, { maximumFractionDigits: 2 });
  return r(n14.units.bytes[T[o8]], { fileSize: u9 });
}

// node_modules/@arcgis/core/widgets/Feature/support/featureUtils.js
var m4 = "esri.widgets.Feature.support.featureUtils";
var g3 = s.getLogger(m4);
var h5 = /href=(""|'')/gi;
var I3 = /(\{([^\{\r\n]+)\})/g;
var b5 = /\'/g;
...
function G({ attributes: e12, globalAttributes: t12, layer: r9, text: n14, expressionAttributes: i12, fieldInfoMap: o8 }) {
  return n14 ? k2({ formattedAttributes: t12, template: H(n14, { ...t12, ...i12, ...e12 }, r9), fieldInfoMap: o8 }) : "";
}
...
function P(e12, t12, r9 = false) {
  ...
  if ("string" == typeof n14) {
    const i12 = "%27", o8 = (r9 ? encodeURIComponent(n14) : n14).replaceAll(b5, i12);
    t12[e12] = o8;
  }
}
...
function _(e12, r9, n14) {
  const i12 = (r9 = S2(r9)) && "{" !== r9[0];
  return r(e12, Q(n14, i12 || false));
}
function z(e12, t12) {
  return e12.replaceAll(I3, (e13, r9, n14) => {
    const i12 = O2(t12, n14);
    return i12 ? `{${i12.name}}` : r9;
  });
}
...
function Y2(e12, t12) {
  var _a;
  const { fieldInfos: r9, fieldName: n14, preventPlacesFormatting: i12, layer: o8 } = t12, a14 = ee(r9, n14), f11 = a14 == null ? void 0 : a14.clone(), d10 = O2(o8, n14);
  if (f11 && !Se(n14)) {
    ...
    if ("date" === t13 || "date-only" === t13 || "time-only" === t13 || "timestamp-offset" === t13 || ((_a = f11.format) == null ? void 0 : _a.dateFormat)) {
      ...
      if (r10.dateFormat ?? (r10.dateFormat = "date-only" === t13 ? "short-date" : "short-date-short-time"), "number" == typeof e12) {
        const t14 = !Z(o8) && r4(o8) && o8.datesInUnknownTimezone || Z(o8) && B(o8.layer) && o8.layer.datesInUnknownTimezone;
  ...
  return "string" == typeof e12 && Se(n14) && y11 ? y11.formatRasterPixelValue(e12) : "string" == typeof (e12 = V2(e12, y11)) || null == e12 || null == y11 ? le(e12) : i12 ? c2(e12, { ...u(y11), minimumFractionDigits: 0, maximumFractionDigits: 20 }) : y11.formatNumber(e12);
}
function ee(e12, t12) {
...
function te({ fieldName: e12, graphic: t12, layer: r9 }) {
  ...
  if (!n14 || e12 !== n14)
    return null;
  const i12 = r9.getFeatureType(t12);
...
function re({ fieldName: e12, value: t12, graphic: r9, layer: n14 }) {
  ...
  if (!n14 || "function" != typeof n14.getFieldDomain)
    return null;
  const i12 = r9 && n14.getFieldDomain(e12, { feature: r9 });
  return i12 && "coded-value" === i12.type ? i12.getName(t12) : null;
}
function ne(e12, t12) {
  const { creatorField: n14, creationDateField: i12, editorField: o8, editDateField: a14 } = e12;
  if (!t12)
    return;
  const l12 = t12[a14];
  if ("number" == typeof l12) {
    const e13 = t12[o8];
    return { type: "edit", date: f(l12, x2), user: e13 };
  }
  const u9 = t12[i12];
  if ("number" == typeof u9) {
    const e13 = t12[n14];
    return { type: "create", date: f(u9, x2), user: e13 };
  }
  return null;
}
function ie(e12, t12) {
...
function se2({ fieldInfos: e12, attributes: t12, layer: r9, graphic: n14, fieldInfoMap: i12, relatedInfos: o8 }) {
  const a14 = {};
  return o8 == null ? void 0 : o8.forEach((t13) => ge({ attributes: a14, relatedInfo: t13, fieldInfoMap: i12, fieldInfos: e12, layer: r9 })), t12 && Object.keys(t12).forEach((o9) => {
    const l12 = t12[o9];
    a14[o9] = ue2({ fieldName: o9, fieldInfos: e12, fieldInfoMap: i12, layer: r9, value: l12, graphic: n14 });
  }), a14;
}
async function fe(e12, t12) {
  var _a, _b;
  const { layer: r9, graphic: n14, outFields: i12, objectIds: o8, returnGeometry: a14, spatialReference: l12 } = e12, u9 = o8[0];
  if ("number" != typeof u9 && "string" != typeof u9) {
    const e13 = "Could not query required fields for the specified feature. The feature's ID is invalid.", t13 = { layer: r9, graphic: n14, objectId: u9, requiredFields: i12 };
    return g3.warn(e13, t13), null;
  }
  if (!((_b = (_a = E(r9)) == null ? void 0 : _a.operations) == null ? void 0 : _b.supportsQuery)) {
    const e13 = "The specified layer cannot be queried. The following fields will not be available.", t13 = { layer: r9, graphic: n14, requiredFields: i12, returnGeometry: a14 };
    return g3.warn(e13, t13), null;
  }
  const s12 = r9.createQuery();
  s12.objectIds = o8, s12.outFields = (i12 == null ? void 0 : i12.length) ? i12 : [r9.objectIdField], s12.returnGeometry = !!a14, s12.returnZ = !!a14, s12.returnM = !!a14, s12.outSpatialReference = l12;
...
async function de({ graphic: e12, popupTemplate: t12, layer: r9, spatialReference: n14 }, i12) {
  if (!r9 || !t12)
    return;
  if ("function" == typeof r9.load && await r9.load(i12), !e12.attributes)
    return;
  const o8 = e12.attributes[r9.objectIdField];
  if (null == o8)
    return;
  const a14 = [o8], l12 = await t12.getRequiredFields(r9.fieldsIndex), u9 = Ee(l12, e12), s12 = u9 ? [] : l12, c21 = t12.returnGeometry || await ce(t12);
  if (u9 && !c21)
    return;
  const d10 = await fe({ layer: r9, graphic: e12, outFields: s12, objectIds: a14, returnGeometry: c21, spatialReference: n14 }, i12);
...
function me({ attributes: e12, graphic: t12, relatedInfo: r9, fieldInfos: n14, fieldInfoMap: i12, layer: o8 }) {
  e12 && t12 && r9 && Object.keys(t12.attributes).forEach((a14) => {
    ...
    e12[l12] = ue2({ fieldName: l12, fieldInfos: n14, fieldInfoMap: i12, layer: o8, value: u9, graphic: t12 });
  });
}
function ge({ attributes: e12, relatedInfo: t12, fieldInfoMap: r9, fieldInfos: n14, layer: i12 }) {
  e12 && t12 && (t12.relatedFeatures && t12.relatedFeatures && t12.relatedFeatures.forEach((o8) => me({ attributes: e12, graphic: o8, relatedInfo: t12, fieldInfoMap: r9, fieldInfos: n14, layer: i12 })), t12.relatedStatsFeatures && t12.relatedStatsFeatures && t12.relatedStatsFeatures.forEach((o8) => me({ attributes: e12, graphic: o8, relatedInfo: t12, fieldInfoMap: r9, fieldInfos: n14, layer: i12 })));
}
var he = (e12) => {
  if (!e12)
    return false;
...
var Ie = ({ layer: e12, method: t12, query: r9, definitionExpression: n14 }) => {
  ...
  if (!((_b = (_a = e12.capabilities) == null ? void 0 : _a.query) == null ? void 0 : _b.supportsCacheHint) || "attachments" === t12)
    return;
  const i12 = null != r9.where ? r9.where : null, o8 = null != r9.geometry ? r9.geometry : null;
  he(n14) || he(i12) || "extent" === (o8 == null ? void 0 : o8.type) || "tile" === r9.resultType || (r9.cacheHint = true);
};
...
var m5 = { editing: false, operations: { add: true, update: true, delete: true } };
var f3 = V.ofType(l3);
var u2 = class extends m2 {
  constructor(t12) {
    super(t12), this._getAttachmentsPromise = null, this._attachmentLayer = null, this.capabilities = { ...m5 }, this.activeAttachmentInfo = null, this.activeFileInfo = null, this.attachmentInfos = new f3(), this.fileInfos = new V(), this.graphic = null, this.mode = "view", this.filesEnabled = false, this.addHandles(l2(() => this.graphic, () => this._graphicChanged(), h));
  }
  destroy() {
  ...
  async getAttachments() {
    ...
    const a14 = this._getObjectId(), i12 = new c7({ objectIds: [a14], returnMetadata: true }), r9 = [], s12 = t12.queryAttachments(i12).then((t13) => t13[a14] || r9).catch(() => r9);
    this._getAttachmentsPromise = s12, this.notifyChange("state");
    const o8 = await s12;
    return e12.removeAll(), o8.length && e12.addMany(o8), this._getAttachmentsPromise = null, this.notifyChange("state"), o8;
  }
  async addAttachment(t12, e12 = this.graphic) {
    var _a;
    const { _attachmentLayer: a14, attachmentInfos: i12, capabilities: r9 } = this;
    if (!e12)
    ...
    const s12 = a14.addAttachment(e12, t12).then((t13) => this._queryAttachment(t13.objectId, e12)), o8 = await s12;
    return i12.add(o8), o8;
  }
  async deleteAttachment(t12) {
    var _a;
    const { _attachmentLayer: e12, attachmentInfos: a14, graphic: i12, capabilities: r9 } = this;
    if (!t12)
    ...
    const s12 = e12.deleteAttachments(i12, [t12.id]).then(() => t12), o8 = await s12;
    return a14.remove(o8), o8;
  }
  async updateAttachment(t12, e12 = this.activeAttachmentInfo) {
    var _a;
    const { _attachmentLayer: a14, attachmentInfos: i12, graphic: r9, capabilities: s12 } = this;
    if (!t12)
    ...
    const o8 = i12.findIndex((t13) => t13 === e12);
    ...
    return i12.splice(o8, 1, h13), h13;
  }
  async commitFiles() {
  ...
  updateFile(t12, e12, a14 = this.activeFileInfo) {
    if (!t12 || !e12 || !a14)
      return null;
    const i12 = this.fileInfos.findIndex((t13) => a14 === t13);
    return i12 > -1 && this.fileInfos.splice(i12, 1, { file: t12, form: e12 }), this.fileInfos.items[i12];
  }
  deleteFile(t12) {
  ...
  async _queryAttachment(t12, e12) {
    ...
    const i12 = this._getObjectId(e12), r9 = new c7({ objectIds: [i12], attachmentsWhere: `AttachmentId=${t12}`, returnMetadata: true });
    return a14.queryAttachments(r9).then((t13) => t13[i12][0]);
  }
...
var F4 = class extends W {
  ...
  loadDependencies() {
    return n4({ icon: () => import("./calcite-icon-6D35RP7Q.js") });
  }
  get capabilities() {
  ...
  render() {
    ...
    return n3("div", { class: this.classes(A2.base, A2.esriWidget) }, e12 ? this.renderProgressBar() : null, "loading" === s12 ? this.renderLoading() : this.renderAttachments(), this.renderErrorMessage());
  }
  renderErrorMessage() {
    const { error: e12, visibleElements: t12 } = this;
    return e12 && t12.errorMessage ? n3("div", { key: "error-message", class: A2.errorMessage }, e12.message) : null;
  }
  renderAttachments() {
  ...
  renderLoading() {
    return n3("div", { class: A2.loaderContainer, key: "loader" }, n3("div", { class: A2.loader }));
  }
  renderProgressBar() {
    return this.visibleElements.progressBar ? n3("div", { class: A2.progressBar, key: "progress-bar" }) : null;
  }
  renderAddForm() {
    const { submitting: e12, selectedFile: t12 } = this, s12 = e12 || !t12, i12 = this.visibleElements.cancelAddButton ? n3("button", { type: "button", bind: this, disabled: e12, onclick: this._cancelForm, class: this.classes(A2.esriButton, A2.esriButtonTertiary, A2.esriButtonSmall, A2.esriButtonHalf, e12 && A2.buttonDisabled) }, this.messages.cancel) : null, a14 = this.visibleElements.addSubmitButton ? n3("button", { type: "submit", disabled: s12, class: this.classes(A2.esriButton, A2.esriButtonSecondary, A2.esriButtonSmall, A2.esriButtonHalf, { [A2.buttonDisabled]: s12 }) }, this.messages.add) : null, n14 = t12 ? n3("span", { key: "file-name", class: A2.fileName }, t12.name) : null, r9 = n3("form", { bind: this, afterCreate: L, afterRemoved: w, "data-node-ref": "_addAttachmentForm", onsubmit: this._submitAddAttachment }, n3("fieldset", { class: A2.fileFieldset }, n14, n3("label", { class: this.classes(A2.fileLabel, A2.esriButton, A2.esriButtonSecondary) }, t12 ? this.messages.changeFile : this.messages.selectFile, n3("input", { class: A2.fileInput, type: "file", name: "attachment", bind: this, onchange: this._handleFileInputChange }))), a14, i12);
    return n3("div", { key: "add-form-container", class: A2.formNode }, r9);
  }
  renderDetailsForm(e12) {
    var _a, _b, _c;
    const { visibleElements: t12, viewModel: s12, selectedFile: i12, submitting: a14 } = this, { capabilities: r9 } = s12, l12 = a14 || !i12;
    let o8, d10, c21, m15;
    i12 ? (o8 = i12.type, d10 = i12.name, c21 = i12.size) : e12 && "file" in e12 ? (o8 = e12.file.type, d10 = e12.file.name, c21 = e12.file.size) : e12 && "contentType" in e12 && (o8 = e12.contentType, d10 = e12.name, c21 = e12.size, m15 = e12.url);
    const h13 = r9.editing && ((_a = r9.operations) == null ? void 0 : _a.delete) && t12.deleteButton ? n3("button", { key: "delete-button", type: "button", disabled: a14, bind: this, onclick: (t13) => this._submitDeleteAttachment(t13, e12), class: this.classes(A2.esriButton, A2.esriButtonSmall, A2.esriButtonTertiary, A2.deleteButton, { [A2.buttonDisabled]: a14 }) }, this.messages.delete) : void 0, u9 = r9.editing && ((_b = r9.operations) == null ? void 0 : _b.update) && t12.updateButton ? n3("button", { disabled: l12, key: "update-button", type: "submit", class: this.classes(A2.esriButton, A2.esriButtonSmall, A2.esriButtonThird, { [A2.buttonDisabled]: l12 }) }, this.messages.update) : void 0, b12 = this.visibleElements.cancelUpdateButton ? n3("button", { disabled: a14, key: "cancel-button", type: "button", bind: this, onclick: this._cancelForm, class: this.classes(A2.esriButton, A2.esriButtonSmall, A2.esriButtonTertiary, A2.esriButtonThird, { [A2.buttonDisabled]: a14 }) }, this.messages.cancel) : void 0, f11 = r9.editing && ((_c = r9.operations) == null ? void 0 : _c.update) ? n3("fieldset", { key: "file", class: A2.fileFieldset }, n3("span", { key: "file-name", class: A2.fileName }, d10), n3("label", { class: this.classes(A2.fileLabel, A2.esriButton, A2.esriButtonSecondary) }, this.messages.changeFile, n3("input", { class: A2.fileInput, type: "file", name: "attachment", bind: this, onchange: this._handleFileInputChange }))) : void 0, v8 = n3("fieldset", { key: "size", class: A2.metadataFieldset }, n3("label", null, v3(this.messagesUnits, c21 ?? 0))), y11 = n3("fieldset", { key: "content-type", class: A2.metadataFieldset }, n3("label", null, o8)), w9 = null != m15 ? n3("a", { class: A2.itemLink, href: m15, rel: "noreferrer", target: "_blank" }, this.renderImageMask(e12, 400), n3("div", { class: A2.itemLinkOverlay }, n3("span", { class: A2.itemLinkOverlayIcon }, n3("calcite-icon", { icon: "launch" })))) : this.renderImageMask(e12, 400), k4 = n3("form", { bind: this, afterCreate: L, afterRemoved: w, "data-node-ref": "_updateAttachmentForm", onsubmit: (t13) => this._submitUpdateAttachment(t13, e12) }, n3("div", { class: A2.metadata }, v8, y11), f11, n3("div", { class: A2.actions }, h13, b12, u9));
    return n3("div", { key: "edit-form-container", class: A2.formNode }, w9, k4);
  }
  ...
  renderGenericImageMask(e12, t12) {
    const { supportsResizeAttachments: s12 } = this.viewModel, i12 = p4(t12), a14 = { [A2.itemImageResizable]: s12 };
    return n3("div", { key: i12, class: this.classes(A2.itemMaskIcon, A2.itemMask) }, n3("img", { title: e12, alt: e12, src: i12, class: this.classes(a14, A2.itemImage) }));
  }
  renderImageMaskForAttachment(e12, t12) {
    const { supportsResizeAttachments: s12 } = this.viewModel;
    if (!e12)
      return null;
    const { contentType: i12, name: a14, url: n14 } = e12;
    if (!s12 || !e6(i12))
      return this.renderGenericImageMask(a14, i12);
    const r9 = this._getCSSTransform(e12), l12 = r9 ? { transform: r9, "image-orientation": "none" } : {}, o8 = `${n14}${(n14 == null ? void 0 : n14.includes("?")) ? "&" : "?"}w=${t12}`, d10 = { [A2.itemImageResizable]: s12 };
    return n3("div", { key: o8, class: this.classes(A2.itemMask) }, n3("img", { styles: l12, alt: a14, title: a14, src: o8, class: this.classes(d10, A2.itemImage) }));
  }
  renderFile(e12) {
    const { file: t12 } = e12;
    return n3("li", { class: A2.item, key: t12 }, n3("button", { key: "details-button", bind: this, class: A2.itemButton, title: this.messages.attachmentDetails, "aria-label": this.messages.attachmentDetails, onclick: () => this._startEditFile(e12), type: "button" }, this.renderImageMask(e12), n3("label", { class: A2.itemLabel }, n3("span", { class: A2.itemFilename }, t12.name || this.messages.noTitle), n3("span", { "aria-hidden": "true", class: this.classes(A2.itemChevronIcon, h2(this.container) ? A2.iconLeft : A2.iconRight) }))));
  }
  renderAttachmentInfo({ attachmentInfo: e12, displayType: t12 }) {
    const { viewModel: s12, effectiveDisplayType: i12 } = this, { capabilities: a14, supportsResizeAttachments: n14 } = s12, { contentType: r9, name: l12, url: o8 } = e12, d10 = this.renderImageMask(e12, "list" === t12 ? 48 : 400), c21 = a14.editing ? n3("span", { "aria-hidden": "true", class: this.classes(A2.itemChevronIcon, h2(this.container) ? A2.iconLeft : A2.iconRight) }) : null, m15 = [d10, "preview" === i12 && n14 && e6(r9) ? null : n3("label", { class: A2.itemLabel }, n3("span", { class: A2.itemFilename }, l12 || this.messages.noTitle), c21)], u9 = a14.editing ? n3("button", { key: "details-button", bind: this, class: A2.itemButton, title: this.messages.attachmentDetails, "aria-label": this.messages.attachmentDetails, "data-attachment-info-id": e12.id, onclick: () => this._startEditAttachment(e12), type: "button" }, m15) : n3("a", { key: "details-link", class: A2.itemButton, href: o8 ?? void 0, target: "_blank" }, m15);
    return n3("li", { class: A2.item, key: e12 }, u9);
  }
  renderAttachmentContainer() {
    var _a;
    const { effectiveDisplayType: e12, viewModel: t12, visibleElements: s12 } = this, { attachmentInfos: i12, capabilities: a14, fileInfos: n14 } = t12, r9 = !!(i12 == null ? void 0 : i12.length), l12 = !!(n14 == null ? void 0 : n14.length), o8 = { [A2.containerList]: "preview" !== e12, [A2.containerPreview]: "preview" === e12 }, d10 = a14.editing && ((_a = a14.operations) == null ? void 0 : _a.add) && s12.addButton ? n3("button", { bind: this, onclick: () => this._startAddAttachment(), class: this.classes(A2.esriButton, A2.esriButtonTertiary, A2.addAttachmentButton), type: "button" }, n3("span", { "aria-hidden": "true", class: this.classes(A2.itemAddIcon, A2.iconPlus) }), this.messages.add) : void 0, c21 = r9 ? n3("ul", { key: "attachments-list", class: A2.items }, i12.toArray().map((t13) => this.renderAttachmentInfo({ attachmentInfo: t13, displayType: e12 }))) : void 0, m15 = l12 ? n3("ul", { key: "file-list", class: A2.items }, n14.toArray().map((e13) => this.renderFile(e13))) : void 0, h13 = l12 || r9 ? void 0 : n3("div", { class: A2.empty }, this.messages.noAttachments);
    return n3("div", { key: "attachments-container", class: this.classes(A2.container, o8) }, c21, m15, h13, d10);
  }
  _modeChanged() {
...
e([y()], F4.prototype, "capabilities", null), e([y()], F4.prototype, "displayType", void 0), e([y({ readOnly: true })], F4.prototype, "effectiveDisplayType", null), e([y()], F4.prototype, "graphic", null), e([y()], F4.prototype, "label", null), e([y(), e2("esri/widgets/Attachments/t9n/Attachments")], F4.prototype, "messages", void 0), e([y(), e2("esri/core/t9n/Units")], F4.prototype, "messagesUnits", void 0), e([y({ readOnly: true })], F4.prototype, "selectedFile", void 0), e([y({ readOnly: true })], F4.prototype, "submitting", void 0), e([y({ readOnly: true })], F4.prototype, "error", void 0), e([y({ type: y3 })], F4.prototype, "viewModel", void 0), e([y()], F4.prototype, "visibleElements", void 0), e([s4("visibleElements")], F4.prototype, "castVisibleElements", null), F4 = e([a("esri.widgets.Attachments")], F4);
var B2 = F4;
...
e([y()], o.prototype, "description", void 0), e([y()], o.prototype, "title", void 0), o = e([a("esri.widgets.Feature.FeatureAttachments.FeatureAttachmentsViewModel")], o);
var c8 = o;
...
var c9 = class extends W {
  ...
  render() {
    return n3("div", { class: n6.base }, this.renderTitle(), this.renderDescription());
  }
  renderTitle() {
    const { title: e12 } = this;
    return e12 ? n3(n5, { level: this.headingLevel, class: n6.title }, e12) : null;
  }
  renderDescription() {
    const { description: e12 } = this;
    return e12 ? n3("div", { key: "description", class: n6.description }, e12) : null;
  }
};
...
var c10 = class extends W {
  ...
  render() {
    ...
    return n3("div", { class: d4.base }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), e12 == null ? void 0 : e12.render());
  }
  _setupFeatureElementInfo() {
    var _a;
    const { description: e12, title: t12, headingLevel: i12 } = this;
    (_a = this._featureElementInfo) == null ? void 0 : _a.set({ description: e12, title: t12, headingLevel: i12 });
  }
};
...
var p6 = class extends a4(m2) {
  ...
  async _createContent(t12) {
    ...
    const o8 = await e12;
    e12 === this._loadingPromise && (this._loadingPromise = null, this.notifyChange("state"), this._set("created", o8));
  }
};
...
var l6 = class extends W {
  ...
  renderLoading() {
    return n3("div", { class: c11.loaderContainer, key: "loader" }, n3("div", { class: c11.loader }));
  }
  renderCreated() {
    var _a;
    const e12 = (_a = this.viewModel) == null ? void 0 : _a.created;
    return e12 ? e12 instanceof HTMLElement ? n3("div", { key: e12, bind: e12, afterCreate: this._attachToNode }) : e4(e12) ? n3("div", { key: e12 }, !e12.destroyed && e12.render()) : n3("div", { key: e12, innerHTML: e12, afterCreate: this._addTargetToAnchors }) : null;
  }
  render() {
    var _a;
    const e12 = (_a = this.viewModel) == null ? void 0 : _a.state;
    return n3("div", { class: c11.base }, "loading" === e12 ? this.renderLoading() : this.renderCreated());
  }
  _attachToNode(e12) {
    const r9 = this;
    e12.appendChild(r9);
...
var l7 = class extends m2 {
  constructor(o8) {
    super(o8), this.attributes = null, this.expressionInfos = null, this.description = null, this.fieldInfos = null, this.title = null;
  }
  get formattedFieldInfos() {
    const { expressionInfos: o8, fieldInfos: e12 } = this, s12 = [];
    return e12 == null ? void 0 : e12.forEach((e13) => {
      if (!(!e13.hasOwnProperty("visible") || e13.visible))
        return;
      const t12 = e13.clone();
      t12.label = L2(t12, o8), s12.push(t12);
    }), s12;
  }
};
e([y()], l7.prototype, "attributes", void 0), e([y({ type: [i7] })], l7.prototype, "expressionInfos", void 0), e([y()], l7.prototype, "description", void 0), e([y({ type: [c3] })], l7.prototype, "fieldInfos", void 0), e([y({ readOnly: true })], l7.prototype, "formattedFieldInfos", null), e([y()], l7.prototype, "title", void 0), l7 = e([a("esri.widgets.Feature.FeatureFields.FeatureFieldsViewModel")], l7);
var n8 = l7;
...
function p8(s12, p16) {
  ...
  if (!r9)
    return p16;
  const t12 = p16.match(r9.pattern), n14 = t12 && t12[2], l12 = r(r(r9.label, { messages: s12, hierPart: n14 }), { appName: r9.appName }), i12 = r9.target ? ` target="${r9.target}"` : "", o8 = "_blank" === r9.target ? ' rel="noreferrer"' : "";
  return p16.replace(r9.pattern, `<a${i12} href="$1"${o8}>${l12}</a>`);
}
...
var m6 = class extends W {
  ...
  renderFieldInfo(e12, t12) {
    const { attributes: s12 } = this.viewModel, i12 = e12.fieldName, r9 = e12.label || i12, o8 = s12 ? null == s12[i12] ? "" : s12[i12] : "", l12 = !(!e12.format || !e12.format.dateFormat), n14 = "number" == typeof o8 && !l12 ? this._forceLTR(o8) : p8(this.messagesURIUtils, o8), a14 = { [u3.fieldDataDate]: l12 };
    return n3("tr", { key: `fields-element-info-row-${i12}-${t12}` }, n3("th", { key: `fields-element-info-row-header-${i12}-${t12}`, class: u3.fieldHeader, innerHTML: r9 }), n3("td", { key: `fields-element-info-row-data-${i12}-${t12}`, class: this.classes(u3.fieldData, a14), innerHTML: n14 }));
  }
  renderFields() {
    const { formattedFieldInfos: e12 } = this.viewModel;
    return (e12 == null ? void 0 : e12.length) ? n3("table", { class: u3.esriTable, summary: this.messages.fieldsSummary }, n3("tbody", null, e12.map((e13, t12) => this.renderFieldInfo(e13, t12)))) : null;
  }
  render() {
    var _a;
    return n3("div", { class: u3.base }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), this.renderFields());
  }
  _setupFeatureElementInfo() {
    var _a;
...
e([y()], m6.prototype, "attributes", null), e([y()], m6.prototype, "description", null), e([y()], m6.prototype, "expressionInfos", null), e([y()], m6.prototype, "fieldInfos", null), e([y()], m6.prototype, "title", null), e([y({ type: n8, nonNullable: true })], m6.prototype, "viewModel", void 0), e([y(), e2("esri/widgets/Feature/t9n/Feature")], m6.prototype, "messages", void 0), e([y(), e2("esri/widgets/support/t9n/uriUtils")], m6.prototype, "messagesURIUtils", void 0), m6 = e([a("esri.widgets.Feature.FeatureFields")], m6);
var c12 = m6;
...
var o2 = ">";
var r5 = M("short-date");
function n9(l12, i12, n14, s12) {
  let e12 = "";
  0 === i12 ? e12 = `${a8} ` : i12 === n14 && (e12 = `${o2} `);
  let u9 = null;
  return u9 = s12 ? f(l12, r5) : c13(l12), e12 + u9;
}

// node_modules/@arcgis/core/widgets/Legend/support/colorRampUtils.js
var o3 = new h3([64, 64, 64]);
function n10(l12, o8) {
  const n14 = [], r9 = l12.length - 1;
  return 5 === l12.length ? n14.push(0, 2, 4) : n14.push(0, r9), l12.map((l13, t12) => n14.includes(t12) ? n9(l13, t12, r9, o8) : null);
}
async function r6(l12, e12, o8) {
  let r9 = false, a14 = [], u9 = [];
  if (l12.stops) {
    const e13 = l12.stops;
    a14 = e13.map((l13) => l13.value), r9 = e13.some((l13) => !!l13.label), r9 && (u9 = e13.map((l13) => l13.label));
  }
  const s12 = a14[0], i12 = a14[a14.length - 1];
  if (null == s12 && null == i12)
    return null;
  const c21 = r9 ? null : n10(a14, o8 ?? false);
  return (await Promise.all(a14.map(async (o9, n14) => ({ value: o9, color: "opacity" === l12.type ? await t6(o9, l12, e12) : (await import("./visualVariableUtils-QMXKDPVU.js")).getColor(l12, o9), label: r9 ? u9[n14] : (c21 == null ? void 0 : c21[n14]) ?? "" })))).reverse();
}
async function t6(e12, n14, r9) {
  const t12 = new h3(r9 ?? o3), a14 = (await import("./visualVariableUtils-QMXKDPVU.js")).getOpacity(n14, e12);
...
function r7(r9) {
  if (!r9.colorStops)
    return [];
  const e12 = [...r9.colorStops].filter((o8) => {
    var _a;
    return ((_a = o8.color) == null ? void 0 : _a.a) > 0;
  });
  ...
  return e12.map((o8, e13) => {
    var _a, _b;
    let l12 = "";
    return 0 === e13 ? l12 = ((_a = r9.legendOptions) == null ? void 0 : _a.minLabel) || "low" : e13 === t12 && (l12 = ((_b = r9.legendOptions) == null ? void 0 : _b.maxLabel) || "high"), { color: o8.color, label: l12, ratio: o8.ratio };
  }).reverse();
}
...
async function b6(l12) {
  ...
  if ("heatmap" === l12.type) {
    ...
    if ("predominance" === ((_b = l12.authoringInfo) == null ? void 0 : _b.type))
      ...
      const e12 = (l12.uniqueValueInfos ?? []).map((e13) => b3(e13.symbol, null)), { field: i12, field2: o8, field3: a14, valueExpression: n14 } = l12;
      (i12 || n14) && await h7(t12, i12 || n14, e12), o8 && await h7(t12, o8, e12), a14 && await h7(t12, a14, e12);
    }
  else if ("class-breaks" === l12.type) {
    const e12 = l12.classBreakInfos.map((e13) => b3(e13.symbol, null)), { field: i12, valueExpression: o8 } = l12;
    await h7(t12, i12 ?? o8, e12);
  } else
    "simple" === l12.type && await h7(t12, "default", [b3(l12.symbol, null)]);
  return "defaultSymbol" in l12 && l12.defaultSymbol && await h7(t12, "default", [b3(l12.defaultSymbol, null)]), t12.forEach((l13, i12) => {
    const o8 = c(l13.filter(Boolean), (e12, l14) => JSON.stringify(e12) === JSON.stringify(l14));
    t12.set(i12, o8);
  }), t12;
}
...
function F5(e12, t12) {
  ...
  if (!e12)
    return;
  const { features: r9, statsFeatures: s12 } = e12, o8 = r9 && r9.value;
  t12.relatedFeatures = o8 ? o8.features : [];
  const i12 = s12 && s12.value;
  t12.relatedStatsFeatures = i12 ? i12.features : [];
}
function I4(e12, t12, r9, s12) {
  var _a;
  const o8 = new d3();
  return o8.outFields = ["*"], o8.relationshipId = "number" == typeof t12.id ? t12.id : parseInt(t12.id, 10), o8.objectIds = [e12.attributes[r9.objectIdField]], ((_a = r9.queryRelatedFeatures) == null ? void 0 : _a.call(r9, o8, s12)) ?? Promise.resolve({});
}
function S3(e12, t12, r9) {
  let s12 = 0;
  const o8 = [];
  for (; s12 < t12.length; )
    o8.push(`${e12} IN (${t12.slice(s12, r9 + s12)})`), s12 += r9;
  return o8.join(" OR ");
}
async function w4(e12, t12, r9, s12) {
  ...
  if ((y11 == null ? void 0 : y11.relationshipTableId) && y11.keyFieldInRelationshipTable) {
    ...
    if (!t13)
      return null;
    const i12 = t13.features.map((e13) => e13.attributes[u9.objectIdField]);
    if ((f11 == null ? void 0 : f11.length) && u9.supportsStatistics) {
      const e13 = new b2();
      e13.where = S3(u9.objectIdField, i12, 1e3), e13.outFields = c21, e13.outStatistics = f11, e13.sourceSpatialReference = m15;
...
var v6 = class extends m2 {
  ...
  _setContentElementMedia(t12) {
    const { formattedMediaInfoCount: e12 } = this, i12 = (t12 + e12) % e12;
    this.activeMediaInfoIndex = i12;
  }
  _pageContentElementMedia(t12) {
    const { activeMediaInfoIndex: e12 } = this, i12 = e12 + t12;
    this._setContentElementMedia(i12);
  }
  _formatMediaInfos() {
    const { mediaInfos: t12, layer: e12 } = this, o8 = this.attributes ?? {}, r9 = this.formattedAttributes ?? {}, a14 = this.expressionAttributes ?? {}, s12 = this.fieldInfoMap ?? /* @__PURE__ */ new Map();
    return (t12 == null ? void 0 : t12.map((t13) => {
      const i12 = t13 == null ? void 0 : t13.clone();
      if (!i12)
        return null;
      if (i12.title = G({ attributes: o8, fieldInfoMap: s12, globalAttributes: r9, expressionAttributes: a14, layer: e12, text: i12.title }), i12.caption = G({ attributes: o8, fieldInfoMap: s12, globalAttributes: r9, expressionAttributes: a14, layer: e12, text: i12.caption }), i12.altText = G({ attributes: o8, fieldInfoMap: s12, globalAttributes: r9, expressionAttributes: a14, layer: e12, text: i12.altText }), "image" === i12.type) {
        const { value: t14 } = i12;
        return this._setImageValue({ value: t14, formattedAttributes: r9, layer: e12 }), i12.value.sourceURL ? i12 : void 0;
      }
      if ("pie-chart" === i12.type || "line-chart" === i12.type || "column-chart" === i12.type || "bar-chart" === i12.type) {
        const { value: t14 } = i12;
        return this._setChartValue({ value: t14, chartType: i12.type, attributes: o8, formattedAttributes: r9, layer: e12, expressionAttributes: a14 }), i12;
      }
      return null;
    }).filter(R)) ?? [];
  }
  _setImageValue(t12) {
    const e12 = this.fieldInfoMap ?? /* @__PURE__ */ new Map(), { value: i12, formattedAttributes: o8, layer: r9 } = t12, { linkURL: a14, sourceURL: s12 } = i12;
    if (s12) {
      const t13 = z(s12, r9);
      i12.sourceURL = k2({ formattedAttributes: o8, template: t13, fieldInfoMap: e12 });
    }
    if (a14) {
      const t13 = z(a14, r9);
      i12.linkURL = k2({ formattedAttributes: o8, template: t13, fieldInfoMap: e12 });
    }
  }
  _setChartValue(t12) {
    const { value: e12, attributes: i12, formattedAttributes: o8, chartType: r9, layer: a14, expressionAttributes: s12 } = t12, { popupTemplate: l12, relatedInfos: n14 } = this, { fields: p16, normalizeField: d10 } = e12, c21 = a14;
    e12.fields = $(p16, c21), d10 && (e12.normalizeField = U2(d10, c21));
    if (!p16.some((t13) => !!(null != o8[t13] || pe(t13) && (n14 == null ? void 0 : n14.size))))
      return;
    const h13 = (l12 == null ? void 0 : l12.fieldInfos) ?? [];
    p16.forEach((t13) => {
      if (pe(t13))
        return void (e12.series = [...e12.series, ...this._getRelatedChartInfos({ fieldInfos: h13, fieldName: t13, formattedAttributes: o8, chartType: r9, value: e12 })]);
      const a15 = this._getChartOption({ value: e12, attributes: i12, chartType: r9, formattedAttributes: o8, expressionAttributes: s12, fieldName: t13, fieldInfos: h13 });
      e12.series.push(a15);
    });
  }
  _getRelatedChartInfos(t12) {
    var _a;
    const { fieldInfos: e12, fieldName: i12, formattedAttributes: o8, chartType: r9, value: a14 } = t12, s12 = [], l12 = m8(i12), n14 = l12 && ((_a = this.relatedInfos) == null ? void 0 : _a.get(l12.layerId.toString()));
    if (!n14)
      return s12;
    ...
    p16.forEach((t13) => {
      ...
      n15 && Object.keys(n15).forEach((t14) => {
        t14 === l12.fieldName && s12.push(this._getChartOption({ value: a14, attributes: n15, formattedAttributes: o8, fieldName: i12, chartType: r9, relatedFieldName: t14, hasMultipleRelatedFeatures: (p16 == null ? void 0 : p16.length) > 1, fieldInfos: e12 }));
      });
    });
    return "one-to-many" === u9 || "many-to-many" === u9 ? s12 : [s12[0]];
  }
  _getTooltip({ label: t12, value: e12, chartType: i12 }) {
    return "pie-chart" === i12 ? `${t12}` : `${t12}: ${e12}`;
  }
  _getChartOption(t12) {
    var _a;
    const { value: e12, attributes: i12, formattedAttributes: o8, expressionAttributes: r9, fieldName: a14, relatedFieldName: n14, fieldInfos: p16, chartType: d10, hasMultipleRelatedFeatures: u9 } = t12, I9 = this.layer, v8 = this.fieldInfoMap ?? /* @__PURE__ */ new Map(), { normalizeField: M5, tooltipField: A5 } = e12, g9 = M5 ? pe(M5) ? i12[m8(M5).fieldName] : i12[M5] : null, x5 = M2(a14) && r9 && void 0 !== r9[a14] ? r9[a14] : n14 && void 0 !== i12[n14] ? i12[n14] : void 0 !== i12[a14] ? i12[a14] : o8[a14], _4 = new i6({ fieldName: a14, value: void 0 === x5 ? null : x5 && g9 ? x5 / g9 : x5 });
    if (pe(a14)) {
      const t13 = v8.get(a14.toLowerCase()), e13 = A5 && v8.get(A5.toLowerCase()), r10 = (t13 == null ? void 0 : t13.fieldName) ?? a14, s12 = u9 && A5 ? m8(A5).fieldName : (e13 == null ? void 0 : e13.fieldName) ?? A5, l12 = u9 && s12 ? i12[s12] : o8[s12] ?? (t13 == null ? void 0 : t13.label) ?? (t13 == null ? void 0 : t13.fieldName) ?? n14, p17 = u9 && n14 ? i12[n14] : o8[r10];
      return _4.tooltip = this._getTooltip({ label: l12, value: p17, chartType: d10 }), _4;
    }
    const C6 = ee(p16, a14), T6 = U2(a14, I9), N4 = A5 && void 0 !== o8[A5] ? o8[A5] : L2(C6 || new c3({ fieldName: T6 }), (_a = this.popupTemplate) == null ? void 0 : _a.expressionInfos), F8 = o8[T6];
    return _4.tooltip = this._getTooltip({ label: N4, value: F8, chartType: d10 }), _4;
  }
};
e([y()], v6.prototype, "abilities", void 0), e([s4("abilities")], v6.prototype, "castAbilities", null), e([y()], v6.prototype, "activeMediaInfoIndex", void 0), e([y({ readOnly: true })], v6.prototype, "activeMediaInfo", null), e([y()], v6.prototype, "attributes", void 0), e([y()], v6.prototype, "description", void 0), e([y()], v6.prototype, "fieldInfoMap", void 0), e([y()], v6.prototype, "formattedAttributes", void 0), e([y()], v6.prototype, "expressionAttributes", void 0), e([y({ readOnly: true })], v6.prototype, "formattedMediaInfos", null), e([y()], v6.prototype, "isAggregate", void 0), e([y()], v6.prototype, "layer", void 0), e([y({ readOnly: true })], v6.prototype, "formattedMediaInfoCount", null), e([y()], v6.prototype, "mediaInfos", void 0), e([y()], v6.prototype, "popupTemplate", void 0), e([y()], v6.prototype, "relatedInfos", void 0), e([y()], v6.prototype, "title", void 0), v6 = e([a("esri.widgets.Feature.FeatureMedia.FeatureMediaViewModel")], v6);
var M3 = v6;
...
var R4 = class extends W {
  constructor(e12, t12) {
    super(e12, t12), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new M3(), this.messages = null, this._disposeChart = (e13) => {
      ...
      const { destroyed: t13, viewModel: i12 } = this;
      if (t13 || !i12 || !e13)
        return;
      const { createRoot: r9 } = await import("./chartUtilsAm5-JWVD3FOI.js"), a14 = await r9(e13);
      this._chartRootMap.set(e13, a14), this._renderChart({ mediaInfo: i12.activeMediaInfo, root: a14 });
    };
  }
  initialize() {
    this._featureElementInfo = new l4(), this.addHandles([l2(() => {
  ...
  render() {
    var _a;
    return n3("div", { bind: this, class: w5.base, onkeyup: this._handleMediaKeyup }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), this.renderMedia());
  }
  renderMedia() {
    const { formattedMediaInfoCount: e12, activeMediaInfoIndex: t12 } = this.viewModel, i12 = this.renderMediaText();
    return e12 ? n3("div", { key: "media-element-container", class: w5.mediaContainer }, this.renderMediaInfo(), n3("div", { class: w5.mediaNavigation }, i12, n3("div", { class: w5.mediaPagination }, this.renderMediaPageButton("previous"), n3("span", { class: w5.mediaPaginationText }, s3(this.messages.pageText, { index: t12 + 1, total: e12 })), this.renderMediaPageButton("next")))) : null;
  }
  renderMediaText() {
    const { activeMediaInfo: e12 } = this.viewModel;
    if (!e12)
      return null;
    const t12 = e12 && e12.title ? n3("div", { key: "media-title", class: w5.mediaItemTitle, innerHTML: e12.title }) : null, i12 = e12 && e12.caption ? n3("div", { key: "media-caption", class: w5.mediaItemCaption, innerHTML: e12.caption }) : null;
    return t12 || i12 ? n3("div", { key: "media-text", class: w5.mediaItemText }, t12, i12) : null;
  }
  renderImageMediaInfo(e12) {
    const { _refreshIntervalInfo: t12 } = this, { activeMediaInfoIndex: i12, formattedMediaInfoCount: r9 } = this.viewModel, { value: a14, refreshInterval: s12, altText: o8, title: n14, type: l12 } = e12, { sourceURL: d10, linkURL: m15 } = a14, p16 = A(m15 ?? void 0) ? "_blank" : "_self", h13 = "_blank" === p16 ? "noreferrer" : "", u9 = s12 ? t12 : null, f11 = u9 ? u9.timestamp : 0, _4 = u9 ? u9.sourceURL : d10, M5 = n3("img", { alt: o8 || n14, key: `media-${l12}-${i12}-${r9}-${f11}`, src: _4 ?? void 0 });
    return (m15 ? n3("a", { title: n14, href: m15, rel: h13, target: p16 }, M5) : null) ?? M5;
  }
  renderChartMediaInfo(e12) {
    const { activeMediaInfoIndex: t12, formattedMediaInfoCount: i12 } = this.viewModel;
    return n3("div", { key: `media-${e12.type}-${t12}-${i12}`, bind: this, class: w5.mediaChart, afterCreate: this._createChart, afterRemoved: this._disposeChart });
  }
  renderMediaInfoType() {
    const { activeMediaInfo: e12 } = this.viewModel;
  ...
  renderMediaInfo() {
    const { activeMediaInfo: e12 } = this.viewModel;
    return e12 ? n3("div", { key: "media-container", class: w5.mediaItemContainer }, n3("div", { key: "media-item-container", class: w5.mediaItem }, this.renderMediaInfoType())) : null;
  }
  renderMediaPageButton(e12) {
    if (this.viewModel.formattedMediaInfoCount < 2)
      return null;
    const t12 = "previous" === e12, i12 = t12 ? this.messages.previous : this.messages.next, r9 = t12 ? "chevron-left" : "chevron-right", a14 = t12 ? "media-previous" : "media-next", s12 = t12 ? this._previous : this._next;
    return n3("button", { type: "button", key: a14, title: i12, "aria-label": i12, tabIndex: 0, class: w5.mediaPaginationButton, bind: this, onclick: s12 }, n3("calcite-icon", { class: w5.mediaPaginationIcon, scale: "s", icon: r9 }));
  }
  _setupFeatureElementInfo() {
    var _a;
    const { description: e12, title: t12 } = this;
  ...
  async _getRendererColors() {
    const { colorAm5: e12 } = await import("./chartCommon-SVPN3RUH.js"), t12 = /* @__PURE__ */ new Map(), i12 = this._getRenderer(), r9 = "default";
    if (!i12)
      return t12;
    const a14 = await b6(i12);
    a14.delete(r9);
    return Array.from(a14.values()).every((e13) => 1 === (e13 == null ? void 0 : e13.length)) ? (Array.from(a14.keys()).forEach((i13) => {
      var _a, _b;
      const r10 = (_b = (_a = a14.get(i13)) == null ? void 0 : _a[0]) == null ? void 0 : _b.toCss(true);
      r10 && t12.set(i13, e12(r10));
    }), t12) : t12;
  }
  ...
  async _renderChart(e12) {
    const { root: t12, mediaInfo: i12 } = e12, { value: r9, type: a14 } = i12, { ResponsiveThemeAm5: s12, DarkThemeAm5: o8, AnimatedThemeAm5: n14, ColorSetAm5: l12, ThemeAm5: d10 } = await import("./chartCommon-SVPN3RUH.js"), m15 = d10.new(t12);
    m15.rule("ColorSet").set("colors", It);
    const c21 = [s12.new(t12), m15];
    r3() && c21.push(o8.new(t12)), this._canAnimateChart() && c21.push(n14.new(t12)), t12.setThemes(c21);
    const h13 = await this._getRendererColors(), u9 = l12.new(t12, {}), f11 = r9.series.map((e13, t13) => {
      const i13 = h13.get(e13.fieldName) || u9.getIndex(t13);
      return { [A3]: e13.tooltip, [y6]: e13.value, columnSettings: { fill: i13, stroke: i13 } };
  ...
  async _customizeChartTooltip(e12, t12 = "horizontal") {
    var _a;
    const { colorAm5: i12 } = await import("./chartCommon-SVPN3RUH.js");
    e12.setAll({ pointerOrientation: t12 }), (_a = e12.get("background")) == null ? void 0 : _a.setAll({ stroke: i12(x3) }), e12.label.setAll({ direction: this._getDirection(), oversizedBehavior: "wrap", maxWidth: b8 });
  }
  async _createPieChart(e12, t12) {
    const { TooltipAm5: i12 } = await import("./chartCommon-SVPN3RUH.js"), { PieChartAm5: r9, PieSeriesAm5: a14 } = await import("./pieChart-YM2AYH6A.js"), { mediaInfo: s12, root: o8 } = e12, { title: n14 } = s12, l12 = 5, d10 = (s12 == null ? void 0 : s12.altText) || (s12 == null ? void 0 : s12.title) || "", m15 = o8.container.children.push(r9.new(o8, { ariaLabel: d10, focusable: true, paddingBottom: l12, paddingTop: l12, paddingLeft: l12, paddingRight: l12 })), c21 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", p16 = i12.new(o8, { labelText: c21 }), h13 = m15.series.push(a14.new(o8, { name: n14, valueField: y6, categoryField: A3, tooltip: p16 }));
  ...
  async _createColumnChart(e12, t12, i12) {
    const { TooltipAm5: r9, ScrollbarAm5: a14 } = await import("./chartCommon-SVPN3RUH.js"), { CategoryAxisAm5: s12, AxisRendererXAm5: o8, ValueAxisAm5: n14, AxisRendererYAm5: l12, ColumnSeriesAm5: d10 } = await import("./xyChart-Q47UPNBR.js"), { mediaInfo: m15, root: c21 } = t12, { value: p16, title: h13 } = m15;
    e12.setAll({ wheelX: "panX", wheelY: "zoomX" });
    const u9 = e12.xAxes.push(s12.new(c21, { renderer: o8.new(c21, { inversed: this._isInversed() }), categoryField: A3 }));
  ...
  async _createBarChart(e12, t12, i12) {
    ...
    u9.get("renderer").labels.template.setAll({ forceHidden: true });
    const f11 = e12.xAxes.push(n14.new(c21, { renderer: o8.new(c21, { inside: false, inversed: this._isInversed() }), min: this._getMinSeriesValue(p16.series) }));
    f11.get("renderer").labels.template.setAll({ direction: this._getDirection() });
    ...
    this._customizeChartTooltip(_4, "vertical"), M5.columns.template.setAll({ ariaLabel: v8, focusable: true, templateField: "columnSettings" }), p16.series.length > I6 && e12.set("scrollbarY", a14.new(c21, { orientation: "vertical" })), u9.data.setAll(i12), M5.data.setAll(i12), M5.appear(this._getChartSeriesAnimationMS()), e12.appear(this._getChartAnimationMS());
  }
  async _createLineChart(e12, t12, i12) {
    const { TooltipAm5: r9, ScrollbarAm5: a14 } = await import("./chartCommon-SVPN3RUH.js"), { CategoryAxisAm5: s12, AxisRendererXAm5: o8, ValueAxisAm5: n14, AxisRendererYAm5: l12, LineSeriesAm5: d10 } = await import("./xyChart-Q47UPNBR.js"), { root: m15, mediaInfo: c21 } = t12, { value: p16, title: h13 } = c21;
    e12.setAll({ wheelX: "panX", wheelY: "zoomX" });
    const u9 = e12.xAxes.push(s12.new(m15, { renderer: o8.new(m15, { inversed: this._isInversed() }), categoryField: A3 }));
    u9.get("renderer").labels.template.setAll({ forceHidden: true });
    ...
    this._customizeChartTooltip(_4, "vertical"), p16.series.length > I6 && e12.set("scrollbarX", a14.new(m15, { orientation: "horizontal" })), u9.data.setAll(i12), M5.data.setAll(i12), M5.appear(this._getChartSeriesAnimationMS()), e12.appear(this._getChartAnimationMS());
  }
  async _createXYChart(e12, t12) {
    const { XYChartAm5: i12, XYCursorAm5: r9 } = await import("./xyChart-Q47UPNBR.js"), { root: a14, mediaInfo: s12 } = e12, { type: o8 } = s12, n14 = (s12 == null ? void 0 : s12.altText) || (s12 == null ? void 0 : s12.title) || "", l12 = a14.container.children.push(i12.new(a14, { ariaLabel: n14, focusable: true, panX: true, panY: true }));
    l12.set("cursor", r9.new(a14, {})), "column-chart" === o8 && await this._createColumnChart(l12, e12, t12), "bar-chart" === o8 && await this._createBarChart(l12, e12, t12), "line-chart" === o8 && await this._createLineChart(l12, e12, t12), l12.root.dom.classList.toggle(w5.mediaChartRendered, true);
  }
  ...
  _setRefreshTimeout(e12) {
    const { refreshInterval: t12, value: i12 } = e12;
    if (!t12)
      return;
    const r9 = 6e4 * t12;
  ...
  _getImageSource(e12, t12) {
    const i12 = e12.includes("?") ? "&" : "?", [r9, a14 = ""] = e12.split("#");
    return `${r9}${i12}timestamp=${t12}${a14 ? "#" : ""}${a14}`;
  }
};
...
function u5({ aggregatedFeatures: e12, arcadeUtils: r9, featureSetVars: a14, context: i12, viewInfo: n14, map: s12, graphic: o8, interceptor: c21 }) {
  a14.forEach((a15) => {
    const p16 = a15.toLowerCase(), l12 = n14.sr, u9 = { map: s12, spatialReference: l12, interceptor: c21 };
    if ("$map" === p16 && (i12.vars[p16] = r9.convertMapToFeatureSetCollection(u9)), "$layer" === p16 && (i12.vars[p16] = r9.convertFeatureLayerToFeatureSet({ layer: o8.sourceLayer, spatialReference: l12, interceptor: c21 })), "$datastore" === p16 && (i12.vars[p16] = r9.convertServiceUrlToWorkspace({ url: o8.sourceLayer.url, spatialReference: l12, interceptor: c21 })), "$aggregatedfeatures" === p16) {
      const a16 = o8.layer, { fields: n15, objectIdField: s13, geometryType: l13, spatialReference: u10, displayField: f11 } = a16, g9 = new Be({ fields: n15, objectIdField: s13, geometryType: l13, spatialReference: u10, displayField: f11, ..."feature" === a16.type ? { templates: a16.templates, typeIdField: a16.typeIdField, types: a16.types } : null, source: e12 });
      i12.vars[p16] = r9.convertFeatureLayerToFeatureSet({ layer: g9, spatialReference: u10, interceptor: c21 });
    }
  });
}
function f6() {
  return import("./arcadeUtils-LEAED7RJ.js");
}
function g7(e12) {
...
async function y7({ graphic: e12, view: r9 }) {
  ...
  if (!t12 || !a14 || "2d" !== (r9 == null ? void 0 : r9.type))
    return [];
  const i12 = await r9.whenLayerView(a14);
  if (!g7(i12))
    return [];
  const n14 = i12.createQuery(), s12 = e12.getObjectId();
  n14.aggregateIds = null != s12 ? [s12] : [];
  const { features: o8 } = await i12.queryFeatures(n14);
  return o8;
}
async function d6({ expressionInfo: e12, arcadeUtils: r9, interceptor: t12, spatialReference: a14, map: i12, graphic: s12, view: c21 }) {
  ...
  d10.interceptor = t12, d10.useAsync = true, u5({ aggregatedFeatures: f11, arcadeUtils: r9, featureSetVars: l12, context: d10, viewInfo: g9, map: i12, graphic: s12, interceptor: t12 });
  const m15 = r9.createFunction(p16, d10);
  return r9.executeAsyncFunction(m15, d10).catch((r10) => o4.error("arcade-execution-error", { error: r10, graphic: s12, expressionInfo: e12 }));
}
async function m9({ expressionInfos: e12, spatialReference: t12, graphic: a14, interceptor: i12, map: n14, view: s12 }) {
  if (!e12 || !e12.length)
    return {};
  const o8 = await f6(), p16 = {};
  for (const r9 of e12)
    p16[`expression/${r9.name}`] = d6({ expressionInfo: r9, arcadeUtils: o8, interceptor: i12, spatialReference: t12, map: n14, graphic: a14, view: s12 });
...
var j8 = class extends a4(m2) {
  constructor(t12) {
    super(t12), this._abortController = null, this.expressionInfo = null, this.graphic = null, this.contentElement = null, this.contentElementViewModel = null, this.interceptor = null, this.view = null, this._cancelQuery = () => {
      ...
      const { expressionInfo: t13, graphic: e12, interceptor: o8, spatialReference: r9, map: n14, view: s12, _abortController: i12 } = this;
      if (!(t13 && e12 && r9 && n14))
        return void this._set("contentElement", null);
      const l12 = await f6();
      if (i12 !== this._abortController)
        return;
      const p16 = await d6({ arcadeUtils: l12, expressionInfo: t13, graphic: e12, interceptor: o8, map: n14, spatialReference: r9, view: s12 });
      if (!p16 || "esri.arcade.Dictionary" !== p16.declaredClass)
        return void this._set("contentElement", null);
      const h13 = await p16.castAsJsonAsync(i12 == null ? void 0 : i12.signal), d10 = h13 == null ? void 0 : h13.type, u9 = "media" === d10 ? I.fromJSON(h13) : "text" === d10 ? c5.fromJSON(h13) : "fields" === d10 ? c4.fromJSON(h13) : null;
  ...
  get state() {
    const { _abortController: t12, contentElement: e12, contentElementViewModel: o8 } = this;
    return t12 ? "loading" : e12 || o8 ? "ready" : "disabled";
  }
  get map() {
    var _a;
...
e([y()], j8.prototype, "_abortController", void 0), e([y({ type: i5 })], j8.prototype, "expressionInfo", void 0), e([y({ type: h4 })], j8.prototype, "graphic", void 0), e([y({ readOnly: true })], j8.prototype, "contentElement", void 0), e([y({ readOnly: true })], j8.prototype, "contentElementViewModel", void 0), e([y()], j8.prototype, "interceptor", void 0), e([y()], j8.prototype, "spatialReference", null), e([y({ readOnly: true })], j8.prototype, "state", null), e([y()], j8.prototype, "map", null), e([y()], j8.prototype, "view", void 0), j8 = e([a("esri.widgets.Feature.FeatureExpression.FeatureExpressionViewModel")], j8);
var C3 = j8;
...
var u6 = class extends W {
  ...
  renderLoading() {
    return n3("div", { key: "loading-container", class: c16.loadingSpinnerContainer }, n3("span", { class: this.classes(c16.iconLoading, c16.spinner) }));
  }
  render() {
    var _a;
    const { state: e12 } = this.viewModel;
    return n3("div", { class: c16.base }, "loading" === e12 ? this.renderLoading() : "disabled" === e12 ? null : (_a = this._contentWidget) == null ? void 0 : _a.render());
  }
  ...
  _setupExpressionWidget() {
    ...
    this._destroyContentWidget();
    const o8 = e12 ? "fields" === s12 ? new c12({ viewModel: e12 }) : "media" === s12 ? new j7({ viewModel: e12 }) : "text" === s12 ? new p7({ viewModel: e12 }) : null : null;
    this._contentWidget = o8, this.scheduleRender();
  }
};
...
function L3(n14, r9, i12) {
  const o8 = Object.keys(r9).filter((e12) => i(n14, e12)), a14 = o8.map((e12) => r9[e12]), s12 = o8.map((e12) => i12.get(e12)).filter(R);
...
var B3 = (e12) => {
  ...
  const n14 = [];
  if (e12.formTemplate) {
    const { description: r9, title: i12 } = e12.formTemplate;
    (_a = e12.fields) == null ? void 0 : _a.forEach((e13) => {
      const o8 = i12 && i(i12, e13.name), a14 = r9 && i(r9, e13.name);
      (o8 || a14) && n14.push(e13.name);
    });
  }
  return n14;
};
...
var f7 = 100;
var m11 = class extends i4(s5(a4(m2))) {
  constructor(e12) {
  ...
  set featurePage(e12) {
    const { featuresPerPage: t12, featureCount: r9 } = this, o8 = 1, l12 = Math.ceil(r9 / t12) || 1;
    this._set("featurePage", Math.min(Math.max(e12, o8), l12));
  }
  get featurePage() {
  ...
  get relatedFeatureInfos() {
    ...
    if (!t12.length || !r9)
      return [];
    const o8 = r9 && "formTemplate" in r9 && r9.formTemplate, l12 = o8 && (o8 == null ? void 0 : o8.title) || void 0;
    return t12.map((t13) => {
      let o9;
      if (e12) {
        ...
        if (a14) {
          ...
          null != t14 && (o9 = t14.toString());
        }
      }
      return { feature: t13, description: o9, title: l12 ? L3(l12, t13.attributes, r9.fieldsIndex) : void 0 };
    }).toArray();
  }
  get relatedLayer() {
  ...
  get state() {
    const { _queryAbortController: e12, _queryFeatureCountAbortController: t12, _queryPageAbortController: r9, canQuery: o8, _loaded: l12, canLoad: a14 } = this;
    return t12 || a14 && !l12 ? "loading" : e12 || r9 ? "querying" : o8 ? "ready" : "disabled";
  }
  ...
  async _queryFeatureCount() {
    const { layer: e12, relatedLayer: t12, relationshipId: r9, objectId: o8, _queryFeatureCountAbortController: l12, canQuery: a14, supportsCacheHint: s12 } = this;
    if (await (e12 == null ? void 0 : e12.load()), await (t12 == null ? void 0 : t12.load()), !a14 || !e12 || !t12)
      return void this._set("featureCount", 0);
    const i12 = t12.createQuery(), n14 = new d3({ cacheHint: s12, relationshipId: r9, returnGeometry: false, objectIds: [o8], where: i12.where ?? void 0 }), u9 = await e12.queryRelatedFeaturesCount(n14, { signal: l12 == null ? void 0 : l12.signal });
    this._set("featureCount", u9[o8] || 0);
  }
  _sliceFeatures(e12) {
  ...
  async _queryPage() {
    const { relatedFeatures: e12, featurePage: t12, showAllEnabled: r9, _queryPageAbortController: o8, featureCount: l12 } = this;
    !r9 || t12 < 2 || !l12 || e12.addMany(await this._queryRelatedFeatures({ signal: o8 == null ? void 0 : o8.signal }));
  }
  async _queryRelatedFeatures(e12) {
    var _a;
    const { orderByFieldsFixedCasing: t12, showAllEnabled: r9, featuresPerPage: l12, displayCount: a14, layer: s12, relationshipId: i12, featurePage: n14, featureCount: u9, relatedLayer: d10, supportsCacheHint: y11 } = this, { canQuery: h13, objectId: p16 } = this;
    if (!h13 || !s12 || !d10)
      return [];
    const C6 = r9 ? ((n14 - 1) * l12 + u9) % u9 : 0, b12 = r9 ? l12 : a14, g9 = d10.objectIdField, _4 = [...t12.map((e13) => e13.field), ...B3(d10), g9].filter(R), f11 = t12.map((e13) => `${e13.field} ${e13.order}`), m15 = d10.createQuery(), q4 = new d3({ orderByFields: f11, start: C6, num: b12, outFields: _4, cacheHint: y11, relationshipId: i12, returnGeometry: false, objectIds: [p16], where: m15.where ?? void 0 }), A5 = await s12.queryRelatedFeatures(q4, { signal: e12 == null ? void 0 : e12.signal }), w9 = ((_a = A5[p16]) == null ? void 0 : _a.features) || [];
    return w9.forEach((e13) => {
      e13.sourceLayer = d10, e13.layer = d10;
    }), w9;
  }
};
e([y()], m11.prototype, "_loaded", void 0), e([y()], m11.prototype, "_queryAbortController", void 0), e([y()], m11.prototype, "_queryPageAbortController", void 0), e([y()], m11.prototype, "_queryFeatureCountAbortController", void 0), e([y({ value: 1 })], m11.prototype, "featurePage", null), e([y()], m11.prototype, "featuresPerPage", void 0), e([y({ readOnly: true })], m11.prototype, "orderByFieldsFixedCasing", null), e([y({ readOnly: true })], m11.prototype, "supportsCacheHint", null), e([y({ readOnly: true })], m11.prototype, "canLoad", null), e([y({ readOnly: true })], m11.prototype, "canQuery", null), e([y()], m11.prototype, "description", void 0), e([y({ readOnly: true })], m11.prototype, "itemDescriptionFieldName", null), e([y({ value: 3 })], m11.prototype, "displayCount", null), e([y({ type: h4 })], m11.prototype, "graphic", void 0), e([y()], m11.prototype, "layer", void 0), e([y()], m11.prototype, "map", void 0), e([y({ readOnly: true })], m11.prototype, "objectId", null), e([y({ readOnly: true })], m11.prototype, "objectIdField", null), e([y()], m11.prototype, "orderByFields", void 0), e([y({ readOnly: true })], m11.prototype, "relatedFeatures", null), e([y({ readOnly: true })], m11.prototype, "relatedFeatureInfos", null), e([y({ readOnly: true })], m11.prototype, "relatedLayer", null), e([y({ readOnly: true })], m11.prototype, "relationship", null), e([y()], m11.prototype, "featureCount", void 0), e([y({ readOnly: true })], m11.prototype, "relatedFeatureViewModels", null), e([y()], m11.prototype, "relationshipId", void 0), e([y()], m11.prototype, "showAllEnabled", void 0), e([y()], m11.prototype, "state", null), e([y()], m11.prototype, "title", void 0), e([y()], m11.prototype, "getRelatedFeatureByObjectId", null), m11 = e([a("esri.widgets.Feature.FeatureRelationship.FeatureRelationshipViewModel")], m11);
var q3 = m11;
...
var F7 = class extends W {
  constructor(e12, t12) {
    super(e12, t12), this._featureElementInfo = null, this._relatedFeatureIntersectionObserverNode = null, this._relatedFeatureIntersectionObserver = new IntersectionObserver(([e13]) => {
      ...
      const { state: e13, showAllEnabled: t13, relatedFeatures: s12, featuresPerPage: i12, featurePage: r9 } = this.viewModel;
      "ready" === e13 && t13 && s12.length >= i12 * r9 && this.viewModel.featurePage++;
    };
  }
  initialize() {
  ...
  loadDependencies() {
    return n4({ icon: () => import("./calcite-icon-6D35RP7Q.js"), list: () => import("./calcite-list-CU5JEWDU.js"), "list-item": () => import("./calcite-list-item-M7UT6Z4A.js"), notice: () => import("./calcite-notice-J4AIF4DN.js") });
  }
  destroy() {
    this._unobserveRelatedFeatureObserver(), this._featureElementInfo = l(this._featureElementInfo);
  }
  get displayShowAllButton() {
    const { showAllEnabled: e12, featureCount: t12, displayCount: s12, state: i12 } = this.viewModel;
    return !e12 && !!t12 && "ready" === i12 && (t12 > s12 || 0 === s12);
  }
  ...
  renderStickyLoading() {
    return "querying" === this.viewModel.state ? n3("div", { key: "sticky-loader", class: f8.stickySpinnerContainer }, this.renderLoadingIcon()) : null;
  }
  renderLoadingIcon() {
    return n3("span", { class: this.classes(f8.iconLoading, f8.spinner) });
  }
  renderLoading() {
    return n3("div", { key: "loading-container", class: f8.loadingSpinnerContainer }, this.renderLoadingIcon());
  }
  renderShowAllIconNode() {
    return n3("calcite-icon", { scale: "s", icon: "list", slot: "content-end" });
  }
  renderChevronIconNode() {
    const e12 = h2(this.container) ? "chevron-left" : "chevron-right";
    return n3("calcite-icon", { scale: "s", icon: e12, slot: "content-end" });
  }
  renderRelatedFeature(e12) {
    ...
    const i12 = "loading" === e12.state;
    return n3("calcite-list-item", { class: this.classes(f8.listItem, { [f8.listItemHidden]: i12 }), key: e12.uid, label: s12, description: e12.description ?? "", onCalciteListItemSelect: () => this.emit("select-record", { featureViewModel: e12 }) }, this.renderChevronIconNode());
  }
  renderShowAllListItem() {
    var _a;
    return this.displayShowAllButton ? n3("calcite-list-item", { key: "show-all-item", label: (_a = this.messages) == null ? void 0 : _a.showAll, description: this.featureCountDescription, onCalciteListItemSelect: () => this.emit("show-all-records") }, this.renderShowAllIconNode()) : null;
  }
  renderNoRelatedFeaturesMessage() {
    var _a;
    return n3("calcite-notice", { key: "no-related-features-message", icon: "information", open: true, kind: "brand", scale: "s", width: "full" }, n3("div", { slot: "message" }, (_a = this.messages) == null ? void 0 : _a.noRelatedFeatures));
  }
  renderFeatureObserver() {
    return n3("div", { key: "feature-observer", class: f8.featureObserver, bind: this, afterCreate: this._relatedFeatureIntersectionObserverCreated });
  }
  renderList() {
    const { relatedFeatureViewModels: e12 } = this.viewModel;
    return n3("calcite-list", null, e12.toArray().map((e13) => this.renderRelatedFeature(e13)), this.renderShowAllListItem());
  }
  renderRelatedFeatures() {
    const { displayListItems: e12 } = this, { state: t12 } = this.viewModel;
    return n3("div", { key: "list-container", class: this.classes(f8.listContainer, { [f8.listContainerQuerying]: "querying" === t12 }) }, e12 ? this.renderList() : "ready" === t12 ? this.renderNoRelatedFeaturesMessage() : null, this.renderStickyLoading(), this.renderFeatureObserver());
  }
  renderRelationshipNotFound() {
    var _a;
    return n3("calcite-notice", { key: "relationship-not-found", icon: "exclamation-mark-triangle", open: true, kind: "danger", scale: "s", width: "full" }, n3("div", { slot: "message" }, (_a = this.messages) == null ? void 0 : _a.relationshipNotFound));
  }
  render() {
    var _a;
    const { state: e12 } = this.viewModel;
    return n3("div", { class: this.classes(f8.base, f8.esriWidget) }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), "loading" === e12 ? this.renderLoading() : "disabled" === e12 ? this.renderRelationshipNotFound() : this.renderRelatedFeatures());
  }
  ...
  _setupFeatureElementInfo() {
    var _a;
    const { headingLevel: e12, visibleElements: t12 } = this, s12 = t12.description && this.description, i12 = t12.title && this.title;
    (_a = this._featureElementInfo) == null ? void 0 : _a.set({ description: s12, title: i12, headingLevel: e12 });
  }
...
e([y()], F7.prototype, "_relatedFeatureIntersectionObserverNode", void 0), e([y({ readOnly: true })], F7.prototype, "displayShowAllButton", null), e([y({ readOnly: true })], F7.prototype, "displayListItems", null), e([y()], F7.prototype, "description", null), e([y({ readOnly: true })], F7.prototype, "featureCountDescription", null), e([y()], F7.prototype, "headingLevel", void 0), e([y()], F7.prototype, "title", null), e([y({ type: q3 })], F7.prototype, "viewModel", void 0), e([y(), e2("esri/widgets/Feature/t9n/Feature")], F7.prototype, "messages", void 0), e([y(), e2("esri/t9n/common")], F7.prototype, "messagesCommon", void 0), e([y()], F7.prototype, "visibleElements", void 0), e([s4("visibleElements")], F7.prototype, "castVisibleElements", null), F7 = e([a("esri.widgets.Feature.FeatureRelationship")], F7);
var _2 = F7;
...
var X = H2 = class extends s5(m2) {
  ...
  setActiveMedia(e12, t12) {
    const i12 = this.contentViewModels[e12];
    i12 instanceof M3 && i12.setActiveMedia(t12);
  }
  nextMedia(e12) {
  ...
  async updateGeometry() {
    var _a;
    const { graphic: e12, spatialReference: t12, _sourceLayer: i12 } = this;
    await (i12 == null ? void 0 : i12.load());
    const r9 = i12 == null ? void 0 : i12.objectIdField;
    if (!r9 || !e12 || !i12)
      return;
    ...
    const o8 = [s12];
    if (!e12.geometry) {
      const r10 = await fe({ layer: i12, graphic: e12, outFields: [], objectIds: o8, returnGeometry: true, spatialReference: t12 }), s13 = r10 == null ? void 0 : r10.geometry;
  ...
  async _graphicChanged() {
    ...
    try {
      ...
      d(i12) || (this._error = i12, s.getLogger(this).error("error", "The popupTemplate could not be displayed for this feature.", { error: i12, graphic: e12, popupTemplate: this._effectivePopupTemplate }));
    }
  ...
  _matchesFeature(e12, t12) {
    var _a;
    const i12 = (_a = e12 == null ? void 0 : e12.graphic) == null ? void 0 : _a.getObjectId(), r9 = t12 == null ? void 0 : t12.getObjectId();
    return null != i12 && null != r9 && i12 === r9;
  }
  _setRelatedFeaturesViewModels({ relatedFeatureViewModels: e12, relatedFeatures: t12, map: i12 }) {
    const { view: r9, spatialReference: s12 } = this;
    t12 == null ? void 0 : t12.filter(Boolean).forEach((t13) => {
      e12.find((e13) => this._matchesFeature(e13, t13)) || e12.add(new H2({ abilities: { relationshipContent: false }, map: i12, view: r9, spatialReference: s12, graphic: t13 }));
    }), e12.forEach((i13) => {
      const r10 = t12 == null ? void 0 : t12.find((e13) => this._matchesFeature(i13, e13));
      r10 || e12.remove(i13);
    });
  }
  _setExpressionContentVM(e12, t12) {
    const i12 = this.formattedAttributes, { contentElement: r9, contentElementViewModel: s12 } = e12, o8 = r9 == null ? void 0 : r9.type;
    s12 && o8 && ("fields" === o8 && (this._createFieldsFormattedAttributes({ contentElement: r9, contentElementIndex: t12, formattedAttributes: i12 }), s12.set(this._createFieldsVMParams(r9, t12))), "media" === o8 && (this._createMediaFormattedAttributes({ contentElement: r9, contentElementIndex: t12, formattedAttributes: i12 }), s12.set(this._createMediaVMParams(r9, t12))), "text" === o8 && s12.set(this._createTextVMParams(r9)));
  }
  _compileRelationship(e12, t12) {
    const { displayCount: i12, orderByFields: r9, relationshipId: s12, title: o8, description: n14 } = e12, { _sourceLayer: a14, graphic: l12, map: p16 } = this;
    if (!W2(a14))
      return;
    const c21 = new q3({ displayCount: i12, graphic: l12, orderByFields: r9, relationshipId: s12, layer: a14, map: p16, ...this._compileTitleAndDesc({ title: o8, description: n14 }) });
  ...
  _compileExpression(e12, t12) {
    const { expressionInfo: i12 } = e12, { graphic: r9, map: s12, spatialReference: o8, view: n14 } = this, a14 = new C3({ expressionInfo: i12, graphic: r9, interceptor: H2.interceptor, map: s12, spatialReference: o8, view: n14 });
  ...
  _compileAttachments(e12, t12) {
    const { graphic: i12 } = this, { description: r9, title: s12 } = e12;
    return this.contentViewModels[t12] = new c8({ graphic: i12, ...this._compileTitleAndDesc({ title: s12, description: r9 }) }), e12;
  }
  _compileCustom(e12, t12) {
    const { graphic: i12 } = this, { creator: r9, destroyer: s12 } = e12;
    return this.contentViewModels[t12] = new l5({ graphic: i12, creator: r9, destroyer: s12 }), e12;
  }
  _compileTitleAndDesc({ title: e12, description: t12 }) {
    const { _fieldInfoMap: i12, _sourceLayer: r9, graphic: s12, formattedAttributes: o8 } = this, n14 = s12 == null ? void 0 : s12.attributes, a14 = this._expressionAttributes, l12 = o8.global;
    return { title: G({ attributes: n14, fieldInfoMap: i12, globalAttributes: l12, expressionAttributes: a14, layer: r9, text: e12 }), description: G({ attributes: n14, fieldInfoMap: i12, globalAttributes: l12, expressionAttributes: a14, layer: r9, text: t12 }) };
  }
  _createFieldsVMParams(e12, t12) {
    const i12 = this._effectivePopupTemplate, r9 = this.formattedAttributes, s12 = { ...r9 == null ? void 0 : r9.global, ...r9 == null ? void 0 : r9.content[t12] }, o8 = (e12 == null ? void 0 : e12.fieldInfos) || (i12 == null ? void 0 : i12.fieldInfos), n14 = o8 == null ? void 0 : o8.filter(({ fieldName: e13 }) => M2(e13) || pe(e13) || s12.hasOwnProperty(e13)), a14 = i12 == null ? void 0 : i12.expressionInfos, { description: l12, title: p16 } = e12;
  ...
  _compileFields(e12, t12) {
    const i12 = e12.clone(), r9 = new n8(this._createFieldsVMParams(e12, t12));
    return this.contentViewModels[t12] = r9, i12.fieldInfos = r9.formattedFieldInfos.slice(0), i12;
  }
  _createMediaVMParams(e12, t12) {
    const { abilities: i12, graphic: r9, _fieldInfoMap: s12, _effectivePopupTemplate: o8, relatedInfos: n14, _sourceLayer: a14, _expressionAttributes: l12 } = this, p16 = this.formattedAttributes, c21 = (r9 == null ? void 0 : r9.attributes) ?? {}, { description: d10, mediaInfos: u9, title: h13 } = e12;
    return { abilities: { chartAnimation: i12.chartAnimation }, activeMediaInfoIndex: e12.activeMediaInfoIndex || 0, attributes: c21, isAggregate: r9 == null ? void 0 : r9.isAggregate, layer: a14, fieldInfoMap: s12, formattedAttributes: { ...p16 == null ? void 0 : p16.global, ...p16 == null ? void 0 : p16.content[t12] }, expressionAttributes: l12, mediaInfos: u9, popupTemplate: o8, relatedInfos: n14, ...this._compileTitleAndDesc({ title: h13, description: d10 }) };
  }
  _compileMedia(e12, t12) {
    const i12 = e12.clone(), r9 = new M3(this._createMediaVMParams(e12, t12));
    return i12.mediaInfos = r9.formattedMediaInfos.slice(0), this.contentViewModels[t12] = r9, i12;
  }
  _createTextVMParams(e12) {
    var _a;
    const { graphic: t12, _fieldInfoMap: i12, _sourceLayer: r9, _expressionAttributes: s12 } = this;
    if (e12 && e12.text) {
      const o8 = (t12 == null ? void 0 : t12.attributes) ?? {}, n14 = ((_a = this.formattedAttributes) == null ? void 0 : _a.global) ?? {};
      e12.text = G({ attributes: o8, fieldInfoMap: i12, globalAttributes: n14, expressionAttributes: s12, layer: r9, text: e12.text });
    }
    return { graphic: t12, creator: e12.text };
  }
  _compileText(e12, t12) {
    const i12 = e12.clone();
    return this.contentViewModels[t12] = new l5(this._createTextVMParams(i12)), i12;
  }
  _compileLastEditInfo() {
    const { _effectivePopupTemplate: e12, _sourceLayer: t12, graphic: i12 } = this;
    if (!e12)
      return;
    const { lastEditInfoEnabled: r9 } = e12, s12 = t12 == null ? void 0 : t12.editFieldsInfo;
    return r9 && s12 ? ne(s12, i12 == null ? void 0 : i12.attributes) : void 0;
  }
  _compileTitle(e12) {
    var _a;
    const { _fieldInfoMap: t12, _sourceLayer: i12, graphic: r9, _expressionAttributes: s12 } = this, o8 = (r9 == null ? void 0 : r9.attributes) ?? {}, n14 = ((_a = this.formattedAttributes) == null ? void 0 : _a.global) ?? {};
    return G({ attributes: o8, fieldInfoMap: t12, globalAttributes: n14, expressionAttributes: s12, layer: i12, text: e12 });
  }
  async _getTitle() {
    const { _effectivePopupTemplate: e12, graphic: t12 } = this;
    if (!t12)
      return null;
    const i12 = e12 == null ? void 0 : e12.title;
    return q2(i12, { graphic: t12 });
  }
  async _getContent() {
    const { _effectivePopupTemplate: e12, graphic: t12 } = this;
    if (!t12)
      return null;
    const i12 = e12 == null ? void 0 : e12.content;
    return q2(i12, { graphic: t12 });
  }
  async _queryFeature(e12) {
    const { _featureAbortController: t12, _sourceLayer: i12, graphic: r9, _effectivePopupTemplate: s12 } = this, o8 = this.map, n14 = this.view, a14 = this.spatialReference;
    if (t12 !== this._featureAbortController || !r9)
      return;
    await de({ graphic: r9, popupTemplate: s12, layer: i12, spatialReference: a14 }, e12);
    const { content: { value: l12 }, title: { value: c21 } } = await j({ content: this._getContent(), title: this._getTitle() }), { expressionAttributes: { value: d10 } } = await j({ checkForRelatedFeatures: this._checkForRelatedFeatures(e12), expressionAttributes: m9({ expressionInfos: s12 == null ? void 0 : s12.expressionInfos, spatialReference: a14, graphic: r9, map: o8, interceptor: H2.interceptor, view: n14 }) });
  ...
  _createMediaFormattedAttributes({ contentElement: e12, contentElementIndex: t12, formattedAttributes: i12 }) {
    const { _effectivePopupTemplate: r9, graphic: s12, relatedInfos: o8, _sourceLayer: n14, _fieldInfoMap: a14, _graphicExpressionAttributes: l12 } = this;
    i12.content[t12] = se2({ fieldInfos: r9 == null ? void 0 : r9.fieldInfos, graphic: s12, attributes: { ...l12, ...e12.attributes }, layer: n14, fieldInfoMap: a14, relatedInfos: o8 });
  }
  _createFieldsFormattedAttributes({ contentElement: e12, contentElementIndex: t12, formattedAttributes: i12 }) {
    if (e12.fieldInfos) {
      const { graphic: r9, relatedInfos: s12, _sourceLayer: o8, _fieldInfoMap: n14, _graphicExpressionAttributes: a14 } = this;
      i12.content[t12] = se2({ fieldInfos: e12.fieldInfos, graphic: r9, attributes: { ...a14, ...e12.attributes }, layer: o8, fieldInfoMap: n14, relatedInfos: s12 });
    }
  }
  _createFormattedAttributes(e12) {
    const { _effectivePopupTemplate: t12, graphic: i12, relatedInfos: r9, _sourceLayer: s12, _fieldInfoMap: o8, _graphicExpressionAttributes: n14 } = this, a14 = t12 == null ? void 0 : t12.fieldInfos, l12 = { global: se2({ fieldInfos: a14, graphic: i12, attributes: n14, layer: s12, fieldInfoMap: o8, relatedInfos: r9 }), content: [] };
  ...
  _checkForRelatedFeatures(e12) {
    const { graphic: t12, _effectivePopupTemplate: i12 } = this;
    return this._queryRelatedInfos(t12, oe(i12), e12);
  }
  async _queryRelatedInfos(e12, t12, i12) {
    const { relatedInfos: r9, _sourceLayer: s12 } = this;
    r9.clear();
    const o8 = null != (s12 == null ? void 0 : s12.associatedLayer) ? await (s12 == null ? void 0 : s12.associatedLayer.load(i12)) : s12;
    if (!o8 || !e12)
      return;
    const n14 = t12.filter((e13) => e13 && pe(e13.fieldName));
    if (!n14 || !n14.length)
      return;
    t12.forEach((e13) => this._configureRelatedInfo(e13, o8));
    const a14 = await R3({ relatedInfos: r9, layer: o8 }, i12);
    Object.keys(a14).forEach((e13) => {
      var _a;
      const t13 = r9.get(e13.toString()), i13 = (_a = a14[e13]) == null ? void 0 : _a.value;
      t13 && i13 && (t13.layerInfo = i13.data);
    });
    const l12 = await $2({ graphic: e12, relatedInfos: r9, layer: o8 }, i12);
  ...
  _configureRelatedInfo(e12, t12) {
    const { relatedInfos: i12 } = this, r9 = m8(e12.fieldName);
    if (!r9)
      return;
    const { layerId: s12, fieldName: o8 } = r9;
    if (!s12)
      return;
    const n14 = i12.get(s12.toString()) || g5(s12, t12);
    n14 && (U3({ relatedInfo: n14, fieldName: o8, fieldInfo: e12 }), this.relatedInfos.set(s12, n14));
  }
};
X.interceptor = new e9(be, Fe), e([y()], X.prototype, "_error", void 0), e([y()], X.prototype, "_featureAbortController", void 0), e([y({ readOnly: true })], X.prototype, "_effectivePopupTemplate", null), e([y({ readOnly: true })], X.prototype, "_fieldInfoMap", null), e([y({ readOnly: true })], X.prototype, "_sourceLayer", null), e([y()], X.prototype, "abilities", void 0), e([s4("abilities")], X.prototype, "castAbilities", null), e([y({ readOnly: true })], X.prototype, "content", void 0), e([y({ readOnly: true })], X.prototype, "contentViewModels", void 0), e([y()], X.prototype, "description", void 0), e([y({ type: Boolean })], X.prototype, "defaultPopupTemplateEnabled", void 0), e([y({ readOnly: true })], X.prototype, "isTable", null), e([y({ readOnly: true })], X.prototype, "state", null), e([y({ readOnly: true })], X.prototype, "formattedAttributes", void 0), e([y({ type: h4, value: null })], X.prototype, "graphic", null), e([y({ readOnly: true })], X.prototype, "lastEditInfo", void 0), e([y({ readOnly: true })], X.prototype, "relatedInfos", void 0), e([y()], X.prototype, "spatialReference", null), e([y({ readOnly: true })], X.prototype, "title", void 0), e([y()], X.prototype, "map", null), e([y({ readOnly: true })], X.prototype, "waitingForContent", null), e([y()], X.prototype, "view", void 0), X = H2 = e([a("esri.widgets.FeatureViewModel")], X);
var Y3 = X;
...
var i9 = (i12) => {
  let n14 = class extends i12 {
    constructor() {
      super(...arguments), this.renderNodeContent = (e12) => e4(e12) && !e12.destroyed ? n3("div", { class: t7.contentNode, key: e12 }, e12.render()) : e12 instanceof HTMLElement ? n3("div", { class: t7.contentNode, key: e12, bind: e12, afterCreate: this._attachToNode }) : t3(e12) ? n3("div", { class: t7.contentNode, key: e12, bind: e12.domNode, afterCreate: this._attachToNode }) : null;
    }
    _attachToNode(e12) {
      const o8 = this;
      e12.appendChild(o8);
...
var j9 = b10 = class extends i9(W) {
  ...
  loadDependencies() {
    return n4({ notice: () => import("./calcite-notice-J4AIF4DN.js") });
  }
  destroy() {
  ...
  render() {
    const { state: e12 } = this.viewModel, t12 = n3("div", { class: t7.container, key: "container" }, this.renderTitle(), "error" === e12 ? this.renderError() : "loading" === e12 ? this.renderLoading() : this.renderContentContainer());
    return n3("div", { class: this.classes(t7.base, t7.esriWidget) }, t12);
  }
  setActiveMedia(e12, t12) {
  ...
  renderError() {
    ...
    return n3("calcite-notice", { open: true, kind: "danger", icon: "exclamation-mark-circle", scale: "s" }, s12.title ? n3("div", { key: "error-title", slot: "title" }, e12.errorMessage) : null, n3("div", { key: "error-message", slot: "message" }, t12.loadingError));
  }
  renderLoading() {
    return n3("div", { key: "loading-container", class: t7.loadingSpinnerContainer }, n3("span", { class: this.classes(t7.iconLoading, t7.spinner) }));
  }
  renderContentContainer() {
    const { visibleElements: e12 } = this;
    return e12.content ? n3("div", { class: t7.main }, [this.renderContent(), this.renderLastEditInfo()]) : null;
  }
  renderTitle() {
    const { visibleElements: e12, title: t12 } = this;
    return e12.title ? n3(n5, { level: this.headingLevel, class: t7.title, innerHTML: t12 }) : null;
  }
  renderContent() {
    ...
    if (Array.isArray(e12))
      return e12.length ? n3("div", { class: t7.contentNode, key: `${t12}-content-elements` }, e12.map(this.renderContentElement, this)) : null;
    if ("string" == typeof e12) {
      const e13 = this._contentWidgets[0];
      return !e13 || e13.destroyed ? null : n3("div", { class: t7.contentNode, key: `${t12}-content` }, e13.render());
    }
  ...
  renderAttachments(e12) {
    ...
    if (!t12 || t12.destroyed)
      return null;
    const { state: s12, attachmentInfos: i12 } = t12.viewModel;
    return "loading" === s12 || i12.length > 0 ? n3("div", { key: this._buildKey("attachments-element", e12), class: this.classes(t7.contentElement) }, t12.render()) : null;
  }
  renderRelationship(e12) {
    const t12 = this._contentWidgets[e12];
    return t12 && !t12.destroyed && this.flowItems ? n3("div", { key: this._buildKey("relationship-element", e12), class: t7.contentElement }, t12.render()) : null;
  }
  renderExpression(e12) {
    const t12 = this._contentWidgets[e12];
    return !t12 || t12.destroyed ? null : n3("div", { key: this._buildKey("expression-element", e12), class: t7.contentElement }, t12.render());
  }
  renderCustom(e12, t12) {
    const { creator: s12 } = e12, i12 = this._contentWidgets[t12];
    return !i12 || i12.destroyed ? null : s12 ? n3("div", { key: this._buildKey("custom-element", t12), class: t7.contentElement }, i12.render()) : null;
  }
  renderFields(e12) {
    const t12 = this._contentWidgets[e12];
    return !t12 || t12.destroyed ? null : n3("div", { key: this._buildKey("fields-element", e12), class: t7.contentElement }, t12.render());
  }
  renderMedia(e12) {
    const t12 = this._contentWidgets[e12];
    return !t12 || t12.destroyed ? null : n3("div", { key: this._buildKey("media-element", e12), class: t7.contentElement }, t12.render());
  }
  renderLastEditInfo() {
    const { visibleElements: e12, messages: t12 } = this, { lastEditInfo: s12 } = this.viewModel;
    if (!s12 || !e12.lastEditedInfo)
      return null;
    const { date: i12, user: n14 } = s12, r9 = "edit" === s12.type ? n14 ? t12.lastEditedByUser : t12.lastEdited : n14 ? t12.lastCreatedByUser : t12.lastCreated, o8 = s3(r9, { date: i12, user: n14 });
    return n3("div", { key: "edit-info-element", class: this.classes(t7.lastEditedInfo, t7.contentElement) }, o8);
  }
  renderText(e12, t12) {
    const s12 = e12.text, i12 = this._contentWidgets[t12];
    return !i12 || i12.destroyed ? null : s12 ? n3("div", { key: this._buildKey("text-element", t12), class: this.classes(t7.contentElement, t7.text) }, i12.render()) : null;
  }
  _buildKey(e12, ...t12) {
  ...
  _addFeatureRelationshipHandles(e12) {
    const { flowItems: t12, visibleElements: i12 } = this;
    this.addHandles([a2(() => e12, "select-record", ({ featureViewModel: e13 }) => {
      t12 && (e13.abilities = { relationshipContent: true }, t12.push(new b10({ flowItems: t12, viewModel: e13, visibleElements: i12 })));
    }), a2(() => e12, "show-all-records", () => {
      if (!t12)
        return;
      const { viewModel: s12 } = e12;
      s12.showAllEnabled = true;
      const i13 = new _2({ visibleElements: { title: false, description: false }, viewModel: s12 });
      this._addFeatureRelationshipHandles(i13), t12.push(i13);
    })], W4);
  }
  _setupContentWidgets() {
    this._destroyContentWidgets();
    const { headingLevel: e12, visibleElements: t12 } = this, s12 = this.get("viewModel.content"), { contentViewModels: i12 } = this.viewModel;
    if (Array.isArray(s12))
      s12.forEach((s13, n14) => {
        if ("attachments" === s13.type && (this._contentWidgets[n14] = new h6({ displayType: s13.displayType, headingLevel: t12.title ? e12 + 1 : e12, viewModel: i12[n14] })), "fields" === s13.type && (this._contentWidgets[n14] = new c12({ viewModel: i12[n14] })), "media" === s13.type && (this._contentWidgets[n14] = new j7({ viewModel: i12[n14] })), "text" === s13.type && (this._contentWidgets[n14] = new p7({ viewModel: i12[n14] })), "custom" === s13.type && (this._contentWidgets[n14] = new p7({ viewModel: i12[n14] })), "expression" === s13.type && (this._contentWidgets[n14] = new m10({ viewModel: i12[n14] })), "relationship" === s13.type) {
          const e13 = new _2({ viewModel: i12[n14] });
...
e([y()], j9.prototype, "graphic", null), e([y()], j9.prototype, "defaultPopupTemplateEnabled", null), e([y()], j9.prototype, "flowItems", void 0), e([y()], j9.prototype, "headingLevel", void 0), e([y({ readOnly: true })], j9.prototype, "isTable", null), e([y()], j9.prototype, "label", null), e([y(), e2("esri/widgets/Feature/t9n/Feature")], j9.prototype, "messages", void 0), e([y(), e2("esri/t9n/common")], j9.prototype, "messagesCommon", void 0), e([y(), e2("esri/widgets/support/t9n/uriUtils")], j9.prototype, "messagesURIUtils", void 0), e([y()], j9.prototype, "spatialReference", null), e([y({ readOnly: true })], j9.prototype, "title", null), e([y()], j9.prototype, "visibleElements", void 0), e([s4("visibleElements")], j9.prototype, "castVisibleElements", null), e([y()], j9.prototype, "map", null), e([y()], j9.prototype, "view", null), e([y({ type: Y3 })], j9.prototype, "viewModel", void 0), j9 = b10 = e([a("esri.widgets.Feature")], j9);
var C4 = j9;
...
var d7 = class extends n2.EventedAccessor {
  constructor(o8) {
    super(o8), this[l9] = new t(), this.location = null, this.screenLocationEnabled = false, this.view = null, this[p11].add([f2(() => n(this.screenLocationEnabled ? this.view : null, (o9) => [o9.size, "3d" === o9.type ? o9.camera : o9.viewpoint]), () => this.notifyChange("screenLocation")), l2(() => this.screenLocation, (o9, e12) => {
      null != o9 && null != e12 && this.emit("view-change");
    })]);
  }
  destroy() {
  ...
  get screenLocation() {
    var _a;
    const { location: o8, view: e12, screenLocationEnabled: t12 } = this;
    return t12 && null != o8 && null != e12 && e12.ready ? (_a = e12.toScreen) == null ? void 0 : _a.call(e12, o8) : null;
  }
};
...
var p13 = class extends W {
  constructor(i12, e12) {
    super(i12, e12), this._animationDelay = 500, this._animationPromise = null, this.viewModel = new c17();
  }
  initialize() {
    this.addHandles(l2(() => this.visible, (i12) => this._visibleChange(i12)));
  }
  destroy() {
  ...
  show(i12) {
    const { location: e12, promise: t12 } = i12 ?? {};
  ...
  render() {
    const { visible: i12 } = this, { screenLocation: e12 } = this.viewModel, t12 = !!e12, s12 = i12 && t12, o8 = !i12 && t12, r9 = { [c18.spinnerStart]: s12, [c18.spinnerFinish]: o8 }, n14 = this._getPositionStyles();
    return n3("div", { class: this.classes(c18.base, r9), styles: n14 });
  }
  _visibleChange(i12) {
    if (i12)
  ...
  _getPositionStyles() {
    const { screenLocation: i12, view: e12 } = this.viewModel;
    if (null == e12 || null == i12)
      return {};
    const { padding: t12 } = e12;
    return { left: i12.x - t12.left + "px", top: i12.y - t12.top + "px" };
  }
};
...
var o5 = { iconZoom: "esri-icon-zoom-in-magnifying-glass", iconTrash: "esri-icon-trash", iconBrowseClusteredFeatures: "esri-icon-table" };
var t9 = new c6({ icon: "magnifying-glass-plus", id: "zoom-to-feature", title: "{messages.zoom}", className: o5.iconZoom });
var i10 = new c6({ icon: "trash", id: "remove-selected-feature", title: "{messages.remove}", className: o5.iconTrash });
var a12 = new c6({ icon: "magnifying-glass-plus", id: "zoom-to-clustered-features", title: "{messages.zoom}", className: o5.iconZoom });
var r8 = new a5({ icon: "table", id: "browse-clustered-features", title: "{messages.browseClusteredFeatures}", className: o5.iconBrowseClusteredFeatures, value: false });
...
var u7 = (t12) => {
  ...
  if (g9 === i10.id) {
    ...
    if (!t13)
      return Promise.reject(new s2(`trigger-action:${i10.id}`, "selectedFeature is required", { selectedFeature: t13 }));
...
async function w8(t12) {
  var _a;
  const { location: r9, selectedFeature: o8, view: i12, zoomFactor: a14 } = t12, c21 = l10(t12);
  if (!i12 || !c21) {
    const t13 = new s2("zoom-to:invalid-target-or-view", "Cannot zoom to location without a target and view.", { target: c21, view: i12 });
    throw s11.error(t13), t13;
  }
  const u9 = i12.scale / a14, d10 = (_a = t12.selectedFeature) == null ? void 0 : _a.geometry, w9 = d10 ?? r9, f11 = null != w9 && "point" === w9.type && await g8(o8, i12);
  t9.active = true, t9.disabled = true;
  try {
    await t12.zoomTo({ target: { target: c21, scale: f11 ? u9 : void 0 } });
  } catch (m15) {
    const t13 = new s2("zoom-to:invalid-graphic", "Could not zoom to the location of the graphic.", { graphic: o8 });
    s11.error(t13);
  } finally {
...
async function f9(t12) {
  ...
  const [i12, a14] = await v7(n14, r9);
  a12.active = true, a12.disabled = true;
  const { extent: c21 } = await i12.queryExtent(a14);
  await t12.zoomTo({ target: c21 }), a12.active = false, a12.disabled = false;
}
async function m13(e12) {
  const { view: t12, selectedFeature: r9 } = e12;
  if (!t12 || !r9)
    return;
  const [n14, o8] = await v7(t12, r9), { extent: i12 } = await n14.queryExtent(o8);
  e12.selectedClusterBoundaryFeature.geometry = i12, t12.graphics.add(e12.selectedClusterBoundaryFeature);
}
async function p14(e12) {
  const { selectedFeature: t12, view: r9 } = e12;
  if (!r9 || !t12)
    return;
  const [n14, o8] = await v7(r9, t12);
  r8.active = true, r8.disabled = true;
  const { features: a14 } = await n14.queryFeatures(o8);
...
async function v7(e12, t12) {
  const r9 = await e12.whenLayerView(t12.sourceLayer), n14 = r9.createQuery(), o8 = t12.getObjectId();
  return n14.aggregateIds = null != o8 ? [o8] : [], [r9, n14];
}
function y9(e12) {
  r8.value = false;
...
async function x4(t12, l12) {
  if (!t12)
    return;
  const i12 = t12.sourceLayer, r9 = (null != l12 && l12.useSourceLayer ? i12 : t12.layer) ?? i12, a14 = L4(r9);
  ...
  const { getColor: p16, getOpacity: h13, getAllSizes: y11, getRotationAngle: d10 } = await import("./visualVariableUtils-QMXKDPVU.js"), m15 = [], b12 = [], g9 = [], w9 = [];
...
var R6 = class extends t5(m12) {
  ...
  initialize() {
    ...
    }, () => this._viewScaleChange()), f2(() => !this.visible, () => this.browseClusterEnabled = false), l2(() => this.browseClusterEnabled, (e12) => e12 ? this.enableClusterBrowsing() : this.disableClusterBrowsing())]);
  }
  destroy() {
  ...
  get allActions() {
    ...
    e12.removeAll();
    const { actions: t12, defaultActions: i12, defaultPopupTemplateEnabled: s12, includeDefaultActions: r9, selectedFeature: o8 } = this, a14 = r9 ? i12.concat(t12) : t12, n14 = o8 && ("function" == typeof o8.getEffectivePopupTemplate && o8.getEffectivePopupTemplate(s12) || o8.popupTemplate), l12 = n14 && n14.actions, h13 = n14 && n14.overwriteActions ? l12 : l12 ? l12.concat(a14) : a14;
  ...
  set features(e12) {
    ...
    const { pendingPromisesCount: i12, promiseCount: s12, selectedFeatureIndex: r9 } = this, o8 = s12 && t12.length;
    o8 && i12 && -1 === r9 ? this.selectedFeatureIndex = 0 : o8 && -1 !== r9 || (this.selectedFeatureIndex = t12.length ? 0 : -1);
  }
  get location() {
  ...
  set location(e12) {
    var _a, _b, _c;
    let t12 = e12;
    const i12 = (_b = (_a = this.view) == null ? void 0 : _a.spatialReference) == null ? void 0 : _b.isWebMercator;
    e12 && ((_c = e12 == null ? void 0 : e12.spatialReference) == null ? void 0 : _c.isWGS84) && i12 && (t12 = d2(e12)), this._set("location", t12);
  }
  ...
  set promises(e12) {
    ...
    this._set("promises", e12), (e12 = e12.slice(0)).forEach((e13) => {
      ...
      }, i12 = () => this._updatePendingPromises(e13);
      e13.then(t12, i12);
  ...
  fetchFeatures(e12, t12) {
    const { view: i12 } = this;
    if (!i12 || !e12)
      throw new s2("fetch-features:invalid-screenpoint-or-view", "Cannot fetch features without a screenPoint and view.", { screenPoint: e12, view: i12 });
    return i12.fetchPopupFeatures(e12, { event: t12 && t12.event, defaultPopupTemplateEnabled: this.defaultPopupTemplateEnabled, signal: t12 && t12.signal });
  }
  open(e12) {
    const t12 = { updateLocationEnabled: false, promises: [], fetchFeatures: false, ...e12, visible: true }, { fetchFeatures: i12 } = t12;
    delete t12.fetchFeatures, i12 && this._setFetchFeaturesPromises(t12.location);
  ...
  async enableClusterBrowsing() {
    ...
    "2d" === (e12 == null ? void 0 : e12.type) ? d8(t12) ? (await m13(this), await p14(this)) : s.getLogger(this).warn("enableClusterBrowsing:invalid-selectedFeature: Selected feature must represent an aggregate/cluster graphic.", t12) : s.getLogger(this).warn("enableClusterBrowsing:invalid-view: View must be 2d MapView.", t12);
  }
  handleViewClick(e12) {
  ...
  _locationChange(e12) {
    const { selectedFeature: t12, updateLocationEnabled: i12 } = this;
    i12 && e12 && (!t12 || t12.geometry) && this.centerAtLocation();
  }
  ...
  _setGraphicOnFeatureViewModels() {
    const { features: e12, featureCount: t12, featurePage: i12, featuresPerPage: s12, featureViewModels: r9 } = this;
    if (null === i12)
      return;
    const o8 = ((i12 - 1) * s12 + t12) % t12, a14 = o8 + s12;
    r9.slice(o8, a14).forEach((t13, i13) => {
      t13 && !t13.graphic && (t13.graphic = e12[o8 + i13]);
    });
  }
  async _selectedFeatureChange(e12) {
    const { location: t12, updateLocationEnabled: i12, view: s12 } = this;
    if (e12 && s12) {
      ...
      !i12 && t12 || !e12.geometry ? i12 && !e12.geometry && this.centerAtLocation().then(() => {
        var _a;
  ...
  _setFetchFeaturesPromises(e12) {
    return this._fetchFeaturesWithController(this._getScreenPoint(e12 || this.location)).then((e13) => {
      const { clientOnlyGraphics: t12, promisesPerLayerView: i12 } = e13, s12 = Promise.resolve(t12), r9 = i12.map((e14) => e14.promise);
  ...
  _updateFeatureVMs() {
    const { selectedFeature: e12, features: t12, featureViewModels: i12 } = this;
    if (d8(e12) || (this.browseClusterEnabled = false), this._destroyFeatureVMs(), !t12 || !t12.length)
      return;
    const s12 = i12.slice(0), r9 = [];
    t12.forEach((t13, i13) => {
      var _a, _b;
      if (!t13)
        return;
      let o8 = null;
      if (s12.some((e13, i14) => (e13 && e13.graphic === t13 && (o8 = e13, s12.splice(i14, 1)), !!o8)), o8)
        r9[i13] = o8;
      else {
  ...
  _fetchFeaturesWithController(e12, t12) {
    ...
    const i12 = new AbortController(), { signal: s12 } = i12;
    this._fetchFeaturesController = i12, this.notifyChange("waitingForResult");
  ...
  _fetchFeaturesAndOpen(e12) {
    const { screenPoint: t12, mapPoint: i12 } = e12, { view: s12 } = this;
    this._fetchFeaturesWithController(t12, e12).then((e13) => {
      const { clientOnlyGraphics: t13, promisesPerLayerView: r9, location: o8 } = e13, a14 = [Promise.resolve(t13), ...r9.map((e14) => e14.promise)];
      return (s12 == null ? void 0 : s12.popup) && "open" in s12.popup && s12.popup.open({ location: o8 || i12, promises: a14 }), e13;
    });
  }
  ...
  _getHighlightLayer(e12) {
    const { layer: t12, sourceLayer: i12 } = e12;
    return i12 && "layer" in i12 && i12.layer ? i12.layer : "map-notes" === (i12 == null ? void 0 : i12.type) || "subtype-group" === (i12 == null ? void 0 : i12.type) ? i12 : t12;
  }
  _getHighlightTarget(e12, t12) {
    const i12 = "imagery" === t12.type ? void 0 : "objectIdField" in t12 ? t12.objectIdField || o7 : null, s12 = e12.attributes;
    return s12 && i12 && s12[i12] || e12;
  }
  async _highlightActiveFeature() {
    const e12 = "highlight-active-feature";
    this._handles.remove(e12);
    const { highlightEnabled: t12, view: i12, activeFeature: s12, visible: r9 } = this;
    if (!(s12 && i12 && t12 && r9))
      return;
    const o8 = this._getHighlightLayer(s12);
    if (!(o8 && o8 instanceof b4))
      return;
    const a14 = this._getLayerView(i12, o8);
    ...
    if (!(n14 && n13(n14) && this._highlightActiveFeaturePromise === a14 && this.activeFeature && this.highlightEnabled))
      return;
    const l12 = n14.highlight(this._getHighlightTarget(s12, o8));
    this._handles.add(l12, e12);
  }
  async _highlightSelectedFeature() {
    const e12 = "highlight-selected-feature";
    this._handles.remove(e12);
    const { selectedFeature: t12, highlightEnabled: i12, view: s12, visible: r9 } = this;
    if (!(t12 && s12 && i12 && r9))
      return;
    const o8 = this._getHighlightLayer(t12);
    if (!(o8 && o8 instanceof b4))
      return;
    const a14 = this._getLayerView(s12, o8);
    ...
    if (!(n14 && n13(n14) && this._highlightSelectedFeaturePromise === a14 && this.selectedFeature && this.highlightEnabled && this.visible))
      return;
    const l12 = n14.highlight(this._getHighlightTarget(t12, o8));
    this._handles.add(l12, e12);
  }
  _updateFeatures(e12) {
    ...
    const i12 = e12.filter((e13) => !t12.includes(e13));
    this.features = t12.concat(i12);
  }
};
...
var U4 = class extends i9(W) {
  constructor(e12, i12) {
    super(e12, i12), this._blurClose = false, this._blurContainer = false, this._containerNode = null, this._mainContainerNode = null, this._featureMenuNode = null, this._actionsMenuNode = null, this._focusClose = false, this._focusContainer = false, this._focusDockButton = false, this._focusFeatureMenuButton = false, this._focusActionsMenuButton = false, this._focusFirstFeature = false, this._focusFirstAction = false, this._handles = new t(), this._pointerOffsetInPx = 16, this._spinner = null, this._feature = null, this._featureMenuIntersectionObserverNode = null, this._featureMenuViewportNode = null, this._rootFlowItemNode = null, this._featureMenuIntersectionObserverCallback = ([e13]) => {
  ...
  loadDependencies() {
    return n4({ action: () => import("./calcite-action-SOKZIDHR.js"), flow: () => import("./calcite-flow-5MRLL7KA.js"), "flow-item": () => import("./calcite-flow-item-ZNT2QSYM.js"), icon: () => import("./calcite-icon-6D35RP7Q.js"), tooltip: () => import("./calcite-tooltip-62WSSQ3C.js") });
  }
  initialize() {
  ...
  get hasContent() {
    ...
    const i12 = e12.viewModel;
    if ((i12 == null ? void 0 : i12.waitingForContent) || "error" === (i12 == null ? void 0 : i12.state))
      return true;
    const o8 = i12 == null ? void 0 : i12.content;
    return Array.isArray(o8) ? !!o8.length : !!o8;
  }
  ...
  set dockOptions(e12) {
    var _a, _b;
    const t12 = { ...L5 }, i12 = (_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.breakpoints, o8 = {};
    i12 && (o8.width = i12.xsmall, o8.height = i12.xsmall);
    const n14 = { ...t12, ...e12 }, s12 = { ...t12.breakpoint, ...o8 }, { breakpoint: r9 } = n14;
  ...
  get selectedFeatureWidget() {
    const { _feature: e12, visibleElements: t12, headingLevel: i12, _flowItems: o8 } = this, { selectedFeatureViewModel: n14 } = this.viewModel, s12 = { ...t12, title: false };
    return n14 ? (e12 ? (e12.viewModel = n14, e12.visibleElements = s12) : this._feature = new C4({ flowItems: o8, headingLevel: i12 + 1, viewModel: n14, visibleElements: s12 }), this._feature) : null;
  }
  get title() {
    return this.viewModel.title;
  }
  ...
  open(e12) {
    ...
    const t12 = !!e12 && !!e12.featureMenuOpen, i12 = !!e12 && !!e12.actionsMenuOpen, o8 = { collapsed: !!e12 && !!e12.collapsed, actionsMenuOpen: i12, featureMenuOpen: t12 };
    "xsmall" === ((_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.widthBreakpoint) && (o8.collapsed = true), this.set(o8), this.viewModel.open(e12), this._shouldFocus(e12), this._addSelectedFeatureIndexHandle();
  }
  previous() {
  ...
  render() {
    var _a, _b, _c, _d;
    const { actionsMenuOpen: e12, dockEnabled: t12, featureMenuVisible: i12, dividedActions: o8, currentAlignment: n14, currentDockPosition: s12 } = this, { active: r9 } = this.viewModel, { menuActions: l12 } = o8, a14 = r9 && l12.length > 1 && e12, c21 = r9 && t12, u9 = r9 && !t12, d10 = (_b = (_a = this.selectedFeature) == null ? void 0 : _a.layer) == null ? void 0 : _b.title, h13 = (_d = (_c = this.selectedFeature) == null ? void 0 : _c.layer) == null ? void 0 : _d.id, p16 = { [n12.alignTopCenter]: "top-center" === n14, [n12.alignBottomCenter]: "bottom-center" === n14, [n12.alignTopLeft]: "top-left" === n14, [n12.alignBottomLeft]: "bottom-left" === n14, [n12.alignTopRight]: "top-right" === n14, [n12.alignBottomRight]: "bottom-right" === n14, [n12.isDocked]: c21, [n12.shadow]: u9, [n12.isDockedTopLeft]: "top-left" === s12, [n12.isDockedTopCenter]: "top-center" === s12, [n12.isDockedTopRight]: "top-right" === s12, [n12.isDockedBottomLeft]: "bottom-left" === s12, [n12.isDockedBottomCenter]: "bottom-center" === s12, [n12.isDockedBottomRight]: "bottom-right" === s12, [n12.isFeatureMenuOpen]: i12, [n12.isActionsMenuOpen]: a14 };
    return n3("div", { class: this.classes(n12.base, p16), role: "presentation", "data-layer-title": d10, "data-layer-id": h13, bind: this, afterCreate: this._positionContainer, afterUpdate: this._positionContainer }, r9 ? [this.renderMainContainer(), this.renderPointer()] : null);
  }
  renderLoadingIcon() {
    return n3("span", { "aria-hidden": "true", class: this.classes(n12.icon, n12.iconLoading, n12.rotating) });
  }
  renderNavigationLoading() {
    const { messagesCommon: e12 } = this;
    return this.viewModel.pendingPromisesCount ? n3("div", { key: V4("loading-container"), role: "presentation", class: n12.loadingContainer, "aria-label": e12.loading, title: e12.loading }, this.renderLoadingIcon()) : null;
  }
  renderPreviousButton() {
    const { messages: e12 } = this;
    return n3("div", { role: "button", tabIndex: 0, bind: this, onclick: this._previous, onkeydown: this._previous, class: this.classes(n12.button, n12.paginationPrevious), "aria-label": e12.previous, title: e12.previous }, n3("calcite-icon", { icon: "chevron-left", scale: "s", class: n12.paginationIcon }));
  }
  renderNextButton() {
    const { messages: e12 } = this;
    return n3("div", { role: "button", tabIndex: 0, bind: this, onclick: this._next, onkeydown: this._next, class: this.classes(n12.button, n12.paginationNext), "aria-label": e12.next, title: e12.next }, n3("calcite-icon", { icon: "chevron-right", scale: "s", class: n12.paginationIcon }));
  }
  renderFeatureMenuButton() {
    const { featureMenuOpen: e12, featureMenuId: t12, messagesCommon: i12 } = this, { featureCount: o8, selectedFeatureIndex: n14 } = this.viewModel;
    return n3("div", { role: "button", tabIndex: 0, bind: this, onclick: this._toggleFeatureMenu, onkeydown: this._toggleFeatureMenu, afterCreate: this._focusFeatureMenuButtonNode, afterUpdate: this._focusFeatureMenuButtonNode, class: n12.featureMenuButton, "aria-haspopup": "true", "aria-controls": t12, "aria-expanded": e12.toString(), "aria-label": i12.menu, title: i12.menu }, n3("calcite-icon", { icon: "list-bullet", scale: "s", class: n12.featureMenuButtonIcon }), this._getPageText(o8, n14));
  }
  ...
  renderDockIcon() {
    const { dockEnabled: e12 } = this, t12 = this._wouldDockTo(), i12 = { [n12.iconUndock]: e12, [n12.iconDock]: !e12, [n12.iconDockToRight]: !e12 && ("top-right" === t12 || "bottom-right" === t12), [n12.iconDockToLeft]: !e12 && ("top-left" === t12 || "bottom-left" === t12), [n12.iconDockToTop]: !e12 && "top-center" === t12, [n12.iconDockToBottom]: !e12 && "bottom-center" === t12 };
    return n3("span", { "aria-hidden": "true", class: this.classes(i12, n12.icon) });
  }
  renderDockButton() {
    var _a, _b, _c;
    const { dockEnabled: e12, messages: t12 } = this, i12 = (_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.widthBreakpoint, o8 = e12 ? t12.undock : t12.dock;
    return "xsmall" !== i12 && ((_c = this.dockOptions) == null ? void 0 : _c.buttonEnabled) ? n3("div", { role: "button", "aria-label": o8, title: o8, tabIndex: 0, bind: this, onclick: this._toggleDockEnabled, onkeydown: this._toggleDockEnabled, afterCreate: this._focusDockButtonNode, afterUpdate: this._focusDockButtonNode, class: this.classes(n12.button, n12.buttonDock) }, this.renderDockIcon()) : null;
  }
  renderTitle() {
    const { title: e12 } = this.viewModel, { titleId: t12, collapsible: i12, contentCollapsed: o8, messagesCommon: n14 } = this, s12 = { [n12.headerContainerButton]: i12 }, r9 = n3(n5, { level: this.headingLevel, class: n12.headerTitle, innerHTML: e12 ?? "" }), l12 = i12 ? n3("button", { key: `${e12}--collapsible`, id: t12, title: o8 ? n14.expand : n14.collapse, bind: this, enterAnimation: this._createFeatureUpdatedAnimation(), class: this.classes(n12.headerContainer, s12), "aria-expanded": o8 ? "false" : "true", onclick: this._toggleCollapsed, type: "button" }, r9, n3("calcite-icon", { class: n12.collapseIcon, key: "collapse-icon", icon: o8 ? "chevron-down" : "chevron-up", scale: "m" })) : n3("div", { key: e12 ?? "title", id: t12, bind: this, enterAnimation: this._createFeatureUpdatedAnimation(), class: this.classes(n12.headerContainer, s12) }, r9);
    return e12 ? l12 : null;
  }
  renderCloseIcon() {
    return n3("span", { "aria-hidden": "true", class: this.classes(n12.icon, n12.iconClose) });
  }
  renderCloseButton() {
    const { visibleElements: e12, messagesCommon: t12 } = this;
    return e12.closeButton ? n3("div", { role: "button", tabIndex: 0, bind: this, onclick: this._close, onkeydown: this._close, class: n12.button, "aria-label": t12.close, title: t12.close, afterCreate: this._closeButtonNodeUpdated, afterUpdate: this._closeButtonNodeUpdated }, this.renderCloseIcon()) : null;
  }
  renderHeader() {
    return n3("header", { class: n12.header }, this.renderTitle(), n3("div", { class: n12.headerButtons }, this.renderDockButton(), this.renderCloseButton()));
  }
  renderContentContainer() {
    const { contentId: e12, hasContent: t12, contentCollapsed: i12, _flowItems: o8 } = this, { content: n14 } = this.viewModel, s12 = o8.toArray(), r9 = { [n12.contentHasFlows]: !!s12.length };
    return t12 && !i12 ? n3("div", { key: n14 ?? "content", enterAnimation: this._createFeatureUpdatedAnimation(), id: e12, class: this.classes(n12.content, r9) }, n3("calcite-flow", { bind: this }, n3("calcite-flow-item", { bind: this, "data-node-ref": "_rootFlowItemNode", afterCreate: L, key: "root-flow-item", onCalciteFlowItemBack: this._handleBackClick }, this.renderContent()), s12.map((e13) => this.renderFlowItem(e13))), s12.map((e13) => this.renderFlowItemTooltips(e13))) : null;
  }
  renderFlowItem(e12) {
    const { messages: t12 } = this, i12 = r3(), o8 = "graphic" in e12 && !e12.isTable;
    return n3("calcite-flow-item", { bind: this, class: this.classes({ [n12.calciteThemeDark]: !i12, [n12.calciteThemeLight]: i12 }), heading: e12.title ?? "", description: this._getFlowItemDescription(e12), onCalciteFlowItemBack: this._handleBackClick, key: `flow-item-${e12.viewModel.uid}` }, n3("calcite-action", { class: n12.actionExit, icon: "move-up", label: t12 == null ? void 0 : t12.exitRelatedRecords, text: t12 == null ? void 0 : t12.exitRelatedRecords, slot: "header-actions-start", bind: this, afterCreate: (t13) => this._storeExitRelatedRecordsAction(e12, t13), onclick: this._destroyFlowItemWidgets }), o8 ? n3("calcite-action", { class: n12.actionSelectFeature, icon: "zoom-to-object", label: t12 == null ? void 0 : t12.selectFeature, text: t12 == null ? void 0 : t12.selectFeature, slot: "header-actions-end", bind: this, afterCreate: (t13) => this._storeFeatureSelectionAction(e12, t13), onclick: () => this._handleOpenRelatedFeature(e12) }) : null, n3("div", { class: this.classes(n12.contentFlowItem, { [n12.calciteThemeDark]: i12, [n12.calciteThemeLight]: !i12 }) }, e12.render()));
  }
  renderFlowItemTooltips(e12) {
    const { messages: t12, _exitRelatedRecordsActions: i12, _featureSelectionActions: o8 } = this, n14 = r3(), s12 = o8.get(e12);
    return [n3("calcite-tooltip", { class: this.classes({ [n12.calciteThemeDark]: !n14, [n12.calciteThemeLight]: n14 }), key: `exit-related-records-tooltip-${e12.viewModel.uid}`, label: t12 == null ? void 0 : t12.exitRelatedRecords, overlayPositioning: "fixed", referenceElement: i12.get(e12), placement: "top" }, t12 == null ? void 0 : t12.exitRelatedRecords), s12 ? n3("calcite-tooltip", { class: this.classes({ [n12.calciteThemeDark]: !n14, [n12.calciteThemeLight]: n14 }), key: `select-related-record-tooltip-${e12.viewModel.uid}`, label: t12 == null ? void 0 : t12.selectFeature, overlayPositioning: "fixed", referenceElement: s12, placement: "top" }, t12 == null ? void 0 : t12.selectFeature) : null];
  }
  renderActionsMenuButton() {
    const { actionsMenuId: e12, actionsMenuButtonId: t12, actionsMenuOpen: i12, dividedActions: o8, messagesCommon: n14 } = this, s12 = i12 ? n14.close : n14.open, { menuActions: r9 } = o8;
    return r9.length ? n3("div", { key: V4("actions-menu-button"), class: this.classes(n12.button, n12.actionsMenuButton), role: "button", id: t12, "aria-haspopup": "true", "aria-controls": i12 ? e12 : null, tabIndex: 0, bind: this, onclick: this._toggleActionsMenu, onkeydown: this._toggleActionsMenu, afterCreate: this._focusActionsMenuButtonNode, afterUpdate: this._focusActionsMenuButtonNode, "aria-label": s12, title: s12 }, n3("span", { "aria-hidden": "true", class: n12.iconActionsMenu })) : null;
  }
  renderMenuActions() {
    const { actionsMenuId: e12, actionsMenuButtonId: t12, actionsMenuOpen: i12, dividedActions: o8 } = this, { menuActions: n14 } = o8;
    return n14.length && i12 ? n3("ul", { id: e12, role: "menu", "aria-labelledby": t12, key: V4("actions"), class: n12.actions, bind: this, onkeyup: this._handleActionMenuKeyup, afterCreate: this._actionsMenuNodeUpdated, afterUpdate: this._actionsMenuNodeUpdated }, n14.toArray().map((e13) => this.renderAction({ action: e13, type: "menu-item" }))) : null;
  }
  renderInlineActions() {
  ...
  renderInlineActionsContainer() {
    const { inlineActions: e12, menuActions: t12 } = this.dividedActions, i12 = !!e12.length, o8 = !!t12.length;
    return i12 || o8 ? n3("div", { key: "inline-actions-container", "data-inline-actions": i12.toString(), "data-menu-actions": o8.toString(), class: n12.inlineActionsContainer }, this.renderInlineActions(), this.renderActionsMenuButton(), this.renderMenuActions()) : null;
  }
  renderNavigation() {
    return this.featureNavigationVisible ? n3("section", { key: V4("navigation"), class: this.classes(n12.navigation) }, this.renderNavigationButtons()) : null;
  }
  renderFooter() {
    const { featureNavigationVisible: e12, dividedActions: t12 } = this, { inlineActions: i12, menuActions: o8 } = t12, n14 = !!i12.length, s12 = !!o8.length, r9 = { [n12.footerHasPagination]: e12, [n12.footerHasActions]: n14, [n12.footerHasActionsMenu]: s12 };
    return e12 || n14 ? n3("div", { key: V4("feature-buttons"), class: this.classes(n12.footer, r9) }, this.renderInlineActionsContainer(), this.renderNavigation()) : null;
  }
  renderFeatureMenuContainer() {
    const { messages: e12 } = this, { featureViewModels: t12, isLoadingFeature: i12 } = this.viewModel, o8 = s3(e12.selectedFeatures, { total: t12.length });
    return n3("section", { key: V4("menu"), class: n12.featureMenu }, n3("strong", { class: n12.featureMenuHeader }, o8), n3("nav", { bind: this, class: n12.featureMenuViewport, "data-node-ref": "_featureMenuViewportNode", afterCreate: L }, this.renderFeatureMenu(), n3("div", { class: n12.featureMenuObserver, bind: this, afterCreate: this._featureMenuIntersectionObserverCreated }), i12 ? n3("div", { class: n12.featureMenuLoader }, this.renderLoadingIcon()) : null));
  }
  renderPointer() {
    return this.dockEnabled ? null : n3("div", { key: V4("pointer"), class: n12.pointer, role: "presentation" }, n3("div", { class: this.classes(n12.pointerDirection, n12.shadow) }));
  }
  renderMainContainer() {
    const { dockEnabled: e12, currentAlignment: t12, currentDockPosition: i12, titleId: o8, contentId: n14, collapsible: s12, hasContent: r9, contentCollapsed: l12, visibleElements: a14 } = this, { title: c21 } = this.viewModel, u9 = "bottom-left" === t12 || "bottom-center" === t12 || "bottom-right" === t12 || "top-left" === i12 || "top-center" === i12 || "top-right" === i12, d10 = "top-left" === t12 || "top-center" === t12 || "top-right" === t12 || "bottom-left" === i12 || "bottom-center" === i12 || "bottom-right" === i12, h13 = { [n12.shadow]: e12, [n12.isCollapsible]: s12, [n12.isCollapsed]: l12 };
    return n3("div", { class: this.classes(n12.main, n12.widget, h13), tabIndex: a14.closeButton ? void 0 : -1, role: "dialog", "aria-live": "polite", "aria-labelledby": c21 ? o8 : "", "aria-describedby": r9 && !l12 ? n14 : "", bind: this, onkeyup: this._handleMainKeyup, afterCreate: this._mainContainerNodeUpdated, afterUpdate: this._mainContainerNodeUpdated }, u9 ? this.renderFooter() : null, u9 ? this.renderFeatureMenuContainer() : null, this.renderHeader(), this.renderContentContainer(), d10 ? this.renderFooter() : null, d10 ? this.renderFeatureMenuContainer() : null);
  }
  renderContent() {
    var _a;
    const e12 = (_a = this.viewModel) == null ? void 0 : _a.content;
    return e12 ? "string" == typeof e12 ? n3("div", { class: t7.contentNode, key: e12, innerHTML: e12 }) : this.renderNodeContent(e12) : null;
  }
  renderActionText(e12) {
    return n3("span", { key: "text", class: n12.actionText }, e12);
  }
  renderActionCalciteIcon(e12, t12) {
    return n3("calcite-icon", { scale: "s", key: `calcite-icon-${t12}`, icon: e12, class: n12.icon });
  }
  renderActionIcon(e12) {
    const t12 = this._getActionClass(e12), i12 = this._getActionImage(e12), o8 = { [n12.iconLoading]: e12.active, [n12.rotating]: e12.active, [n12.icon]: !!t12, [n12.actionImage]: !e12.active && !!i12 };
    return t12 && (o8[t12] = !e12.active), n3("span", { key: "icon", "aria-hidden": "true", class: this.classes(n12.icon, o8), styles: this._getIconStyles(i12) });
  }
  renderAction(e12) {
    const { action: t12, type: i12 } = e12, o8 = this._getActionTitle(t12), n14 = { [n12.action]: "toggle" !== t12.type, [n12.actionToggle]: "toggle" === t12.type, [n12.actionToggleOn]: "toggle" === t12.type && t12.value, [n12.buttonDisabled]: t12.disabled }, s12 = [t12.icon && !t12.active ? this.renderActionCalciteIcon(t12.icon, t12.uid) : this.renderActionIcon(t12), this.renderActionText(o8)], r9 = "menu-item" === i12 ? n3("li", { key: t12.uid, role: "menuitem", tabIndex: 0, title: o8, "aria-label": o8, class: this.classes(n12.button, n14), onkeyup: this._handleActionMenuItemKeyup, bind: this, "data-action-uid": t12.uid, onclick: this._triggerAction, onkeydown: this._triggerAction }, s12) : n3("div", { key: t12.uid, role: "button", tabIndex: 0, title: o8, "aria-label": o8, class: this.classes(n12.button, n14), onkeyup: this._handleActionMenuItemKeyup, bind: this, "data-action-uid": t12.uid, onclick: this._triggerAction, onkeydown: this._triggerAction }, s12);
    return t12.visible ? r9 : null;
  }
  renderFeatureMenuItem(e12, t12) {
    const { messages: i12, messagesCommon: o8 } = this, { selectedFeatureIndex: n14, selectedFeatureViewModel: s12 } = this.viewModel, r9 = e12 === s12, l12 = { [n12.featureMenuSelected]: r9 }, a14 = r9 ? n3("span", { key: V4(`feature-menu-selected-feature-${n14}`), title: i12.selectedFeature, "aria-label": i12.selectedFeature, class: n12.iconCheckMark }) : null, c21 = n3("span", { innerHTML: e12.title || o8.untitled });
    return n3("li", { role: "menuitem", tabIndex: -1, key: V4(`feature-menu-feature-${n14}`), class: this.classes(l12, n12.featureMenuItem), bind: this, "data-feature-index": t12, onblur: this._removeActiveFeature, onfocus: this._setActiveFeature, onkeyup: this._handleFeatureMenuItemKeyup, onclick: this._selectFeature, onkeydown: this._selectFeature, onmouseover: this._setActiveFeature, onmouseleave: this._removeActiveFeature }, n3("span", { class: n12.featureMenuTitle }, c21, a14));
  }
  renderFeatureMenu() {
    const { featureMenuId: e12 } = this, { featureViewModels: t12 } = this.viewModel;
    return t12.length > 1 ? n3("ol", { class: n12.featureMenuList, id: e12, bind: this, afterCreate: this._featureMenuNodeUpdated, afterUpdate: this._featureMenuNodeUpdated, onkeyup: this._handleFeatureMenuKeyup, role: "menu" }, t12.filter((e13) => !!e13.graphic).map((e13, t13) => this.renderFeatureMenuItem(e13, t13))) : null;
  }
  ...
  async _openRelatedFeature(e12) {
    ...
    const t12 = e12.graphic, i12 = t12 == null ? void 0 : t12.geometry;
    if (null == i12 || null == t12)
      return;
    this._destroyFlowItemWidgets(), await this.viewModel.zoomTo({ target: i12 });
    const o8 = h10(i12);
    this.open({ features: [t12], location: null != o8 ? o8 : void 0 });
  }
  ...
  _getActionTitle(e12) {
    const { messages: t12, selectedFeature: i12, messagesCommon: o8 } = this, { id: n14 } = e12, s12 = i12 == null ? void 0 : i12.attributes, r9 = e12.title ?? "", l12 = "zoom-to-feature" === n14 ? s3(r9, { messages: t12 }) : "remove-selected-feature" === n14 ? s3(r9, { messages: o8 }) : "zoom-to-clustered-features" === n14 || "browse-clustered-features" === n14 ? s3(r9, { messages: t12 }) : e12.title;
    return l12 && s12 ? s3(l12, s12) : l12 ?? "";
  }
  _getActionClass(e12) {
    const { selectedFeature: t12 } = this, i12 = t12 == null ? void 0 : t12.attributes, { className: o8, image: n14 } = e12, s12 = n14 || o8 ? o8 : n12.iconDefaultAction;
    return s12 && i12 ? s3(s12, i12) : s12 ?? "";
  }
  _getActionImage(e12) {
    if (e12.active)
      return "";
    const { selectedFeature: t12 } = this, i12 = t12 == null ? void 0 : t12.attributes, { image: o8 } = e12;
    return o8 && i12 ? s3(o8, i12) : o8 ?? "";
  }
  ...
  _getInlineActionCount() {
    ...
    if ("number" != typeof e12)
      return null;
    const i12 = Math.round(e12);
    return Math.max(t12 ? i12 - 1 : i12, 0);
  }
  _watchActions() {
  ...
  _divideActions() {
    const { allActions: e12 } = this.viewModel, i12 = e12.filter((e13) => e13.visible), o8 = this._getInlineActionCount(), n14 = null === o8, s12 = 0 === o8;
    return { inlineActions: n14 ? i12.slice(0) : s12 ? new V() : i12.slice(0, o8), menuActions: n14 ? new V() : s12 ? i12.slice(0) : i12.slice(o8) };
  }
  ...
  _setActiveFeature(e12) {
    const { viewModel: t12 } = this, i12 = W5(e12.currentTarget);
    t12.activeFeature = t12.features[i12] || null;
  }
  _removeActiveFeature() {
    this.viewModel.activeFeature = null;
  }
  _handleFeatureMenuItemKeyup(e12) {
    const t12 = i2(e12), { _featureMenuNode: i12 } = this, n14 = W5(e12.currentTarget);
    if (!i12)
      return;
    const s12 = i12.querySelectorAll("li"), r9 = s12.length;
    if ("ArrowUp" !== t12)
      if ("ArrowDown" !== t12)
        if ("Home" !== t12)
          if ("End" !== t12)
  ...
  _handleActionMenuItemKeyup(e12) {
    const t12 = i2(e12), { _actionsMenuNode: i12 } = this, n14 = e12.currentTarget.dataset.actionUid, { menuActions: s12 } = this.dividedActions, r9 = s12.findIndex((e13) => e13.uid === n14);
    if (!i12)
      return;
    const l12 = i12.querySelectorAll("li"), a14 = l12.length;
    if ("ArrowUp" !== t12)
      if ("ArrowDown" !== t12)
        if ("Home" !== t12)
          if ("End" !== t12)
  ...
  _displaySpinner() {
    ...
    if (!e12)
      return;
    const { location: t12, waitingForResult: i12 } = this.viewModel;
    i12 && t12 ? e12.show({ location: t12 }) : e12.hide();
  }
  _getIconStyles(e12) {
  ...
  _selectedFeatureIndexUpdated(e12, t12) {
    const { featureCount: i12 } = this;
    i12 && e12 !== t12 && -1 !== e12 && (this._destroyFlowItemWidgets(), this.actionsMenuOpen = false, this.featureMenuOpen = false, this._mainContainerNode && (this._mainContainerNode.scrollTop = 0), this._rootFlowItemNode && this._rootFlowItemNode.scrollContentTo({ top: 0 }));
  }
  ...
  _isOutsideView(e12) {
    const { popupHeight: t12, popupWidth: i12, screenLocation: o8, side: n14, view: s12 } = e12;
    if (isNaN(i12) || isNaN(t12) || !s12 || !o8)
      return false;
    const r9 = s12.padding;
    return "right" === n14 && o8.x + i12 / 2 > s12.width - r9.right || ("left" === n14 && o8.x - i12 / 2 < r9.left || ("top" === n14 && o8.y - t12 < r9.top || "bottom" === n14 && o8.y + t12 > s12.height - r9.bottom));
  }
  _calculateAutoAlignment(e12) {
    if ("auto" !== e12)
      return e12;
    const { _pointerOffsetInPx: t12, _containerNode: i12, _mainContainerNode: o8, viewModel: n14 } = this, { screenLocation: s12, view: r9 } = n14;
    if (null == s12 || !r9 || !i12)
      return "top-center";
    ...
    const a14 = o8 ? window.getComputedStyle(o8, null) : null, c21 = a14 ? l12(a14.getPropertyValue("max-height")) : 0, u9 = a14 ? l12(a14.getPropertyValue("height")) : 0, { height: d10, width: h13 } = i12.getBoundingClientRect(), p16 = h13 + t12, g9 = Math.max(d10, c21, u9) + t12, m15 = this._isOutsideView({ popupHeight: g9, popupWidth: p16, screenLocation: s12, side: "right", view: r9 }), v8 = this._isOutsideView({ popupHeight: g9, popupWidth: p16, screenLocation: s12, side: "left", view: r9 }), f11 = this._isOutsideView({ popupHeight: g9, popupWidth: p16, screenLocation: s12, side: "top", view: r9 }), _4 = this._isOutsideView({ popupHeight: g9, popupWidth: p16, screenLocation: s12, side: "bottom", view: r9 });
  ...
  _calculateAutoDockPosition(e12) {
    ...
    if ("auto" !== e12)
      return e12;
    const t12 = (_a = this.viewModel) == null ? void 0 : _a.view, i12 = h2(this.container) ? "top-left" : "top-right";
    if (!t12)
      return i12;
    const o8 = t12.padding || { left: 0, right: 0, top: 0, bottom: 0 }, n14 = t12.width - o8.left - o8.right, { breakpoints: s12 } = t12;
    return s12 && n14 <= s12.xsmall ? "bottom-center" : i12;
  }
  _positionContainer(e12 = this._containerNode) {
    if (e12 && (this._containerNode = e12), !this._containerNode)
      return;
    const { screenLocation: t12 } = this.viewModel, { width: i12 } = this._containerNode.getBoundingClientRect(), o8 = this._calculatePositionStyle(t12, i12);
    o8 && Object.assign(this._containerNode.style, o8);
  }
  _calculateFullWidth(e12) {
    const { currentAlignment: t12, _pointerOffsetInPx: i12 } = this;
    return "top-left" === t12 || "bottom-left" === t12 || "top-right" === t12 || "bottom-right" === t12 ? e12 + i12 : e12;
  }
  _calculateAlignmentPosition(e12, t12, i12, o8) {
    const { currentAlignment: n14, _pointerOffsetInPx: s12 } = this;
    if (!i12)
      return;
    const { padding: r9 } = i12, l12 = o8 / 2, a14 = i12.height - t12, c21 = i12.width - e12;
  ...
  _calculatePositionStyle(e12, t12) {
    const { dockEnabled: i12, view: o8 } = this;
    if (!o8)
      return;
    if (i12)
    ...
    if (null == e12 || !t12)
      return;
    const n14 = this._calculateFullWidth(t12), s12 = this._calculateAlignmentPosition(e12.x, e12.y, o8, n14);
  ...
  _dockingThresholdCrossed(e12, t12, i12) {
    const [o8, n14] = e12, [s12, r9] = t12, { width: l12 = 0, height: a14 = 0 } = i12 ?? {};
    return o8 <= l12 && s12 > l12 || o8 > l12 && s12 <= l12 || n14 <= a14 && r9 > a14 || n14 > a14 && r9 <= a14;
  }
  _updateDockEnabledForViewSize(e12, t12) {
    if (!e12 || !t12)
      return;
    const i12 = this.get("viewModel.view.padding") || { left: 0, right: 0, top: 0, bottom: 0 }, o8 = i12.left + i12.right, n14 = i12.top + i12.bottom, s12 = [], r9 = [];
    s12[0] = e12[0] - o8, s12[1] = e12[1] - n14, r9[0] = t12[0] - o8, r9[1] = t12[1] - n14;
  ...
  _toggleScreenLocationEnabled() {
    ...
    if (!t12)
      return;
    const i12 = t12.active && !e12;
    t12.screenLocationEnabled = i12;
  }
  _shouldDockAtCurrentViewSize(e12) {
    var _a, _b;
    const t12 = e12.breakpoint, i12 = (_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.ui;
    if (!i12)
      return false;
    const { width: o8, height: n14 } = i12;
    if (isNaN(o8) || isNaN(n14))
      return false;
    if (!t12)
      return false;
    const s12 = t12.hasOwnProperty("width") && o8 <= (t12.width ?? 0), r9 = t12.hasOwnProperty("height") && n14 <= (t12.height ?? 0);
    return s12 || r9;
  }
  ...
  _triggerAction(e12) {
    const t12 = e12.currentTarget.dataset.actionUid, { allActions: i12 } = this.viewModel, o8 = i12.findIndex((e13) => e13.uid === t12), n14 = i12.at(o8);
    n14 && "toggle" === n14.type && (n14.value = !n14.value), this.actionsMenuOpen = false, this.viewModel.triggerAction(o8);
  }
  _selectFeature(e12) {
