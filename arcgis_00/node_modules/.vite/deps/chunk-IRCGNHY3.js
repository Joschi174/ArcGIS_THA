...
import {
  r
} from "./chunk-PH2HQMHS.js";
import {
  o as o4
} from "./chunk-EZOSZES7.js";
import {
  a as a5,
  h2 as h3,
  m as m4,
...
import {
  c
} from "./chunk-P662BGUZ.js";
import {
  t
} from "./chunk-PM77FW2O.js";
import {
  te
} from "./chunk-JKPERUTC.js";
import {
  V as V2
...
import {
  u as u4
} from "./chunk-CKSC27NP.js";
import {
  l as l4
} from "./chunk-WNYS35QN.js";
import {
  e as e2
...
e([y()], c4.prototype, "_filter", void 0), e([y()], c4.prototype, "_excludedEffectView", void 0), e([y()], c4.prototype, "_includedEffectView", void 0), e([y()], c4.prototype, "duration", void 0), e([y()], c4.prototype, "excludedEffects", null), e([y()], c4.prototype, "featureEffect", null), e([y()], c4.prototype, "filter", null), e([y()], c4.prototype, "hasEffects", null), e([y()], c4.prototype, "includedEffects", null), e([y({ value: 0 })], c4.prototype, "scale", null), e([y()], c4.prototype, "transitioning", null), c4 = e([a2("esri.layers.effects.FeatureEffectView")], c4);
var r3 = c4;
...
e([y({ type: [s3], json: { write: true } })], c5.prototype, "features", void 0), e([o2("features")], c5.prototype, "readFeatures", null), c5 = e([a2("esri.rest.support.AggregateFeatureSet")], c5);
var i5 = c5;
...
e([y()], r4.prototype, "layer", void 0), e([y()], r4.prototype, "layerView", void 0), e([y()], r4.prototype, "tileInfoView", void 0), e([y()], r4.prototype, "updating", null), r4 = e([a2("esri.views.2d.layers.features.tileRenderers.BaseTileRenderer")], r4);
var o5 = r4;
...
e([y({ readOnly: true })], c7.prototype, "updating", null), e([y()], c7.prototype, "process", void 0), c7 = e([a2("esri.views.2d.layers.support.FeatureCommandQueue")], c7);
var p5 = c7;
...
var u8 = class extends p {
  ...
  async updateTiles(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("updateTiles", e5));
  }
  async update(e5) {
    const t5 = { config: e5 };
  ...
  async setHighlight(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.setHighlight", e5));
  }
  async stop() {
    if (await this._startupResolver.promise, !this.closed)
      return y2(this._connection.invoke("stop"));
  }
  async refresh(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.refresh", e5));
  }
  ...
  async onEdits(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.onEdits", e5));
  }
  async enableEvent(e5, t5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.enableEvent", { name: e5, value: t5 }));
  }
  async pauseStream() {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.pauseStream"));
  }
  async resumeStream() {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.resumeStream"));
  }
  async sendMessageToSocket(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.sendMessageToSocket", e5));
  }
  async sendMessageToClient(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.sendMessageToClient", e5));
  }
  async updateCustomParameters(e5) {
    return await this._startupResolver.promise, y2(this._connection.invoke("controller.updateCustomParameters", e5));
  }
...
e([y()], u8.prototype, "isReady", void 0), e([y({ constructOnly: true })], u8.prototype, "client", void 0), e([y()], u8.prototype, "tileRenderer", null), u8 = e([a2("esri.views.2d.layers.support.FeatureLayerProxy")], u8);
var l5 = u8;
...
var _ = (r8) => {
  let _2 = class extends r8 {
    ...
    get availableFields() {
      ...
      return "outFields" in e5 && e5.outFields ? g(t5, [...b4(t5, e5.outFields), ...r9]) : g(t5, r9);
    }
    get featureEffect() {
    ...
    async fetchClientPopupFeatures(e5) {
      ...
      for (let o10 = 0; o10 < t5.length; o10++) {
        ...
        if (!("popupEnabled" in l8))
          continue;
        const a11 = b4(this.layer.fieldsIndex, s6.outFields), u10 = p2(l8, e5);
        if (null == u10)
          continue;
  ...
  return e([y()], _2.prototype, "_updatingRequiredFieldsPromise", void 0), e([y({ readOnly: true })], _2.prototype, "availableFields", null), e([y({ type: w2 })], _2.prototype, "featureEffect", null), e([y({ type: d4 })], _2.prototype, "filter", void 0), e([y(b)], _2.prototype, "timeExtent", void 0), e([y()], _2.prototype, "layer", void 0), e([y({ type: Number })], _2.prototype, "maximumNumberOfFeatures", null), e([y({ readOnly: true, type: Boolean })], _2.prototype, "maximumNumberOfFeaturesExceeded", null), e([y({ readOnly: true })], _2.prototype, "requiredFields", void 0), e([y()], _2.prototype, "suspended", void 0), e([y()], _2.prototype, "view", void 0), _2 = e([a2(q2)], _2), _2;
};
...
`), n10;
  ...
  _getEffectiveRenderer() {
    ...
    if (this._updateClusterSizeTask = o(this._updateClusterSizeTask), r8 && "renderer" in r8 && r8.renderer && !((_a = r8.renderer.authoringInfo) == null ? void 0 : _a.isAutoGenerated)) {
      const e6 = r8.fields;
      if ("cluster" === r8.type) {
        const { renderer: t6, didInject: i9 } = f3(r8.renderer, r8, this._aggregateValueRanges);
    ...
    if (r8 && "cluster" === r8.type && t5 && b3(t5)) {
      const e6 = r8, i9 = [], s6 = c2(i9, t5, e6, this._aggregateValueRanges, true);
...
e([y()], K.prototype, "_serviceOptions", void 0), e([y()], K.prototype, "_proxy", void 0), e([y()], K.prototype, "_pipelineIsUpdating", void 0), e([y()], K.prototype, "_effectiveRenderer", void 0), e([y()], K.prototype, "_effectiveFeatureReduction", null), e([y()], K.prototype, "_aggregateValueRanges", void 0), e([y()], K.prototype, "_commandsQueue", void 0), e([y()], K.prototype, "featureEffectView", void 0), e([y()], K.prototype, "labelsVisible", null), e([y()], K.prototype, "labelingCollisionInfos", null), e([y({ readOnly: true })], K.prototype, "queryMode", null), e([y()], K.prototype, "renderingConfigHash", null), e([y()], K.prototype, "tileRenderer", void 0), e([y()], K.prototype, "updating", void 0), K = e([a2("esri.views.2d.layers.FeatureLayerView2D")], K);
var W = K;

export {
  W
};
//# sourceMappingURL=chunk-IRCGNHY3.js.map
