...
var Panel = proxyCustomElement(class extends H {
  ...
  renderActionBar() {
    return h("div", { class: CSS3.actionBarContainer, hidden: !this.hasActionBar }, h("slot", { name: SLOTS2.actionBar, onSlotchange: this.handleActionBarSlotChange }));
  }
  ...
  renderHeaderActionsEnd() {
    ...
    const icons = [ICONS2.expand, ICONS2.collapse];
    ...
    const closeNode = closable ? h("calcite-action", { "aria-label": close, "data-test": "close", icon: ICONS2.close, onClick: this.close, text: close, title: close }) : null;
    ...
    return h("div", { class: { [CSS3.headerActionsEnd]: true, [CSS3.headerActions]: true }, hidden: !showContainer, key: "header-actions-end" }, slotNode, this.renderMenu(), collapseNode, closeNode);
  }
  renderMenu() {
  ...
  renderHeaderNode() {
    ...
    return h("header", { class: CSS3.header, hidden: !(showHeaderContent || hasActionBar) }, h("div", { class: { [CSS3.headerContainer]: true, [CSS3.headerContainerBorderEnd]: hasActionBar }, hidden: !showHeaderContent }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd()), this.renderActionBar());
  }
  renderFooterNode() {
...
var FlowItem = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Host, null, h("calcite-panel", {
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setContainerRef
    }, this.renderBackButton(), h("slot", { name: SLOTS3.actionBar, slot: SLOTS2.actionBar }), h("slot", { name: SLOTS3.headerActionsStart, slot: SLOTS2.headerActionsStart }), h("slot", { name: SLOTS3.headerActionsEnd, slot: SLOTS2.headerActionsEnd }), h("slot", { name: SLOTS3.headerContent, slot: SLOTS2.headerContent }), h("slot", { name: SLOTS3.headerMenuActions, slot: SLOTS2.headerMenuActions }), h("slot", { name: SLOTS3.fab, slot: SLOTS2.fab }), h("slot", { name: SLOTS3.footerActions, slot: SLOTS2.footerActions }), h("slot", { name: SLOTS3.footer, slot: SLOTS2.footer }), h("slot", null)));
  }
  static get assetsDirs() {
    return ["assets"];
  }
...
@esri/calcite-components/dist/components/calcite-flow-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-flow-item-ZNT2QSYM.js.map
