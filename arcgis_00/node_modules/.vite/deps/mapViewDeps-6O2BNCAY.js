...
async function s6(s7) {
  const r7 = import("./mask-svg-XESDVYSI.js"), i12 = import("./overlay-svg-QP6AAM3F.js"), o12 = t4((await r7).default, { signal: s7 }), e8 = t4((await i12).default, { signal: s7 }), m4 = { mask: await o12, overlay: await e8 };
  return s2(s7), m4;
}
...
//# sourceMappingURL=mapViewDeps-6O2BNCAY.js.map
