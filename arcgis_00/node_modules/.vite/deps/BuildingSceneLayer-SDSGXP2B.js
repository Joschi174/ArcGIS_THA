...
var _2 = class extends _.LoadableMixin(m(n5)) {
  ...
  async queryCachedAttributes(e3, r3) {
    const t8 = b2(this.fieldsIndex, await n4(this, p3(this)));
...
var K2 = class extends N(l2(c2(j2(t2(O(i(b3))))))) {
  constructor(e3) {
  ...
  readSummaryStatistics(e3, r3) {
    ...
    if ("string" == typeof r3.statisticsHRef) {
      const e4 = V((_a2 = this.parsedUrl) == null ? void 0 : _a2.path, r3.statisticsHRef);
