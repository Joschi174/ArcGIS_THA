...
function i(n2) {
  const t2 = [n2.r / 255, n2.g / 255, n2.b / 255].map((n3) => n3 <= 0.04045 ? n3 / 12.92 : ((n3 + 0.055) / 1.055) ** 2.4), r2 = a(e, t2);
  return { x: 100 * r2[0], y: 100 * r2[1], z: 100 * r2[2] };
}
function h(n2) {
  const t2 = a(c, [n2.x / 100, n2.y / 100, n2.z / 100]).map((n3) => {
...
function x(n2) {
  ...
  let c2 = o2, a2 = 0 === e2 ? 0 : o2 === t2 ? (r2 - u2) / e2 % 6 : o2 === r2 ? (u2 - t2) / e2 + 2 : (t2 - r2) / e2 + 4, i2 = 0 === e2 ? 0 : e2 / c2;
  return a2 < 0 && (a2 += 6), a2 *= 60, i2 *= 100, c2 *= 100 / 255, { h: a2, s: i2, v: c2 };
}
function k(n2) {
...
//# sourceMappingURL=chunk-3DKXLUT7.js.map
